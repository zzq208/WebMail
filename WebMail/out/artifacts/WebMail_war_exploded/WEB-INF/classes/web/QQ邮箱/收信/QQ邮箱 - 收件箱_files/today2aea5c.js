;(function (a) {
    ...
    b.prototype = {
        _init: function () {
            ...
            e._moQmTab = c = new qmTab({
                win: h,
                tab: f,
                style: {normal: "tab_list bd pointer", over: "tab_list bd pointer", select: "tab_list bd actived"},
                onchange: function (l, k) {
                    ...
                    if (n && p && !m) {
                        createIframe(h, p, {
                            ...
                            obj: f[l].container,
                            where: "beforeEnd",
                            className: attr(n, "class_iframe") || "",
                            style: attr(n, "style_iframe") || "",
                            attrs: attr(n, "attrs_iframe") || ""
                        });
                    }
                }
            });
                            ...
                            j[e].onclick = function () {
                                ...
                                if (i.getAttribute(h) == "1") {
                                    ...
                                    audioPlay({
                                        ...
                                        global: false,
                                        autoplay: true,
                                        url: i.getAttribute(f),
                                        updatecallback: function (l) {
                                            var k = GelTags("img", i);
                                            if (l == "stopped") {
                                                show(k[1], 0);
                                                show(k[0], 1);
            ...
            setTimeout(function () {
                if (QMMLCache.useCache()) {
                    ...
                    if (k.length) {
                        ...
                        E(k, function (v) {
                            ...
                            addEvent(v, "click", function (z) {
                                ...
                                ossLog(x, "all", T("stat=nothing&$locname$=today,,,$id$").replace({
                                    id: 5,
                                    locname: x == "realtime" ? "loc" : "locval"
                                }));
                                preventDefault(z);
                            });
                        });
                    ...
                    if (j && j.id != "folder_9") {
                        var n = "today" + j.id, f = parseInt(j.getAttribute("total")),
                            g = parseInt(j.getAttribute("unread")),
                            i = getGlobalVarValue(n) || setGlobalVarValue(n, {v: Math.round(Math.random() * 10000)}), o;
            ...
            var d = getTop();
            var c = this;
            c.bOpenBill && d.QMAjax.send(getTop().gsNodejslogichost + '/bill/newcount', {
                onload: function (e, f) {
                    if (e) {
                        var h = d.eval('(' + f + ')');
                        if (h.data) {
