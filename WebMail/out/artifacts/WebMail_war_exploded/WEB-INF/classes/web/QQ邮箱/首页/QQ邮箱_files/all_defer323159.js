;(function () {
    var b = getTop(), a = ["IE", "FF", "Safari", "Edge", "Opera", "360", "Chrome", "Sogou", "QB"], c = "Sogou,QB,360",
        d = gbIsWebKit ? "webkit" : "ie", g = gsAppVer.indexOf("qqbrowser") != -1, f = function () {
            try {
...
;(function () {
    ...
    a._onevent = function (d) {
        return function () {
            ...
            _oValue = {
                focus: [f.getAttribute("focus") != "true", "", "", "true"],
                blur: [f.value == "", (attr(f, "fullsearch") == "1") ? a._TIP_FULL_TEXT : a._TIP_NORMAL_TEXT, "#a0a0a0", "false"]
            }[d];
            if (_oValue[0]) {
                f.value = _oValue[1];
    ...
    function b() {
        var e = S("subject"),
            j = T("<div unselectable=\"on\" class=\"ss_drop_item\"><a href=\"javascript:;\" unselectable=\"on\"><span unselectable=\"on\" class=\"ss_icon ss_icon_mail\"></span>\u5305\u542B<b unselectable=\"on\">$keyword$</b>\u7684\u90AE\u4EF6</a></div>"),
            h = T("<div unselectable=\"on\" class=\"ss_drop_item\"><a href=\"javascript:;\"				unselectable=\"on\"><span class=\"ss_icon ss_icon_attach\" unselectable=\"on\"></span>\u5305\u542B<b unselectable=\"on\">$keyword$</b>\u7684\u9644\u4EF6</a></div>"),
            i = T("<div unselectable=\"on\" class=\"ss_drop_item\"><a href=\"javascript:;\"				unselectable=\"on\"><span class=\"ss_icon ss_icon_group\" unselectable=\"on\"></span>\u5305\u542B<b unselectable=\"on\">$keyword$</b>\u7684\u7FA4\u90AE\u4EF6</a></div>"),
            k = T("<div unselectable=\"on\" class=\"ss_drop_item\"><a href=\"javascript:;\"				unselectable=\"on\"><span class=\"ss_icon ss_icon_note\" unselectable=\"on\"></span>\u5305\u542B<b unselectable=\"on\">$keyword$</b>\u7684\u8BB0\u4E8B</a></div>"),
            f = "<div class=\"ss_drop_item ss_drop_split\" unselectable=\"on\"><a unselectable=\"on\" href=\"javascript:;\">\u9AD8\u7EA7\u641C\u7D22...</a></div>",
            g = trim(e.value);
        if (g == "") {
            return "";
        }
            ...
            if (attr(e, "fullsearch") != "1") {
                return [{sId: "searchInMail", sItemValue: j.replace({keyword: htmlEncode(g)})}, {
                    sId: "advanceSearch",
                    sItemValue: f
                }];
            }
                ...
                return [{sId: "searchInMail", sItemValue: j.replace({keyword: htmlEncode(g)})}, {
                    sId: "searchInAttach",
                    sItemValue: h.replace({keyword: htmlEncode(g)})
                }, {sId: "searchInGroupMail", sItemValue: i.replace({keyword: htmlEncode(g)})}, {
                    sId: "searchInNotes",
                    sItemValue: k.replace({keyword: htmlEncode(g)})
                }, {sId: "advanceSearch", sItemValue: f}];
            }
        }
    }
    ...
    function c() {
        if (S("smartSearch")) {
            a.QMAuto = new QMAutoComplete({
                oInput: S("subject"),
                oPosObj: S("smartSearch"),
                sClassName: (getLocale() == "zh_CN") ? "" : "smart_search_menu",
                nWidth: (getLocale() == "zh_CN") ? 280 : 370,
                oClass: {classnormal: "ss_drop_item_wrap", classhigh: "ss_drop_item_wrap_hover"},
                ongetdata: function () {
                    return b();
                },
                onselect: function (d) {
...
function showAdvanceSearchDialog(a) {
    var d = getTop(), c = {sid: d.getSid(), keyword: (a != "all") ? encodeURI(trim(S("subject").value)) : "", from: a},
        e = T('/cgi-bin/folderlist?sid=$sid$&t=searchoption&advancesearch=2&loc=frame_html,,9&advkeyword=$keyword$&from=$from$').replace(c),
        b = new QMDialog({
            sId: "advsearch", sTitle: "\u90AE\u4EF6\u9AD8\u7EA7\u641C\u7D22", sUrl: e, onload: function () {
...
(function (b) {
    ...
    var l = function (u) {
        ...
        var y = z.QMEditor.createEditor({
            editorId: 'sendToMobile',
            tbExternId: "QMEditorToolBarPlusArea-sendToMobile",
            editorAreaId: "QMEditorArea-sendToMobile",
        ...
        var v = {
            rule: function () {
                return {
                    click: {
                        "submit_send": {bPropagable: false},
                        "cancel_send": {bPropagable: false},
                        "click_defaultText": {bPropagable: false}
                    },
                    mousedown: {"click_defaultText_down": {bPropagable: false}},
                    mouseup: {"click_defaultText_up": {bPropagable: false}}
                };
            }, events: function () {
                return {
                    "submit_send": function (B, C) {
                        ...
                        a.sendOssLog('note');
                        var F = z.getSid();
                        QMAjax.send('/cgi-bin/note_edit?sid=' + F, {
                            method: 'post',
                            content: T('sid=$sid$&catid=-1&contenttype=html&actiontype=send&content__html=$content__html$&loc=$loc$&t=$t$&ef=js&resp_charset=UTF8&jumplock=true').replace({
                                t: encodeURIComponent('note_send_to_phone.json'),
                                sid: z.getSid(),
                                content__html: encodeURIComponent(z.QMEditor.getEditor('sendToMobile').getContent()),
                                loc: encodeURIComponent('note_list,note_first_page,digest')
                            }),
                            onload: function (G, I, H) {
                                if (G) {
                                    var J = evalValue(I) || {};
                                    if (J.statusCode) {
    ...
    var c = false, k = function (v) {
        ...
        w.createIframe(window, w.T("/cgi-bin/readtemplate?sid=$sid$&t=ftn_bigattachSendToMoble").replace({sid: w.getSid()}), {
            scrolling: false, obj: u, onload: function () {
    ...
    var q = function () {
        ...
        new QMTabDialog({
            ...
            oTabs: [{
                sTabTitle: '\u6587\u5B57', sTabContent: '', fInitTabContent: function (v) {
                    l(v);
                }, bDefault: true
            }, {
                sTabTitle: '\u6587\u4EF6',
                sTabContent: '\u6B63\u5728\u52A0\u8F7D\u4E2D...',
                fInitTabContent: function (v) {
                    k(v);
                },
                bDefault: false
            }]
    ...
    var j = function () {
        ...
        return {
            iosInstall: parseInt(_oUserInfo.get('IOSWEBAPPVER'), 10) || 0,
            iosVer: _oUserInfo.get('IOSWEBAPPVERNEW') || '0',
            androidInstall: parseInt(_oUserInfo.get('ANDROIDWEBAPPVER'), 10) || 0,
            androidVer: _oUserInfo.get('ANDROIDWEBAPPVERNEW') || '0'
        };
    };
    var r = function (u, v) {
    ...
    var o = function () {
        ...
        var u = new v.QMDialog({
            sId: 'download-app',
            sTitle: '\u4F20\u9001\u5230\u624B\u673A',
            sBodyHtml: v.T(['<div class="uploadfromapp_wrap" id="content">', z, '</div>']).replace({
                sid: v.getSid(),
                skey: y,
                stitle2: A,
                sdesc: x
...
function showAdvanceSearchMenu() {
    var c = {
            "all": {
                sId: "0",
                sItemValue: "<div class=\"ss_drop_item\"><a href=\"javascript:;\"><span class=\"ss_icon ss_icon_mail\"></span>\u67E5\u770B\u6240\u6709\u90AE\u4EF6</a></div>"
            },
            "att": {
                sId: "1",
                sItemValue: "<div class=\"ss_drop_item\"><a href=\"javascript:;\"><span class=\"ss_icon ss_icon_attach\"></span>\u67E5\u770B\u6240\u6709\u9644\u4EF6</a></div>"
            },
            "grp": {
                sId: "3",
                sItemValue: "<div class=\"ss_drop_item\"><a href=\"javascript:;\"><span class=\"ss_icon ss_icon_group\"></span>\u67E5\u770B\u6240\u6709\u7FA4\u90AE\u4EF6</a></div>"
            },
            "nte": {
                sId: "4",
                sItemValue: "<div class=\"ss_drop_item\"><a href=\"javascript:;\"><span class=\"ss_icon ss_icon_note\"></span>\u67E5\u770B\u6240\u6709\u8BB0\u4E8B</a></div>"
            },
            "adv": {
                sId: "2",
                sItemValue: "<div class=\"ss_drop_item ss_drop_split\"><a href=\"javascript:;\">\u9AD8\u7EA7\u641C\u7D22...</a></div>"
            }
        }, a = Scale.fixBodyWidth(document.body.clientWidth - 284), b = 62, d = attr(S("subject"), "fullsearch"),
        e = attr(S("subject"), "newattachfolder");
    new (getTop().QMMenu)({
        oEmbedWin: window,
        nX: a,
        nY: b,
        nWidth: 281,
        oItems: d == 1 ? [c.all, c.att, c.grp, c.nte, c.adv] : [c.all, c.grp, c.nte, c.adv],
...
function navRightMenu(_aoDomObj, _aoEvent) {
    var _oDoc = _aoDomObj.ownerDocument, _oWin = _oDoc.defaultView || _oDoc.parentWindow,
        _anClientX = Scale.fixCursorPos(_aoEvent.clientX, 'x') + bodyScroll(_oWin, 'scrollLeft'),
        _anClientY = Scale.fixCursorPos(_aoEvent.clientY, 'y') + bodyScroll(_oWin, 'scrollTop'),
        _oTarget = getEventTarget(_aoEvent), _sMenuId, _sEtitle, _bIsShowMenu = false, _bIsFsSep = false, _oItemMap = {
            _OPEN: {
                sId: "open",
                sItemValue: '\u6253\u5F00',
                oUrl: T("/cgi-bin/mail_list?sid=$sid$&s=unread&folderid=personal&flag=new&page=0&stype=myfolders&topmails=0")
            },
            _OPEN_NEW: {sId: "opennew", sItemValue: '\u65B0\u7A97\u53E3\u6253\u5F00'},
            _HR: {
                nHeight: 10,
                sItemValue: '<div style="background:#CCC; height:1px; margin-top:5px; overflow:hidden;"></div>'
            },
            _WRITE_GROUP_MAIL: {sId: "writegroupmail", sItemValue: '\u5199\u7FA4\u90AE\u4EF6'},
            _READ_RECORD: {sId: "readrecord", sItemValue: '\u7FFB\u9605\u6240\u6709\u8BB0\u4E8B'},
            _READ_NEW: {sId: "readnew", sItemValue: '\u67E5\u770B\u672A\u8BFB'},
            _WRITE_MESSAGE: {sId: "writemessage", sItemValue: '\u5199\u77ED\u6D88\u606F'},
            _CHECK_MAILING: {sId: "checkmailing", sItemValue: '\u67E5\u8BE2\u6295\u9012\u72B6\u6001'},
            _EMPTY_DEL: {sId: "emptydel", sItemValue: '\u6E05\u7A7A\u5DF2\u5220\u9664'},
            _MARK: {sId: "mark", sItemValue: '\u5168\u90E8\u6807\u4E3A\u5DF2\u8BFB'},
            _CREATE_TAG: {sId: "createtag", sItemValue: '\u65B0\u5EFA\u6807\u7B7E'},
            _SETTING: {sId: "setting", sItemValue: '\u8BBE\u7F6E'},
            _HIDE: {sId: "hide", sItemValue: '\u9690\u85CF\u6B64\u5E94\u7528'},
            _SHOW: {sId: "show", sItemValue: '\u663E\u793A\u6B64\u5E94\u7528'},
            _SHOWHIDE: {sId: "showhide", sItemValue: '\u5E94\u7528\u7BA1\u7406'},
            _CREATE_REMIND: {sId: "createremind", sItemValue: '\u65B0\u5EFA\u63D0\u9192'},
            _UPLOAD: {sId: "upload", sItemValue: '\u4E0A\u4F20\u6587\u4EF6'},
            _ADD_SUBSCRIPTION: {sId: "addsubscription", sItemValue: '\u6DFB\u52A0\u8BA2\u9605'},
            _MANAGE_GROUP_MAIL: {sId: "managegroupmail", sItemValue: '\u7FA4\u90AE\u4EF6\u7BA1\u7406'},
            _CHECK_UNANSWERED: {sId: "checkunanswered", sItemValue: '\u67E5\u8BE2\u672A\u88AB\u56DE\u590D\u72B6\u6001'},
            _DEL_INQUIRY: {sId: "delinquiry", sItemValue: '\u5220\u4FE1\u67E5\u8BE2'},
            _EMPTY_TRASH: {sId: "emptytrash", sItemValue: '\u6E05\u7A7A\u5783\u573E\u7BB1'},
            _MANAGE_SUBSCRIPTION: {sId: "managesubscription", sItemValue: '\u8BA2\u9605\u7BA1\u7406'},
            _WRITE_LOG: {sId: "writelog", sItemValue: '\u5199\u8BB0\u4E8B'},
            _WRITE_DAILY: {sId: "writedaily", sItemValue: '\u5199\u65E5\u5FD7'},
            _RECIEVED_INQUIRY: {sId: "revievedinquiry", sItemValue: '\u6536\u4FE1\u67E5\u8BE2'},
            _REPORT: {sId: "report", sItemValue: '\u4E3E\u62A5\u67E5\u8BE2'},
            _CREATE_FOLDER: {sId: "createfolder", sItemValue: '\u65B0\u5EFA\u6587\u4EF6\u5939'},
            _CREATE_MAILBOX: {sId: "createmailbox", sItemValue: '\u6DFB\u52A0\u5176\u4ED6\u90AE\u7BB1'},
            _MANAGE_FOLDER: {sId: "managefolder", sItemValue: '\u6587\u4EF6\u5939\u7BA1\u7406'},
            _MANAGE_MAILBOX: {sId: "managemailbox", sItemValue: '\u5176\u4ED6\u90AE\u7BB1\u7BA1\u7406'},
            _DEL_FOLDER: {sId: "delfolder", sItemValue: '\u5220\u9664\u6587\u4EF6\u5939'},
            _MANAGE_TAG: {sId: "managetag", sItemValue: '\u6807\u7B7E\u7BA1\u7406'},
            _RECIEVE_RECORD: {sId: "recieverecord", sItemValue: '\u6536\u53D6\u8BB0\u5F55'},
            _RECIEVE_POPMAIL: {sId: "recievepopmail", sItemValue: '\u6536\u53D6\u90AE\u4EF6'},
            _RECIEVE_ALL_POPMAIL: {sId: "recieveallpopmail", sItemValue: '\u5168\u90E8\u6536\u53D6'},
            _DEL_MAILBOX: {sId: "delmailbox", sItemValue: '\u5220\u9664\u6B64\u90AE\u7BB1'},
            _MAILBOX_SETING: {sId: "mailboxsetting", sItemValue: '\u4FEE\u6539\u8BBE\u7F6E'},
            _SHOW_MY_FOLDER: {sId: "showmyfolder", sItemValue: '\u7F6E\u9876\u663E\u793A'},
            _HIDE_MY_FOLDER: {sId: "hidemyfolder", sItemValue: '\u53D6\u6D88\u7F6E\u9876\u663E\u793A'},
            _SHOW_POP_FOLDER: {sId: "showpopfolder", sItemValue: '\u7F6E\u9876\u663E\u793A'},
            _HIDE_POP_FOLDER: {sId: "hidepopfolder", sItemValue: '\u53D6\u6D88\u7F6E\u9876\u663E\u793A'},
            _SHOW_TAG_FOLDER: {sId: "showtagfolder", sItemValue: '\u7F6E\u9876\u663E\u793A'},
            _HIDE_TAG_FOLDER: {sId: "hidetagfolder", sItemValue: '\u53D6\u6D88\u7F6E\u9876\u663E\u793A'}
        }, _oCategoryMap = {
            _NORMAL_OPEN: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._HR],
            _GROUPMAIL: [_oItemMap._WRITE_GROUP_MAIL, _oItemMap._MARK, _oItemMap._HR],
            _NOTEPAD_OPEN: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_RECORD, _oItemMap._HR],
            _MAIL_LIST: [_oItemMap._READ_NEW, _oItemMap._MARK, _oItemMap._HR],
            _SENDED: [_oItemMap._CHECK_MAILING, _oItemMap._CHECK_UNANSWERED],
            _DELETED: [_oItemMap._EMPTY_DEL, _oItemMap._DEL_INQUIRY],
            _TRASH: [_oItemMap._MARK, _oItemMap._EMPTY_TRASH, _oItemMap._HR, _oItemMap._REPORT],
            _MAIL_SUBSCRIPTION: [_oItemMap._READ_NEW, _oItemMap._MARK, _oItemMap._HR, _oItemMap._MANAGE_SUBSCRIPTION],
            _TAG: [_oItemMap._CREATE_TAG, _oItemMap._MANAGE_TAG],
            _MYTAG: [_oItemMap._CREATE_TAG, _oItemMap._HR],
            _SETTING: [_oItemMap._SETTING, _oItemMap._HR],
            _MAILBOX_SETING: [_oItemMap._MAILBOX_SETING, _oItemMap._HR],
            _REMIND: [],
            _ATTACH: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._HR],
            _NOTEPAD: [_oItemMap._WRITE_LOG, _oItemMap._HR],
            _UPLOAD: [_oItemMap._UPLOAD, _oItemMap._HR],
            _READER: [_oItemMap._ADD_SUBSCRIPTION, _oItemMap._WRITE_DAILY, _oItemMap._MARK, _oItemMap._HR],
            _FOLDER_MANAGER: [_oItemMap._CREATE_FOLDER, _oItemMap._MANAGE_FOLDER],
            _MAILBOX_MANAGER: [_oItemMap._CREATE_MAILBOX, _oItemMap._MANAGE_MAILBOX, _oItemMap._HR]
        }, _oMenuMap = {
            "1": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._MAIL_LIST).concat([_oItemMap._RECIEVED_INQUIRY]),
                sName: "recievebox"
            },
            "notsysmsg": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._READ_NEW, _oItemMap._MARK]),
                sName: "personalmsg"
            },
            "sysmsg": {oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._READ_NEW, _oItemMap._MARK]), sName: "sysmsg"},
            "addrvip": {oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW], sName: "addrvip"},
            "starred": {oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW], sName: "starred"},
            "9": {oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._WRITE_MESSAGE]), sName: "message"},
            "8": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._GROUPMAIL).concat([_oItemMap._MANAGE_GROUP_MAIL]),
                sName: "groupmail"
            },
            "4": {oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW], sName: "draftbox"},
            "3": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._MARK]).concat(_oCategoryMap._SENDED),
                sName: "sended"
            },
            "5": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._MARK]).concat(_oCategoryMap._DELETED),
                sName: "deleted"
            },
            "6": {oMenu: _oItems = _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._TRASH), sName: "trashbox"},
            "personal": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_FOLDER, _oItemMap._MANAGE_FOLDER],
                sName: "personal"
            },
            "personalfolders": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_FOLDER, _oItemMap._MANAGE_FOLDER, _oItemMap._SHOW_MY_FOLDER],
                sName: "personalfolders"
            },
            "pop": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._RECIEVE_ALL_POPMAIL, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_MAILBOX, _oItemMap._MANAGE_MAILBOX],
                sName: "pop"
            },
            "popfolders": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._RECIEVE_POPMAIL, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_MAILBOX, _oItemMap._MANAGE_MAILBOX, _oItemMap._SHOW_POP_FOLDER],
                sName: "popfolders"
            },
            "mytopfolders": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_FOLDER, _oItemMap._MANAGE_FOLDER, _oItemMap._HIDE_MY_FOLDER],
                sName: "mytopfolders"
            },
            "poptopfolders": {
                oMenu: [_oItemMap._OPEN, _oItemMap._OPEN_NEW, _oItemMap._READ_NEW, _oItemMap._HR, _oItemMap._RECIEVE_POPMAIL, _oItemMap._MARK, _oItemMap._HR, _oItemMap._CREATE_MAILBOX, _oItemMap._MANAGE_MAILBOX, _oItemMap._HIDE_POP_FOLDER],
                sName: "poptopfolders"
            },
            "tagtopfolders": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._CREATE_TAG, _oItemMap._MANAGE_TAG, _oItemMap._HIDE_TAG_FOLDER]),
                sName: "tagtopfolders"
            },
            "tag": {oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._TAG), sName: "tag"},
            "tagfolders": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat([_oItemMap._CREATE_TAG, _oItemMap._MANAGE_TAG, _oItemMap._SHOW_TAG_FOLDER]),
                sName: "tagfolders"
            },
            "11": {oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._SETTING), sName: "plp"},
            "card": {oMenu: _oCategoryMap._NORMAL_OPEN, sName: "card"},
            "postcard": {oMenu: _oCategoryMap._NORMAL_OPEN, sName: "postcard"},
            "reminder": {oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._REMIND), sName: "reminder"},
            "attach": {oMenu: _oCategoryMap._ATTACH, sName: "attach"},
            "note": {oMenu: _oCategoryMap._NOTEPAD_OPEN.concat(_oCategoryMap._NOTEPAD), sName: "note"},
            "ftn": {oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._UPLOAD), sName: "ftn"},
            "resume": {oMenu: _oCategoryMap._NORMAL_OPEN, sName: 'resume'},
            "billassistant": {oMenu: _oCategoryMap._NORMAL_OPEN, sName: 'billassistant'},
            "mydisk": {oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._UPLOAD), sName: "mydisk"},
            "reader": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._READER).concat(_oCategoryMap._SETTING),
                sName: "reader"
            },
            "morefunction": {oMenu: [_oItemMap._SHOWHIDE], sName: "morefunction"},
            "bookfolders": {
                oMenu: _oCategoryMap._NORMAL_OPEN.concat(_oCategoryMap._MAIL_SUBSCRIPTION),
                sName: "bookfolders"
            }
        }, _oItemFuncMap = {
        ...
        var _oMenu = new QMMenu({
            ...
            onitemclick: function (_asId, _aoItemConfig) {
                ...
                switch (_asId) {
                        ...
                        if (_sMenuId == "reader") {
                            ...
                            QMAjax.send("/cgi-bin/mail_mgr?mailaction=read_all&t=unreadmail_reg_data", {
                                ...
                                content: T('sid=$sid$&folderid=$folderid$&flag=$flag$').replace({
                                    sid: getSid(),
                                    folderid: (_sMenuId == "notsysmsg" || _sMenuId == "sysmsg") ? 1 : _sMenuId,
                                    flag: _osysTag[_sMenuId] || ""
                                }),
                    ...
                    case "showtagfolder":
                        ...
                        _sURL = T("/cgi-bin/foldermgr?t=foldermgr_json&resp_charset=UTF8&ef=js&sid=$sid$&fun=$funvalue$&showtype=$showtype$&$idname$=$id$&kvclick=foldermgr|topfolder|rclick$showtype$|1").replace({
                            funvalue: _sFunValue,
                            showtype: _sShowType,
                            idname: _sIdName,
                            id: _sId,
                    ...
                    case "hidetagfolder":
                        ...
                        if (finds("#folder_" + _sMenuId + " img", document)[0]) {
                            var _sMainUrl = T("/cgi-bin/readtemplate?sid=$sid$&t=checkpwd&delegate_url=$delegate_url$").replace({
                                sid: getTop().getSid(),
                                delegate_url: encodeURIComponent(encodeURIComponent(_sURL + "&lock=true"))
                            });
            ...
            onload: function () {
                ...
                if (_oMenuObj.option("sId") == _sMenuId) {
                    var _nHeight = parseInt(_oMenuObj.option("nHeight")),
                        _nWidth = parseInt(_oMenuObj.option("nWidth")),
                        _oPos = calcAdjPos([_anClientY, _anClientX, _anClientY, _anClientX], _nWidth, _nHeight, _oWin, 1);
...
function mailRightMenu(d, f) {
    var n = d.ownerDocument, q = n.defaultView || n.parentWindow, b = f.clientX + bodyScroll(q, 'scrollLeft'),
        c = f.clientY + bodyScroll(q, 'scrollTop'), a = BaseMailOper, k = a.getInstance(q), l = GelTags('input', d)[0],
        i = l.checked == true;
    if (!k) {
        return;
    }
    ...
    function j(e) {
        var B = [], D = [], F = [], z = 0, C = e.oMail, v = e.sFid == "11" || /^(LP|ZP)/.exec(C[0].sMid), y = C.length,
            t = false, A = {
                nHeight: 10,
                sItemValue: '<div style="background:#CCC; height:1px; margin-top:7px; overflow:hidden;"></div>',
                bDisSelect: true
            },
            I = T(['<div style="white-space:nowrap;zoom:1;">', '<input type="button" class="item_square flagbg$flagbg$"/>', '<span class="item_square_txt">$name$ &nbsp</span>', '</div>']);
            ...
            if (!t) {
                B.push({
                    ...
                    oSubMenu: {
                        ...
                        oItems: [{
                            nHeight: 350,
                            sItemValue: T('<div scroll="true" id="pre" style="height:350px;width:438px;overflow-x:hidden;overflow-y:auto;"><div style="*margin:100px 0 0 0;height:64px;text-align:center;width:100%;"><center><img src="$images$ico_loading2.gif"/></center></div></div>').replace({images: getPath("image")})
                        }],
                        onload: function () {
                            ...
                            QMAjax.send(T('/cgi-bin/readmail?sid=$sid$&folderid=$f$&t=quickreadmail&mailid=$m$&mode=preview&maxage=3600&ver=$v$').replace({
                                ...
                                method: 'GET', onload: function (M, O, N) {
                                    if (M) {
    ...
    var g = null, r = unikey(), p = new QMMenu({
        sId: r,
        oEmbedWin: q,
        nWidth: "auto",
        nMaxWidth: 180,
        ...
        onload: function () {
            var u = this;
            if (u.option("sId") == r) {
                var e = parseInt(u.option("nHeight")), t = parseInt(u.option("nWidth")),
                    v = calcAdjPos([c, b, c, b], t, e, q, 1);
...
(function (a) {
    ...
    function b(g, f) {
        ...
        QMAjax.send(h, {
            method: "GET", content: null, onload: function (i, k, j) {
                var l = evalValue(k);
                if (l.members) {
    ...
    a.showGGoupMember = function (g, f) {
        ...
        b(g, function (k) {
            if (d[g]) {
                var m = calcPos(f), l = [{
                    nHeight: 35,
                    sItemValue: '<div class="bold black"><img title="\u7FA4\u90AE\u4EF6" src="/zh_CN/htmledition/images/spacer.gif" class="lm_groupAutoIcon" style="margin-left:0;"/>' + g.replace(/@.*/, "") + ' \u90AE\u4EF6\u7EC4\u6210\u5458</div>'
                }, {
                    nHeight: 8,
...
;(function () {
    ...
    var b = getTop(),
        c = ['data:image/webp;base64,UklGRiQAAABXRUJQVlA4IBgAAAAwAQCdASoBAAEAAwA0JaQAA3AA/vuUAAA=', 'data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA==', 'data:image/webp;base64,UklGRh4AAABXRUJQVlA4TBEAAAAvAAAAAAfQ//73v/+BiOh/AAA='];
    var a = function (g, f) {
        var h = new Image();
        h.onload = function () {
            if (h.width == 1) {
