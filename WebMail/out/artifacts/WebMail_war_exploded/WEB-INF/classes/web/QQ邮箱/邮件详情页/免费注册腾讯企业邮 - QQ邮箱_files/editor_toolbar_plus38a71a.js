(function (a, b) {
    ...
    QMEditor.FUNCLIB.Mo = QMEditor.FUNCLIB.inheritFrom(function (c) {
        ...
        e.setUiConfig({
            arrowPos: e.getFuncConfig().arrowPos || e.getFuncConfig().width / 2 || 224,
            title: d.FUN_MO,
            label: d.FUN_MO_LABEL
        });
    }, QMEditor.FUNCLIB.MENU);
    QMEditor.FUNCLIB.Mo.prototype.getMenuUI = function (c) {
        var d = c.nWidth = this.getFuncConfig().width || 448;
        return a.T('<div id="mo_cntr" style="width:$width$px"><div class="qmEditorToolLoading"><img align="absmiddle" src="$images_path$ico_loading21e9c5d.gif">&nbsp;&nbsp;\u52A0\u8F7D\u4E2D</div></div>').replace({
            width: d,
    ...
    QMEditor.FUNCLIB.Mo.prototype.initMenu = function (c) {
        ...
        if (!window.QMMo) {
            var d = this;
            a.loadJsFile("$js_path$/com/kits/qmeditor/base/release/plus/mo24e6ae.js", true, document, function () {
                if (!window.QMMo) {
...
(function (A, _aoUndefined) {
    ...
    QMEditor._ActiveX.prototype._modelDialog = function (_afOnCloseEvent) {
        ...
        new (A.QMDialog)({
            sId: "upload",
            sTitle: _oLanguage.PO_DLG_TITLE,
            sBodyHtml: _oTemplate.DIALOG_UPLOADIMG.replace({
                imgPath: A.getPath("image"),
                langUploading: _oLanguage.PO_DLG_UPLOADING,
                langUploadFail: _oLanguage.PO_DLG_UPLOADFAIL
            }),
            nWidth: 400,
            bAnimation: false,
            onclose: function () {
    ...
    QMEditor._ActiveX.prototype._processResponse = function (_asResponse, _afOnUploadFinishEvent) {
        var _sResponse = _asResponse || "", _nStart = _sResponse.indexOf('On_upload("'),
            _nEnd = _sResponse.indexOf('");', _nStart),
            _sRealResponse = (_nStart != -1 && _nEnd != -1) ? _sResponse.substring(_nStart + 11, _nEnd) : "err";
        ...
        if (_nStart != -1 && _nEnd != -1) {
            ...
            return _afOnUploadFinishEvent(false, {
                curSize: _formatSize(_sRealResponse[0]),
                allowSize: _formatSize(_sRealResponse[1])
            });
        }
        return _afOnUploadFinishEvent(false);
    };
    ...
    QMEditor.prototype.insertImage = function (_asUrl, _afCallback, _aoMapObj) {
        var _oSelf = this, _sFileSizeExpression = _asUrl.match(/filesize=.*&/),
            _sFileSize = _sFileSizeExpression && _sFileSizeExpression[0],
            _nFileSize = _sFileSize && parseInt(_sFileSize.split('=')[1]);
    ...
    QMEditor.FUNCLIB.Photo = QMEditor.FUNCLIB.inheritFrom(function (_aoParamSet) {
        ...
        var _oSelf = this, _oEditor = _oSelf.getBindEditor(), _oLang = _oEditor.getLanguage(),
            _oPhotoMethods = _oSelf._moPhotoMethods = [];
        ...
        (_oSelf.getFuncConfig().album === true && _oEditor.getEditorAreaWin().location.protocol == 'http:') && _oPhotoMethods.push({
            sId: "qzone",
            sItemValue: _oLang.PO_QQALBUM_DESC
        });
        (_oSelf.getFuncConfig().attach === true) && _oPhotoMethods.push({
            sId: "attach",
            sItemValue: _oLang.PO_ATTACH_PHOTO
        });
        if (_oSelf.getFuncConfig().iPhoneUpload === true) {
            _oPhotoMethods.push({
                sId: "webapns",
                sItemValue: "\u4ECE\u624B\u673A\u76F8\u518C\u4E0A\u4F20<span class='ico_mobileapp'></span>"
            });
            QMEditor.getTopWin().requestShowTip("QMEditorToolBarPlusArea", 48, QMEditor.getTopWin().getMainWin());
        }
        this.setUiConfig({
            moreBtn: _bIcon ? 0 : _oPhotoMethods.length > 1,
            title: _oLang.FUN_PHOTO,
            label: _oLang.FUN_PHOTO_LABEL
        });
    ...
    QMEditor.FUNCLIB.Photo.prototype.getMenuUI = function (_aoMenuCfg) {
        ...
        switch (_aoMenuCfg.sName) {
            case "qzone":
                ...
                return A.getRes('<div id="qzone" class="qzone_container" style="text-align:center;"><div style="text-align:center; margin:110px 0;"><img src="$images_path$ico_loading21e9c5d.gif" align="absmiddle" />&nbsp;&nbsp;\u52A0\u8F7D\u4E2D</div></div>');
            case "attach":
                _oMenuCfg.nWidth = 364;
                _oMenuCfg.nArrowPos = _aoMenuCfg.nWidth / 2;
                return A.getRes(['<div class="QMEditorToolPop">', '<h1 class="qmEditorHead">\u9644\u4EF6\u5939\u6536\u85CF\u56FE\u7247</h1>', '<div class="qmEditorPicContent" id="content">', '<div class="clr" id="contentclr"></div>', '<div class="qzone_container" style="text-align:center; height:132px; padding-top:110px;"><img src="$images_path$ico_loading21e9c5d.gif" align="absmiddle"/>&nbsp;&nbsp;\u52A0\u8F7D\u4E2D</div>', '</div>', '</div>']);
            case "webapns":
                getTop().LogKV("compose|toolbar|entrance|photo|tel");
                var _oTop = QMEditor.getTopWin(),
                    _nIosWebAppVer = parseInt(QMEditor.getTopWin().goUserInfo.get("IOSWEBAPPVER"), 10) || 0,
                    _nIosWebAppVerNew = QMEditor.getTopWin().goUserInfo.get("IOSWEBAPPVERNEW"),
                    _nAndroidWebAppVer = parseInt(QMEditor.getTopWin().goUserInfo.get("ANDROIDWEBAPPVER"), 10) || 0,
                    _sKey = (new Date()).valueOf(), _sTitle2 = "", _sDesc = "", _oImgPath = [];
            ...
            function moveProcess(_aoDom, _anCurrent, _anPercent) {
                var _nCnt = 1, _nLength = (_anCurrent - 1) * _anPercent, _nStep = 5,
            ...
            function doWpns(_anStep) {
                var _oUpDlg = new (A.QMDialog)({
                    ...
                    onclose: function () {
                        ...
                        _oTop.QMAjax.send(getTop().T("/cgi-bin/webapnscheck?sid=$sid$&action=clearindex").replace({sid: getTop().getSid()}), {
                ...
                (_nIosWebAppVer == "1" || _nAndroidWebAppVer == "1") && _oTop.QMAjax.send(_oTop.T("/cgi-bin/webapnscheck?sid=$sid$&key=$key$").replace({
                    sid: _oTop.getSid(),
                    key: _anStep ? "" : _sKey
                }), {
                    method: "POST", onload: function () {
                        ...
                        _oSelf._oTimer = setInterval(function () {
                            _oTop.QMAjax.send(_oTop.T("/cgi-bin/webapnscheck?sid=$sid$&key=$key$&action=checkappimg").replace({
                                sid: _oTop.getSid(),
                                key: _sKey
                            }), {
                                method: "POST", onload: function (_abIsOk, _asParam) {
                                    if (_abIsOk && _oSelf._bIpUploading) {
                                        var _oResult = evalValue(_asParam), _sHTML = "", _sUrl,
                                            _oVecThumbnail = _oResult.Thumbnailurl || [], _nTotal = _oResult.total || 1,
                                            _oVecImg = _oResult.imgurl || [], _oProcess = _oUpDlg.S("uploadprocess"),
                ...
                if ((_nIosWebAppVer == "1" || _nAndroidWebAppVer == "1")) {
                    ...
                    var _oDownDlg = new (A.QMDialog)({
                        sId: "download",
                        sTitle: "\u4ECE\u624B\u673A\u76F8\u518C\u4E0A\u4F20",
                        sBodyHtml: A.T(['<div class="uploadfromapp_wrap" id="content">', '<ul class="uploadfromapp_step">', '<li class="ufa_actived">1.\u626B\u63CF\u4E8C\u7EF4\u7801</li>', '<li>2.$stitle2$</li>', '<li class="ufa_last">3.\u4ECE\u624B\u673A\u4E0A\u4F20\u7167\u7247</li>', '</ul>', '<div class="uploadfromapp_qr">', '<img src="/cgi-bin/generate_twodimcode?sid=$sid$&action=appdownload&skey=$skey$" />', '<div class="ufa_angle1"></div>', '<div class="ufa_angle2"></div>', '<div class="ufa_angle3"></div>', '<div class="ufa_angle4"></div>', '</div>', '<p class="ufa_intro">$sdesc$&nbsp;<a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&no=1001015&&id=23" target="_blank">\u5E2E\u52A9</a></p>', '</div>']).replace({
                            sid: getTop().getSid(),
                            skey: _sKey,
                            stitle2: _sTitle2,
                            sdesc: _sDesc
        ...
        if (_aoMenuCfg.sName == "url") {
            ...
            A.addEvent(_aoMenu.S("content"), "scroll", function (_aoEvent) {
                if (!_oSelf._mbLoadingAttach) {
                    var _oContent = _aoMenu.S("content"), _nOffsetHeight = _oContent.offsetHeight,
                        _nClientHeight = _oContent.clientHeight, _nScrollTop = _oContent.scrollTop;
    ...
    QMEditor.FUNCLIB.Photo.prototype.doMenuShow = function (_aoMenu, _aoMenuCfg) {
        ...
        if (!_sName && _oSelf.getUiType() == 'icon' && _oSelf._moPhotoMethods[0].sId == 'upload') {
            ...
            A.loadJsFile("$js_path$/qmqzoneimg24e6b9.js", true, A.window.document, function () {
                if (!_aoMenu.isClose()) {
                    A.window.QMQzoneImg.selectInMenu({
                        oContainer: _aoMenu.S("qzone"),
                        onclick: function (_anLabelIdx, _anListIdx, _aoPhoto, _anScrollTop) {
                            _aoMenu.close();
    ...
    QMEditor.FUNCLIB.Photo.prototype._showAttachImage = function (_aoMenu) {
        ...
        var _oSelf = this,
            _sUrl = A.T("/cgi-bin/attachfolder?topmails=0&s=search&folderid=attach&hflag=attach&t=attachfolder.json&subject=&sender=&receiver=&searchmode=attach&advancesearch=0&showattachtag=1&perpage=18&filetype=1&action=list&func=getimage&page=$page$&sid=$sid$&resp_charset=UTF8&&ef=js").replace({
                page: _oSelf._mnAttachNextPage,
                sid: A.getSid()
            }),
            _sATTACH_FAIL = A.T(['<div style="text-align:center; line-height:1.5; margin-top:90px;">\u52A0\u8F7D\u5931\u8D25\uFF0C<a href="javascript:void(0);" retry="1">\u91CD\u8BD5</a>\u3002</div>']),
            _sATTACH_NONE = A.T(['<div style="text-align:center; line-height:1.5; margin-top:90px;">\u60A8\u7684\u9644\u4EF6\u5939\u6536\u85CF\u4E2D\u6682\u65E0\u56FE\u7247\u3002<br/>\u5C06\u91CD\u8981\u56FE\u7247\u6536\u85CF\u8D77\u6765\uFF0C\u5373\u53EF\u5728\u5199\u4FE1\u4E2D\u5FEB\u901F\u6DFB\u52A0\u3002</div>']),
            _sATTACH_CONTENT = A.TE(['$@$for($oList$)$@$', '<div class="left pointer qmEditorPicSelect"', ' onmouseover="this.className=\x27left pointer  qmEditorPicSelect bd\x27;"', ' onmouseout="this.className=\x27left pointer  qmEditorPicSelect\x27;"', '>', '<table cellspacing="0" cellpadding="0"><tbody><tr><td valign="absmiddle">', '<img src="', getTop().QMDistributeDomain.getHost(), '$sIconUrl$" viewurl="$sUrl$" mailid="$sMailId$" attachid="$sAttachId$" attachname="$sAttachName$" fileextenal="$sFileExt$" filebyte="$sFileByte$" style="width:100px;"/>', '</td></tr></tbody></table>', '</div>', '$@$endfor$@$', '']);
        A.show(_aoMenu.S("content").lastChild, 1);
        A.QMAjax.send(_sUrl, {
            method: "GET", onload: function (_abIsOk, _asParam, _aoXmlObj) {
                _oSelf._mbLoadingAttach = false;
                if (_abIsOk) {
                    try {
    ...
    QMEditor.FUNCLIB.Photo.prototype._insertAttachImage = function (_aoImage) {
        var _oSelf = this, _sId = "loadimg", _oEditor = _oSelf.getBindEditor(), _oTemplate = _oEditor.getTemplate(),
            _oLanguage = _oEditor.getLanguage();
        new A.QMDialog({
            sId: _sId,
            sTitle: "\u52A0\u8F7D\u56FE\u7247",
            sBodyHtml: _oTemplate.DIALOG_UPLOADIMG.replace({
                imgPath: A.getPath("image"),
                langUploading: _oLanguage.PO_DLG_INSERTING,
                langUploadFail: _oLanguage.PO_DLG_INSERTINGFAIL
            }),
            nWidth: 400,
            bAnimation: false,
            onclose: function () {
        ...
        A.getAttachList([{
            mailid: _aoImage.getAttribute("mailid"),
            attachid: _aoImage.getAttribute("attachid"),
            attachname: _aoImage.getAttribute("attachname"),
            fileextenal: _aoImage.getAttribute("fileextenal"),
            filebyte: _aoImage.getAttribute("filebyte")
        }], function (_abIsOk, _aoParam) {
            if (_abIsOk && _aoParam) {
    ...
    QMEditor.FUNCLIB.Photo.prototype._uploadingDlg = function (_asOpt, _anPercent, _anCnt, _anFileIdx) {
        ...
        if (_asOpt == "close") {
            ...
            var _oEditor = _oSelf.getBindEditor(), _oTemplate = _oEditor.getTemplate(),
                _oLanguage = _oEditor.getLanguage();
            ...
            new (A.QMDialog)({
                ...
                sBodyHtml: _oTemplate.DIALOG_UPLOADIMG.replace({
                    imgPath: A.getPath("image"),
                    langUploading: _oTemplate.PO_DLG_UPLOADING.replace({cnt: _anCnt, idx: _anFileIdx || 0}),
                    langUploadFail: _oLanguage.PO_DLG_UPLOADFAIL
                }),
                nWidth: 400,
                bAnimation: false,
    ...
    QMEditor.FUNCLIB.Photo.prototype._initUpload = function (_aoUploadDom) {
        ...
        _oPicUpload = _oTop.QMFileUpload.create("popup", {
            utype: utype,
            oContainer: _aoUploadDom,
            nTimeout: 2000,
            oQueryData: {
                widthlimit: _oConf.widthlimit || 0,
                heightlimit: _oConf.heightlimit || 0,
                sizelimit: _oConf.sizelimit || 0
            },
            onbeforepopupselect: function () {
                _oSelf.hideMenu();
            },
    ...
    QMEditor.FUNCLIB.Photo.prototype._next = function () {
        var _oSelf = this, _oFileList = _oSelf._moFileList, _nIndex = _oSelf._mnIndex,
            _nLen = _oFileList && _oFileList.length || 0, _oFile = _nIndex < _nLen && _oFileList[_nIndex];
        if (_oFile) {
    ...
    (function (_aoWin) {
        var _S_SCREENSNAP_EXTENSION_ID = "gicmopcfdmkpokppfpnkmgebcaohbffc", _oTop = _aoWin, _bScreenSnaping = false,
            _bHeartbeat = false;
        QMEditor.FUNCLIB.ScreenSnap = QMEditor.FUNCLIB.inheritFrom(function (_aoParamSet) {
            ...
            this.setBindEditor(_aoParamSet.editor);
            this._updateUIInfo();
            var _oSelf = this, _oEditor = this.getBindEditor(), _oActiveX = QMEditor._ActiveX._bind(_oEditor),
                _sTmpEditerContent = "", _bCanInstallEx = A.gbIsIE || A.QMAXInfo.mbAblePlugin, _nTimeout;
        ...
        QMEditor.FUNCLIB.ScreenSnap.prototype._updateUIInfo = function () {
            ...
            this.setUiConfig({
                clsName: _bIsEnabled ? "" : "qmEditorScreenSnapDisable",
                title: _bIsEnabled ? _oLang.FUN_SCREENSNAP : _oLang.FUN_SCREENSNAP_SETUP_TIP,
                label: _oLang.FUN_SCREENSNAP_LABEL
            });
        };
        QMEditor.FUNCLIB.ScreenSnap.prototype._screenSnapByNew = function () {
            ...
            if (_bHeartbeat) {
                ...
                if (_oTop.isCanConnectGoogle.result === false) {
                    ...
                    var _sBroserDesc = _oTop.gbIsEdge ? "Microsoft Edge\u6D4F\u89C8\u5668" : "Chrome\u6D4F\u89C8\u566842\u6216\u4EE5\u4E0A\u7248\u672C",
                        _sMore = _oTop.gbIsEdge ? "" : '<a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&id=10000&&no=1001245" target="_blank">\u4E86\u89E3\u66F4\u591A</a>';
                    _oTop.confirmBox({
                        title: "\u6E29\u99A8\u63D0\u793A",
                        msg: ['<div class="dialog_f_t" style="font-weight: normal;">\u4F60\u6B63\u5728\u4F7F\u7528\u7684\u662F', _sBroserDesc, '\uFF0C\u6682\u4E0D\u652F\u6301\u622A\u5C4F\u529F\u80FD\u3002<br/>\u62B1\u6B49\u7ED9\u4F60\u5E26\u6765\u4E86\u56F0\u6270\uFF0C\u6211\u4EEC\u5C06\u5C3D\u5FEB\u4F18\u5316\u3002', _sMore, '</div>'].join(""),
                        confirmBtnTxt: '\u786E\u5B9A',
                        mode: "alert",
        ...
        QMEditor.FUNCLIB.ScreenSnap.prototype._showInstallactiveNew = function () {
            _oTop.confirmBox({
                title: "QQ\u90AE\u7BB1\u622A\u5C4F\u63D2\u4EF6",
                msg: ['<div class="dialog_f_t" style="font-weight: normal;margin-top:3px;">\u4F7F\u7528\u622A\u5C4F\u529F\u80FD\uFF0C\u9700\u8981\u4E0B\u8F7D\u5B89\u88C5QQ\u90AE\u7BB1\u622A\u5C4F\u63D2\u4EF6\u3002</div>'].join(""),
                confirmBtnTxt: "\u4E0B\u8F7D\u5B89\u88C5",
                onreturn: function (_abIsOk) {
                    if (_abIsOk) {
    ...
    QMEditor.FUNCLIB.Music = QMEditor.FUNCLIB.inheritFrom(function (_aoParamSet) {
        ...
        _oSelf.setUiConfig({
            arrowPos: 160,
            fBeforeclose: _oSelf._fBeforeclose,
            title: _oLang.FUN_MUSIC,
            label: _oLang["FUN_MUSIC_LABEL"]
        });
    ...
    QMEditor.FUNCLIB.Music.prototype.getMenuUI = function () {
        return A.T('<div class="qmEditorMusicCntr qmEditorToolLoading"><img align="absmiddle" src="$images_path$ico_loading21e9c5d.gif">&nbsp;&nbsp;\u52A0\u8F7D\u4E2D</div>').replace({images_path: A.getPath("image", true)});
    };
    QMEditor.FUNCLIB.Music.prototype.initMenu = function (_aoMenuObj, _aoConfig) {
        ...
        if (!window.QMBgMusic) {
            _oEditor.loadFile({"$js_path$/com/kits/qmeditor/qqmail/release/plus/bgmusic25194d.js": true}, function () {
                if (!window.QMBgMusic) {
    ...
    QMEditor.FUNCLIB.Music.prototype._confirm = function (_afAction) {
        ...
        _oTop.confirmBox({
            title: "\u6DFB\u52A0\u80CC\u666F\u97F3\u4E50",
            msg: T(['<div class="dialog_f_t">$name$</div>', '<div class="dialog_f_d">\u81F3\u591A\u6DFB\u52A0\u4E00\u9996\u80CC\u666F\u97F3\u4E50</div>']).replace({name: _oEditor.getLanguage().MC_REPLACE_TIP}),
            confirmBtnTxt: '\u786E\u5B9A',
            cancelBtnTxt: '\u53D6\u6D88',
            onreturn: function (_abIsOk) {
                _abIsOk && _afAction();
    ...
    QMEditor.FUNCLIB.Music.prototype._initMenuForMo = function (_aoMenuObj) {
        ...
        _oSelf._moMusicPanel.setup({
            container: _oItemContainer,
            height: '175px',
            width: '265px',
            num: _oSelf._mnNumPerPage,
            menuObj: _aoMenuObj,
            style: _oEditor.getTemplate().STYLE,
            onselectmusic: function (_asSong, _asSinger, _asUrl) {
                function insert() {
    ...
    QMEditor.FUNCLIB.Map.prototype._dofaultClick = function (_avDefaultLocation) {
        ...
        var _oDialog = new (A.QMDialog)({
            sId: "id_compose_editor_map_center",
            sTitle: "\u63D2\u5165\u5730\u56FE",
            nWidth: 467,
            sBodyHtml: '<div id="div_content_body" style="height:400px;"></div>',
            bAnimation: false,
            onload: function () {
    ...
    QMEditor.FUNCLIB.Map.prototype.initMenu = function (_aoMenuObj, _aoConfig) {
        ...
        if (!window.QMMap) {
            _oEditor.loadFile({"$js_path$/com/kits/qmeditor/qqmail/release/plus/map2626db.js": true}, function () {
                if (!window.QMMap) {
                    _oItemContainer.innerHTML = '<div class="qmEditorMusicCntr">\u52A0\u8F7D\u5931\u8D25</div>';
                }
                else {
    ...
    QMEditor.FUNCLIB.Map.prototype._initMenuForMo = function (_aoMenuObj) {
        ...
        _oSelf._moMapPanel.setup({
            container: _oItemContainer,
            defaultLocation: _oSelf._mvDefaultLocation || "",
            height: '175px',
            width: '265px',
            num: _oSelf._mnNumPerPage,
            menuObj: _aoMenuObj,
            style: _oEditor.getTemplate().STYLE,
            onselectMap: function (_asSong, _asSinger, _asUrl) {
    ...
    (function (A, _aoUndefined) {
        ...
        var _oKeywordKvObj = {"province": "\u7701", "city": "\u5E02", "area": "\u533A", "county": "\u53BF"},
            _sMapDomain = getTop().isHttp() ? "map.qq.com" : "apis.map.qq.com",
            _sMapUnikKey = "UH3BZ-CYLKV-RHTPL-UAGSL-DRA4V-VGFSJ";
        QMMap.prototype.ZoomControl = function (_aoConfig) {
            var _oContext = _aoConfig.context, _oTop = getTop(), _oMap = _aoConfig.map, _oWin = _aoConfig.win,
                _sTemp = QMMap._TEMPLATE._ZOOM_CONTROL_.replace(), _oZoomDiv, _oCenterPosition;
        ...
        QMMap.prototype.getIconUrl = function (_asSuffix) {
            var _sBasePath = ["com/kits/qmeditor/base/images/newicon/icon_location", _asSuffix, ".png"].join(""),
                _oTop = getTop(), _sTopHost = getTop().location.hostname, _sIconUrl;
            if (/dev/i.test(_sTopHost)) {
                ...
                if (_asSuffix == "_2x") {
                    _sIconUrl = _oTop.getRes("$js_path$com/kits/qmeditor/base/images/newicon/icon_location_2x24c44c.png");
                }
                else if (!_asSuffix) {
                    _sIconUrl = _oTop.getRes("$js_path$com/kits/qmeditor/base/images/newicon/icon_location24c44c.png");
                }
        ...
        QMMap.prototype.Marker = function (_aoConfig) {
            var _oContext = _aoConfig.context, _oLocation = _aoConfig.location, _oMap = _aoConfig.map,
                _oWin = _aoConfig.win;
        ...
        function ImageMapType() {
            ...
            var earthlayer = new _oWin.qq.maps.ImageMapType({
                name: '\u9AD8\u6E05\u5E95\u56FE',
                alt: '\u9AD8\u6E05\u5E95\u56FE',
                tileSize: new _oWin.qq.maps.Size(128, 128),
                minZoom: 1,
                maxZoom: 18,
        ...
        QMMap.prototype._initUI = function (_aoConfig) {
            var _oSelf = this, _oMenuObj = _oSelf._moMenuObj, _oTemplate = QMMap._TEMPLATE, _oParam = {
                style: _aoConfig.style,
                images_path: A.getPath("image", true),
                result: _oTemplate._INFO.replace({info: "\u8BF7\u8F93\u5165\u5173\u952E\u5B57\u8FDB\u884C\u641C\u7D22"}),
                sid: A.getSid()
            };
        ...
        QMMap.prototype._beforeLoadPrev = function () {
            var _oTop = getTop(), _oSelf = this, _oMenuObj = _oSelf._moMenuObj, _oDivLoading = _oSelf._moDivLoading,
                _oDivWelcome = _oSelf._moDivWelcome, _oInputPlaceSearch = _oSelf._moInputPlaceSearch,
                _oDomSearchDesc = _oMenuObj.S("span_searchDesc");
        ...
        QMMap.prototype._loadPrev = function () {
            ...
            var _oTop = getTop(), _oSelf = this, _oMenuObj = _oSelf._moMenuObj,
                _oInputPlaceSearch = _oSelf._moInputPlaceSearch;
            if (_oSelf._mvDefaultLocation) {
                if ((typeof _oSelf._mvDefaultLocation).toLowerCase() == "string") {
                    ...
                    var _oPrevMapCfg = _oSelf._mvDefaultLocation, _oDivLoading = _oSelf._moDivLoading,
                        _oLatLng = _oSelf.getLatLng(_oPrevMapCfg.pos), _oDomPlaceDetail = _oMenuObj.S("placedetail");
                    ...
                    _oSelf._moCurrentPos = {
                        "title": _oPrevMapCfg.title,
                        "address": _oPrevMapCfg.posDesc,
                        "location": _oLatLng
                    };
        ...
        QMMap.prototype._fBeforeclose = function () {
            var _oSelf = this, _oTop = getTop(), _oMenuObj = _oSelf._moMenuObj, _bIsNeedMemory = !_oSelf._mbIsFinished,
                _oInputPlaceSearch = _oSelf._moInputPlaceSearch, _oDomPlaceDetail = _oMenuObj.S("placedetail");
            if (_bIsNeedMemory && _oSelf._moMap) {
                _oTop._oPrevMapCfg_ = {
                    title: _oTop.htmlEncode(_oInputPlaceSearch.value),
                    address: _oTop.htmlEncode(_oDomPlaceDetail.innerHTML),
                    mapCenterLocation: _oSelf._moMap.getCenter(),
                    markerLocation: _oSelf._moMarker.getPosition(),
                    currentPos: _oSelf._moCurrentPos
                };
            }
            else {
        ...
        QMMap.prototype._setData = function () {
            var _oSelf = this, _oMenuObj = _oSelf._moMenuObj, _oDivMapContainer = _oMenuObj.S("mapContainer"),
                _oDivResultDom = _oMenuObj.S("resultData"), _oDomNearByPlaceDetail = _oMenuObj.S("nearByPlacedetail"),
                _oInputPlaceSearch = _oMenuObj.S("searchText"), _oDivError = _oMenuObj.S("div_error"),
                _oDivLoading = _oMenuObj.S("div_loading"), _oDivWelcome = _oMenuObj.S("div_welcome"),
                _oDivPlaceDetail = _oMenuObj.S("placedetail"),
                _oSpanResultTitleText = _oMenuObj.S("span_resultTitleText"),
                _oDivLocation = _oMenuObj.S("div_location");
        ...
        QMMap.prototype._getCityNameByLocalIp = function () {
            ...
            citylocation = new _oWin.qq.maps.CityService({
        ...
        QMMap.prototype.setCenter = function (_avlocation) {
            var _oSelf = this, _oMainWin = _oSelf._moWin, _oDivMapContainer = _oSelf._moDivMapContainer,
                _oDivLocation = _oSelf._moDivLocation, _oLatLng = _oSelf.getLatLng(_avlocation), _oLocArr;
        ...
        QMMap.prototype.createMap = function (_avLatLng) {
            ...
            var _oSelf = this, _oMainWin = _oSelf._moWin, _oDivMapContainer = _oSelf._moDivMapContainer,
                _oLocation = _oSelf.getLatLng(_avLatLng), _oMap;
            _oMap = _oSelf._moMap = new _oMainWin.qq.maps.Map(_oDivMapContainer, {
                center: _oLocation,
                panControl: false,
                ...
                mapTypeControlOptions: {mapTypeIds: ['earth']},
                zoomControlOptions: {style: _oMainWin.qq.maps.ZoomControlStyle.SMALL}
            });
        ...
        QMMap.prototype._setEvent = function () {
            var _oSelf = this, _oTop = getTop(), _oMenuObj = _oSelf._moMenuObj, _oDomSearch = _oMenuObj.S("searchText"),
                _oDomSearchDesc = _oMenuObj.S("span_searchDesc"), _oDomPlaceDetail = _oMenuObj.S("placedetail"),
                _oDomNearByPlaceDetail = _oMenuObj.S("nearByPlacedetail"), _oDomResultData = _oMenuObj.S("resultData"),
                changePlaceholder = function (_aoEvent) {
                    var _oTarget = _oTop.getEventTarget(_aoEvent);
            ...
            _oMenuObj.S("span_confirm").onclick = function () {
                ...
                var _oPosition = _oSelf._moMarker.getPosition(), _nZoomTemp = _oSelf._moMap.getZoom(),
                    _oCenter = _nZoomTemp < 4 ? _oPosition : _oSelf._moMap.getCenter(),
                    _sCenter = [_oCenter.getLat(), ",", _oCenter.getLng()].join(""),
                    _nZoom = _nZoomTemp < 4 ? 4 : _nZoomTemp,
                    _sPosition = [_oPosition.getLat(), ",", _oPosition.getLng()].join(""),
                    _sUriEncdeKeyWord = encodeURIComponent(_oDomPlaceDetail.innerHTML),
                    _sPoiTitle = _oTop.attr(_oDomPlaceDetail, "title"),
                    _sUrl = ["apis.map.qq.com/ws/staticmap/v2/?insertmap=1&key=", _sMapUnikKey, "&size=425*250&scale=2&center=", _sCenter, "&zoom=", _nZoom, "&markers=icon:", encodeURIComponent(_oSelf.getIconUrl("_2x")), "|label:A|", _sPosition].join("");
                _oSelf._moEditor.insertImage(A.getRes("$images_path$ico_loading21e9c5d.gif"), function () {
                ...
                function insertMap(_asUrl) {
                    _oSelf._moEditor.insertImage(_asUrl, function () {
                        ...
                        bIsFromMap: true,
                        originUrl: _sUrl,
                        searchkeyword: _oDomSearch.value,
                        title: htmlEncode(_sPoiTitle),
                        center: htmlEncode(_sCenter),
                        zoom: _nZoomTemp,
                        pos: htmlEncode(_sPosition),
                        detaildesc: htmlEncode(_oDomPlaceDetail.innerHTML),
                        sMapRedirectUrl: ["http://apis.map.qq.com/uri/v1/marker?referer=qqmail&marker=coord:", _sPosition, ";title:", encodeURIComponent(_sPoiTitle), ";addr:", _sUriEncdeKeyWord].join("")
                    });
                }

                QMAjax.send("/cgi-bin/postcard", {
                    content: _oTop.T("sid=$sid$&layerxml=$layerxml$").replace({
                        sid: _oTop.getSid(),
                        layerxml: encodeURIComponent(QMMap._TEMPLATE._LAYER_XML.replace({
                            mapurl: htmlEncode(_sUrl),
                            title: _oTop.attr(_oDomPlaceDetail, "title"),
                            address: _oDomPlaceDetail.innerHTML,
                            hideTitle: _sPoiTitle ? 0 : 1
                        }))
            ...
            A.addEvent(_oMenuObj.S("allPlace"), "click", function (_aoEvent) {
                var _oTarget = A.getEventTarget(_aoEvent);
                if (_oTarget) {
                    var _sParam = _oTarget.getAttribute("param") || _oTarget.parentNode.getAttribute("param"),
                        _oTarget = _oTarget.getAttribute("param") ? _oTarget : _oTarget.parentNode, _oAddress,
                        _sLocation, _nCurPage;
                    switch (_sParam) {
                        case "me":
                            if ((_sLocation = _oTarget.getAttribute("sLocation")) && _sLocation) {
                                ...
                                if (_oAddress && _oAddress.length > 0) {
                                    _oSelf._saveLocation({
                                        title: _oAddress[0].innerHTML,
                                        address: _oAddress[1].innerHTML
                                    });
            ...
            A.addEvent(_oDomResultData, "click", function (_aoEvent) {
                ...
                if (_oTarget) {
                    var _sParam = _oTarget.getAttribute("param") || _oTarget.parentNode.getAttribute("param"),
                        _oTarget = _oTarget.getAttribute("param") ? _oTarget : _oTarget.parentNode, _sLocation, _sTitle,
                        _sAddress, _oSpans, _oAddress, _nCurPage;
                    if (_sParam == "me") {
                        if ((_sLocation = _oTarget.getAttribute("sLocation")) && _sLocation) {
                            A.show(_oSelf._moDivLoading, true);
                            A.show(_oSelf._moSpanResultTitleText, false);
                            ...
                            function showMap() {
                                _oSelf._moCurrentPos = {
                                    "title": _sTitle,
                                    "address": _sAddress,
                                    "location": _oSelf.getLatLng(_sLocation)
                                };
                                _oSelf.createMap(_sLocation);
                                A.show(_oSelf._moDivLoading, false);
                                _oSelf.setCenter(_sLocation);
                                _oMenuObj.setHtml(_oMenuObj.S("currentPlace"), QMMap._TEMPLATE._CURRENT_ITEM.replace({
                                    title: _sTitle,
                                    address: _sAddress,
                                    location: _oSelf.getLatLng(_sLocation)
                                }));
        ...
        QMMap.prototype._pageActionForNearBy = function (_aoConfig, _aoRes) {
            ...
            var _oSelf = this, _oTop = getTop(), _oDomNearByPlaceDetail = _oSelf._moDomNearByPlaceDetail,
                _oContainer = _aoConfig.container, _oMainWin = _oSelf._moWin, _anCurPage = 1, _sDesc = _aoConfig.desc,
                _oMenuObj = _oSelf._moMenuObj, _sTemp;
            if (_aoRes) {
                if (_aoRes.status != 0 || _aoRes.count == 0) {
                    ...
                    _sTemp = QMMap._TEMPLATE._TABLE[_sDesc].replace({
                        count: "",
                        data: _aoRes.data,
                        total: "",
                        index: "",
                        num: "",
                        _nCurPage: _oSelf._moNCurPage[_sDesc]
                    });
        ...
        QMMap.prototype.toogle = function (_abIsNotNeedAnimate) {
            var _oToogle = [{
                    "classname": "trangle_top",
                    "contrast": "trangle_down",
                    "from": 204,
                    "to": 0
                }, {"classname": "trangle_down", "contrast": "trangle_top", "from": 0, "to": 204}], _oSelf = this,
                _oDomNearByPlaceDetail = _oSelf._moDomNearByPlaceDetail, _oMenuObj = _oSelf._moMenuObj,
                _oToogelDom = _oMenuObj.S("a_toogle"), _oSpans;
            if ((_oSpans = A.finds("span", _oToogelDom)) && _oSpans.length > 0) {
                ...
                A.E(_oToogle, function (_aoObj) {
                    if (A.hasClass(_oSpans, _aoObj.classname)) {
                        ...
                        !_abIsNotNeedAnimate && qmAnimation.moveVerti(_oMenuObj.S("allPlace"), "move", {
                            from: _aoObj.from,
                            to: _aoObj.to,
                            speed: "fast"
                        });
        ...
        QMMap.prototype._search = function (_asText) {
            var _oSelf = this, _oMenuObj = _oSelf._moMenuObj, _oResData = _oSelf._moDivResultDom,
                _oResTip = _oMenuObj.S("result"), _oDivError = _oSelf._moDivError, _oTemp = QMMap._TEMPLATE;
        ...
        QMMap.prototype._searchMapNearBy = function (_anLng, _anLat, _asTitle, _abIsFromCkSearchBar) {
            ...
            _oMainWin.searchCallback = function (_aoResult) {
                try {
                    ...
                    _oSelf._pageActionForNearBy({
                        desc: "nearby",
                        container: _oSelf._moDomNearByPlaceDetail
                    }, _oSelf._moResult.nearby);
                }
                catch (e) {
                    _oTop.showError("\u5730\u5740\u83B7\u53D6\u5931\u8D25...");
                }
    ...
    QMEditor.FUNCLIB.More = QMEditor.FUNCLIB.inheritFrom(function (_aoParamSet) {
        ...
        var _oSelf = this, _oTop = getTop(), _oEditor = _oSelf.getBindEditor(), _oLang = _oEditor.getLanguage(),
            _oMoreMethods = _oSelf._moMoreMethods = [];
        ...
        if (_aoParamSet.editor.getEditorId() == "compose") {
            ...
            _oSelf._moMoreMethods.push({
                sId: "vote",
                sItemValue: '<span class="editor_btn_text qmEditorVote ">\u6295\u7968</span>'
            });
        }
        _oSelf._moMoreMethods.push({
            sId: "map",
            sItemValue: '<span class="editor_btn_text qmEditorMap ">\u5730\u56FE</span>'
        });
        _oSelf.setId("More");
    ...
    QMEditor.FUNCLIB.More.prototype.getFuncObj = function (_asFuncName) {
        var _oSelf = this;
        return new QMEditor.FUNCLIB[_asFuncName]({
            oParamSet: _oSelf._moParamSet,
            editor: _oSelf._moParamSet.editor,
            uiType: "text",
            container: _oSelf._moContainer
        });
    };
    ...
    if (getTop().getLocale() == "zh_CN") {
        ...
        QMEditor.FUNCLIB.NetDisk.prototype.init_ = function () {
            var A = QMEditorAdapter, _oSelf = this, _oEditor = _oSelf.getBindEditor(), _oTop = QMEditor.getTopWin(),
                _oContainer = _oSelf.getContainer();
            _oContainer.style.display = "none";
            A.waitFor(function () {
                return _oTop.goUserInfo.get("NetDisk") && typeof (_oTop.goUserInfo.get("NetDisk").bIsSpread) == "boolean";
            }, function (_abIsOk) {
                _abIsOk && _oTop.goUserInfo.get("NetDisk").bIsSpread && _oTop.loadJsFile("$js_path$qmnetdisk38a714.js", true, _oTop.document, function () {
                    ...
                    _oTop.QMNetDisk.addEvent(_oTop.QMNetDisk.EVENT.SELECT, function (_aoFileList) {
                        _aoFileList.length && this.sharelink.get(_aoFileList, {
                            oninit: function (_aoList) {
...
;(function (a, d) {
    ...
    a.extend(QMEditor.CONST.LANGUAGE.zh_CN, {
        FUN_WORD: '\u5BFC\u5165\u6587\u6863',
        FUN_WORD_LABEL: '\u6587\u6863',
        FUN_WORD_IMPORT_TITLE: '\u5BFC\u5165\u6587\u6863',
        FUN_WORD_IMPORT_BODY: '\u6B63\u5728\u5BFC\u5165\u2026',
        FUN_WORD_ERROR_MULTI: '\u4E0D\u652F\u6301\u6279\u91CF\u5BFC\u5165',
        FUN_WORD_ERROR_FILEINFO: '\u6587\u4EF6\u8DEF\u5F84\u8BC6\u522B\u9519\u8BEF\u6216\u8D85\u51FA\u5927\u5C0F\u9650\u5236',
        FUN_WORD_ERROR_FILESIZE_OVERFLOW: '\u6587\u4EF6\u8FC7\u5927\uFF0C\u65E0\u6CD5\u5BFC\u5165',
        FUN_WORD_ERROR_FILESIZE_ZERO: '\u4E0D\u80FD\u5BFC\u5165\u7A7A\u6587\u6863',
        FUN_WORD_ERROR_FILESIZE_OVERFLOW_TXT: '\u8BFB\u53D6\u6587\u6863\u5185\u5BB9\u5931\u8D25\uFF0C\u6682\u65E0\u6CD5\u5BFC\u5165',
        FUN_WORD_ERROR_GETCONTENT: '\u8BFB\u53D6\u6587\u6863\u5185\u5BB9\u5931\u8D25\uFF0C\u6682\u65E0\u6CD5\u5BFC\u5165',
        FUN_WORD_ERROR_SELECTFILE: '\u4E0A\u4F20\u5931\u8D25 \u8BF7\u91CD\u8BD5',
        FUN_WORD_ERROR_NOTSUPPERTYPE: '\u6682\u4E0D\u652F\u6301\u5BFC\u5165\u8FD9\u79CD\u6587\u6863\u683C\u5F0F',
        FUN_WORD_ERROR_UPLOAD: '\u4E0A\u4F20\u6587\u6863\u5931\u8D25',
        FUN_WORD_ERROR_EDITORTYPE: '\u6587\u672C\u7F16\u8F91\u5668\u4E0D\u652F\u6301\u5BFC\u5165',
        FUN_WORD_ERROR_CGI_9006: '\u6587\u6863\u88AB\u52A0\u5BC6\uFF0C\u5BFC\u5165\u5931\u8D25',
        FUN_WORD_ERROR_CGI_TIMEOUT: '\u52A0\u8F7D\u8D44\u6E90\u8D85\u65F6',
        FUN_WORD_ERROR_CGI_NOCONTENT: '\u8BFB\u53D6\u6587\u6863\u5185\u5BB9\u5931\u8D25\uFF0C\u6216\u6587\u6863\u5185\u5BB9\u4E3A\u7A7A',
        FUN_WORD_ERROR_NOCONTENT: '\u8BFB\u53D6\u6587\u6863\u5185\u5BB9\u5931\u8D25\uFF0C\u6216\u6587\u6863\u5185\u5BB9\u4E3A\u7A7A',
        FUN_WORD_ERROR_PARTFILEERR: '\u8BFB\u53D6\u6587\u6863\u5185\u5BB9\u5931\u8D25',
        FUN_WORD_ERROR_CGI_UNDEFINED: '\u672A\u77E5\u9519\u8BEF\uFF0C\u83B7\u53D6\u6587\u6863\u4FE1\u606F\u5931\u8D25',
        FUN_WORD_ADDED_FILECELL: '\u5DF2\u5C06\u6587\u6863\u6DFB\u52A0\u4E3A\u9644\u4EF6'
    });
    a.extend(QMEditor.CONST.getTemplate(), {DIALOG_WORD_UPLOAD: a.T(['<div style="text-align:center;padding:58px; padding-bottom:78px;">', '<img src="$images_path$ico_loading21e9c5d.gif" style="position:relative; top: 12px;"> $say_uploading$ <span id="percent"></span>', '</div>'])});
    ...
    b.prototype._getUploadingDialog = function (e) {
        ...
        h._moUploadingDialog = new c.QMDialog({
            'sTitle': g.FUN_WORD_IMPORT_TITLE,
            'sId': 'editor_func_word_upload',
            'sBodyHtml': f.getTemplate().DIALOG_WORD_UPLOAD.replace({
                images_path: c.getPath("image"),
                say_uploading: g.FUN_WORD_IMPORT_BODY
            }),
            'onclose': function () {
    ...
    b.prototype._getUploadCfg = function (e) {
        ...
        return {
            ...
            oContainer: e,
            oComlist: g.getUiType() == 'icon' ? c.QMFileUpload.create.oCreaterInstance.orders.noflashPopup : null
        };
    };
    b.prototype._getFileContent = function (e) {
        ...
        c.qmAnimation.play(f.getPanelDom(), {
            win: g.getEditorAreaWin(),
            from: j._mnUploadPercent,
            to: 97,
            speed: 12000,
            basespeed: 1.3,
            tween: "Sine",
        ...
        c.QMAjax.send(l, {
            timeout: 20000, onload: function (n, o) {
                if (!f.isClose()) {
...
;(function (a, l) {
    ...
    b.prototype.init_ = function () {
        ...
        if (!window.getSelection) {
            ...
            j.addClass(m, 'opa50');
            j.loadJsFileToTop(['$js_path$com/kits/qmeditor/qqmail/release/editor_toolbar_ext250c75.js']);
            a.waitFor(function () {
    ...
    c.prototype = {
        _oStyleList: h, _sWarpNodeMarker: '__editorWarp__', _getBrowerStyle: function (n, o, m) {
