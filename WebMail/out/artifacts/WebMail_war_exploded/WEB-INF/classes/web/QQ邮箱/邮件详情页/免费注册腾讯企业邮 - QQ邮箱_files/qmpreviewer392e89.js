var QMComAdaptar = (function (a) {
    ...
    return {
        ...
        getScaleCon: Scale.getContainer,
        evalCss: evalCss,
        bodyScroll: bodyScroll,
        contain: isObjContainTarget,
        show: show,
        isShow: isShow,
        posShow: function (e, f, g) {
            if (e) {
...
var QMPreviewer = (function (a, e) {
    var k = {img: "Image", music: "Music", video: "Video", doc: "Document", compress: "Compress", other: "Other"},
        d = 0, c = 1, b = 50, j = {}, i = {}, l = {}, m = [];
    ...
    j._open = function (o) {
        ...
        !this._moMask && (this._moMask = n("Mask", {
            sId: this._msId + "_mask",
            sSkin: this._msSkin,
            oDomContainer: this._moDomScrollArea,
            oEvents: {fClick: a.funcProxy(this, this._back)}
        }));
        !this._moOperator && (this._moOperator = n("Operator", {
            sId: this._msId + "_operator",
            sSkin: this._msSkin,
            oDomFrame: this._moDomFrame,
            oDomContainer: this._moDomScrollArea,
            oDomScrollArea: this._moDomScrollArea,
            oMenuContainer: this._moDomFrame,
            oEvents: {
                fClick: a.funcProxy(this, this._operate),
                fSelect: a.funcProxy(this, this._operate),
                fResizeVisualRange: a.funcProxy(this, this._visualRangeResize)
            }
        }));
        !this._moTip && (this._moTip = n("Tip", {
            sId: this._msId + "_tip",
            sSkin: this._msSkin,
            oDomContainer: this._moDomFrame,
            oVisualRange: this._moOperator.getVisualRange()
        }));
    ...
    j._createFileViewer = function (o) {
        ...
        if (r) {
            ...
            r = n(s, {
                sId: this._msId + "_viewer",
                sSkin: this._msSkin,
                oTip: this._moTip,
                oOperator: this._moOperator,
                oDomContainer: s == "Image" ? this._moDomFrame : this._moDomScrollArea,
                oVisualRange: this._moOperator.getVisualRange(),
                oFileInfo: p,
                oFileList: q,
                oEvents: s != "Loader" ? e : {
                    fLoad: a.funcProxy(this, this._loadUrl),
                    fCancelLoad: a.funcProxy(this, this._cancelLoadUrl),
                    fFinish: a.funcProxy(this, this._loadUrlFinish)
                }
            });
        }
        return r;
    ...
    j._installFileViewer = function (q, o, p) {
        ...
        this._moOperator.enable({
            navbar: false,
            minibar: {minimize: w == "Music"},
            mainbar: {
                Video: 1,
                Music: 1
            }[this._msMode] || this._mbNoOpt ? false : {
                parse2OnlineDoc: t.sParse2OnlineDocUrl ? true : false,
                zoombtn: w == "Image" ? true : "disable",
                rotate: w == "Image" ? true : "disable",
                app: this._mbShowApp,
                next: r ? false : (u ? true : "disable"),
                prev: r ? false : (v ? true : "disable"),
                breakline: this._mbShowBreakLine ? !r : false,
                send: !!this._moEvents.fFrwd ? (t.bIsTimeout == 1 ? "disable" : true) : false,
                list: r ? false : s,
                info: t.oInfo,
                scan: d && t.bIsTimeout != 1 && !!t.sTwoDCodeUrl,
                down: this._mbShowDownBtn ? (!t.sDown ? false : (t.bIsTimeout == 1 ? "disable" : true)) : false
            }
        }, {Document: true, Compress: true, Image: true}[this._calcViewerType(t)]);
    ...
    j._installClassifyViewer = function () {
        ...
        this._installViewer(n(this._msMode = "Classifier", {
            sId: this._msId + "_classifier",
            sSkin: this._msSkin,
            oTip: this._moTip,
            oDomContainer: this._moDomFrame,
            oVisualRange: this._moOperator.getVisualRange(),
            oFilesMap: this._moFilesMap,
            oEvents: {fClick: a.funcProxy(this, this._operate)}
        }));
    };
    ...
    j.component("Viewer", function (p, o) {
        ...
        p.log_ = function (q) {
            if (!this._mbHasLoged && this._moFileInfo) {
                var r = this._moFileInfo, s = a.extend({
                    stat: "previewer",
                    from: {attach: 0, bigattach: 1}[r.sFrom],
                    type: {other: 0, image: 1, "document": 2, music: 3, video: 4, compress: 5}[this._msType],
                    suffix: (r.sName || "").split(".").pop() || r.sSuffix || "none",
                    result: q,
                    trans: r.sHash ? 1 : 0
                }, this._msOssParam);
                ...
                if (!isNaN(s.from) && !isNaN(s.type) && s.result >= 0 && s.result <= 2) {
                    ...
                    if (q == 1) {
                        var t = {
                            other: "preview_other_suc",
                            image: "preview_img_suc",
                            "document": "preview_doc_suc",
                            music: "preview_music_suc",
                            video: "preview_video_suc",
                            compress: "preview_compress_suc"
                        }[this._msType];
...
(function (a, b) {
    QMPreviewer.component("Operator", function (e, f) {
        var c = 1500, d = 0, g = {
            minibar: {minimize: false, close: true},
            navbar: {nav: false},
            mainbar: {
                zoombtn: "disable",
                rotate: "disable",
                parse2OnlineDoc: false,
                prev: true,
                next: true,
                breakline: true,
                list: false,
        ...
        e.initMenu_ = function (h) {
            ...
            j._moListMenu = j._useComponent("Menu.Selector", {
                sId: j._msId + "_list",
                sType: "list",
                oDomContainer: i,
                oEvents: {fClick: a.funcProxy(j, j._menuOpt), fHide: a.funcProxy(j, j._unselectListBtn)}
            });
            j._moInfoMenu = j._useComponent("Menu.Info", {
                sId: j._msId + "_info",
                sType: "info",
                oDomContainer: i,
                oEvents: {fClick: a.funcProxy(j, j._menuOpt), fHide: a.funcProxy(j, j._unselectInfoBtn)}
            });
            j._moScanMenu = j._useComponent("Menu.Scan", {
                sId: j._msId + "_scan",
                sType: "scan",
                oDomContainer: i,
                oEvents: {fClick: a.funcProxy(j, j._menuOpt), fHide: a.funcProxy(j, j._unselectScanBtn)}
            });
        };
        ...
        e.calcVisualRange_ = function () {
            var o = this, n = o._moDomRange.clientWidth, m = o._moDomRange.clientHeight, j = 0,
                k = a.isShow(o._moDomNavBar) ? parseInt(a.getStyle(o._moDomNavBar, "left")) + o._moDomNavBar.clientWidth : 0,
                i = a.isShow(o._moDomMiniBar) ? (n - (parseInt(a.getStyle(o._moDomMiniBar, "right")) || 0) - (parseInt(a.getStyle(o._moDomMiniBar, "width")) || 0)) - 10 : n,
                h = o._mnMainBarTop = a.isShow(o._moDomMainBar) ? (m - (parseInt(a.getStyle(o._moDomMainBar, "bottom")) || 0) - o._moDomMainBar.clientHeight) : m,
                l = Math.max(n - i, k);
            o._moVisualRange = {
                nTop: j,
                nBottom: h,
        ...
        e.showMenu_ = function (h) {
            if (h == this._msCurMenu) {
                ...
                this._msCurMenu = h;
                this._moCurMenu = {
                    list: this._moListMenu,
                    info: this._moInfoMenu,
                    scan: this._moScanMenu
                }[h], a.addClass(this._dom(h), "select");
                this.resizeMenu_();
            }
        };
    ...
    QMPreviewer.component("OperatorSkin1", function (c, d) {
        ...
        c.initMenu_ = function (f) {
            ...
            h._moListMenu = h._useComponent("Menu.Selector.Side", {
                sId: h._msId + "_list",
                sType: "list",
                oDomContainer: f.oDomScrollArea,
                oEvents: {fClick: a.funcProxy(h, h._menuOpt), fHide: a.funcProxy(h, h._unselectListBtn)}
            });
            h._moScanMenu = h._useComponent("Menu.ScanSkin1", {
                sId: h._msId + "_scan",
                oDomScrollArea: f.oDomScrollArea,
                sType: "scan",
                oDomContainer: g,
                oEvents: {fClick: a.funcProxy(h, h._menuOpt), fHide: a.funcProxy(h, h._unselectScanBtn)}
            });
        };
        ...
        c.calcVisualRange_ = function (f) {
            var m = this, g = (getTop().gnIEVer == 6), l = g ? m._moDomRange.parentNode : m._moDomRange,
                k = l.clientWidth, j = l.clientHeight,
                h = (m._moDomMainBar.clientHeight || parseInt(a.getStyle(m._moDomMainBar, "height"))) + 1 + 3;
            if (k && j) {
                m._moVisualRange = {
                    nTop: h,
                    nBottom: j,
...
(function (a, b) {
    QMPreviewer.component("Menu.Scan", function (c, d) {
        ...
        c._redraw = function () {
            if (this._mbNewData || !this._mbShowed) {
                this._draw(QMPreviewer.getView("menuscan", {
                    sId: this._msId,
                    src: this._msTwoDCodeUrl,
                    name: this._msName,
                    oJs: a
                }));
                this._mbShowed = true;
    ...
    QMPreviewer.component("Menu.ScanSkin1", function (c, d) {
        ...
        c._redraw = function () {
            if (this._mbNewData || !this._mbShowed) {
                this._draw(QMPreviewer.getView("menuscanskin1", {
                    sId: this._msId,
                    src: this._msTwoDCodeUrl,
                    name: this._msName,
                    oJs: a
...
(function (a, b) {
    QMPreviewer.component("Menu.Selector", function (d, e) {
        ...
        d.setFileList = function (f) {
            ...
            this._draw(QMPreviewer.getView("menuselector", {
                sId: this._msId,
                oList: f,
                nItemPerPage: c,
                oPage: h,
...
(function (a, b) {
    QMPreviewer.component("Document", function (c, d) {
        ...
        c.resize_ = function () {
            ...
            if (k) {
                var g = 0, l = this._moFileInfo.sSuffix || (this._moFileInfo.sName || "".split(".").pop()),
                    f = k.nFullHeight - g - k.nFullTop, i = (e || {
                        xls: 1,
                        xlsx: 1,
                        ppt: 1,
                        pptx: 1,
                        eml: 1
                    }[l]) ? (this._moDomDocTitle ? this._moDomDocTitle.clientHeight : 0) : 0,
                    h = {xls: 1024, xlsx: 1024, pdf: 960, ppt: 990, pptx: 990}[l] || 840,
                    j = (k.nFullWidth < h + g ? k.nFullWidth : h) - g;
        ...
        c._showHandle = function () {
            try {
                ...
                if (g && g.childNodes.length > 0) {
                    var h = this._moDomDocFrame.contentWindow.document.childNodes[0],
                        f = h && h.nodeName == "#comment" && h.data.toLowerCase().indexOf("exception") > -1;
                    this._showErr(f);
                    this.log_(f ? 0 : 1);
    ...
    QMPreviewer.component("DocumentSkin1", function (c, d) {
        ...
        c.resize_ = function () {
            ...
            if (i) {
                var j = h._moFileInfo.sName.split(".").pop(), f = (e || {
                    xls: 1,
                    xlsx: 1,
                    ppt: 1,
                    pptx: 1
                }[j]) ? (h._moDomDocTitle ? h._moDomDocTitle.clientHeight : 0) : 0;
...
(function (a, b) {
    QMPreviewer.component("Compress", function (c, d) {
        c.init = function (e, f) {
            ...
            g._moNavOpter = g._useComponent("Operator", {
                sId: g._msId + "_navopt",
                oDomContainer: g._moDomContainer,
                bAutoResize: false,
                oEvents: {
                    fClick: a.funcProxy(g, g._operate),
                    fResizeVisualRange: a.funcProxy(g, g._subVisualRangeResize)
                }
            });
        ...
        c.installFileViewer_ = function (e) {
            ...
            this._moNavOpter.enable({
                navbar: {nav: this._moPath[this._moPath.length - 1].sName},
                minibar: {minimize: f.sType == "music"},
                mainbar: {
                    zoombtn: f.sType == "img" ? true : "disable",
                    rotate: f.sType == "img" ? true : "disable",
                    next: false,
                    prev: false,
                    breakline: false,
                    list: false,
        ...
        c._drawCtt = function (e) {
            ...
            h._dom("ctt").innerHTML = e == "clear" ? "" : QMPreviewer.getView(h._moTmpl.sContent || "compresscontent", a.extend({
                oJs: a,
                sId: h._msId
            }, h._moPath[h._moPath.length - 1]));
            if (e != "clear") {
        ...
        c.createLazyLoadPic = function () {
            var k = this, e = k._dom("ctt"), h = a.calcPos(e), f = e.parentNode, g = a.calcPos(f), i = k._moDom,
                j = a.finds("li.cps_column", i);
        ...
        c._viewFile = function (e) {
            ...
            if (e.sType == "doc" && e.sUrl) {
                var f = {redirect: true, t: "attachments_content", s: "yozo", fromattach: "1"},
                    g = new RegExp("(.*)(&curfile=)(.*?)\\&", "gi");
                g.test(e.sUrl) && (f.filename = RegExp.$3);
                e.sUrl = a.cookQueryString(e.sUrl, f);
            }
            e.pwd && (e.sUrl += "&pwd=" + e.pwd);
            this.installFileViewer_(this._useComponent(h, {
                sId: this._msId + "_" + h,
                oTip: this._moTip,
                bFromCompress: true,
                oOperator: this._moNavOpter,
                oDomContainer: this._moDomContainer,
                oVisualRange: this._moVisualRange,
                oFileInfo: e
            }));
        };
        ...
        c._decrypt = function () {
            var g = this, f = g._dom("pwd"), h = f.value, e = this._moPath[this._moPath.length - 1],
                i = e.sUrl + "&pwd=" + h;
            if (h) {
    ...
    QMPreviewer.component("CompressSkin1", function (c, d) {
        c.init = function (e) {
            ...
            this._moLayerMask = this._useComponent("Mask", {
                sId: this._msId + "_cpsmask",
                oDomContainer: this._moDomContainer,
                bIsLayerLever: true,
                oEvents: {fClick: a.funcProxy(this, this.back)}
            });
...
(function (a, b) {
    QMPreviewer.component("Image", function (c, d) {
        ...
        c._show = function (g, f, e) {
            ...
            var m = this._moVisualRange, i = this._calcBorder(), j = Math.floor(m.nLeft + (m.nWidth - g - i) / 2),
                k = Math.floor(m.nTop + (m.nHeight - f - i) / 2);
        ...
        c._showByAnimation = function (f, e) {
            qmAnimation.play(f, {
                from: e ? 0.5 : 1, to: e ? 1 : 0.5, speed: 'slow', onaction: function (g) {
                    a.show(f, true);
                    setOpacity(f, g);
                }, oncomplete: function () {
                    show(f, e);
        ...
        c._fitImg = function (e) {
            var o = this, f = this._calcBorder(), p = this._moVisualRange,
                m = (p.nWidth - this._mnRangeDelta - f) || this._mnRangeDef,
                l = (p.nHeight - this._mnRangeDelta - f) || this._mnRangeDef, i = this._mbIsRotate ? l : m,
                h = this._mbIsRotate ? m : l, k = e.nWidth, j = e.nHeight, n = k / i, g = j / h;
            if (n > 1 || g > 1) {
                if (n > g) {
        ...
        c._rotate = function (f, e) {
            ...
            if (document.addEventListener) {
                ...
                var g = g % 360, i = g >= 0 ? Math.PI * g / 180 : Math.PI * (360 + g) / 180, h = Math.cos(i),
                    j = Math.sin(i);
        ...
        c.mousedown_ = function (e) {
            this._moMovingInfo = {
                _oDomCapture: this._moDom.setCapture ? this._moDom : window,
                _nMouseX: e.clientX,
                _nMouseY: e.clientY,
                _nDomX: parseInt(a.getStyle(this._moDom, "left")),
                _nDomY: parseInt(a.getStyle(this._moDom, "top"))
            };
            a.rmClass(this._moDom, "layer_img_ts");
        ...
        c.mousewheel_ = function (e) {
            ...
            var l = this._moDom, k = this._moDomImg, g = k.naturalHeight || k.height || 0,
                i = k.naturalWidth || k.width || 0, j = this._mnZoom, f = j;
            if (!k.naturalHeight) {
                k.naturalHeight = g;
                k.naturalWidth = i;
            }
    ...
    QMPreviewer.component("Music", function (c, d) {
        var e = function (f) {
            ...
            if (typeof f.length == "undefined") {
                return ({
                    title: f.sName, autoplay: true, fileType: f.sSuffix, url: f.sUrl, onsuccess: function () {
                        h.log_(1);
                    }, onerror: function () {
                        h.log_(0);
                    }
        ...
        c._addPlayer = function () {
            var i = this, g = i._moCfg, j = "gplayer_kernel", k = "gplayer_container", h = {
                sId: "qmPreViewERaudio",
                oContainer: this._moDomMusic,
            ...
            a.getPlayer(function (l) {
                var m = l.initKernel({
                    sId: j, oContainer: f(), onShowPlaylist: function () {
                    }
                ...
                if (f.oFileList) {
                    i.init({
                        oSkin: i.initSkin({
                            ...
                            oContainer: g._moDomSkin,
                            oSkinTemplate: h,
                            oPlayList: {nType: 1, oContainer: g._moDomPlaylist}
                        }),
                        oKernel: i.initKernel({
                            sId: "qmPreViewERvidio",
                            oContainer: g._moDomKernel,
                            oInfoList: e.call(g, f.oFileList)
                        })
                    });
                }
                else {
                    i.init({
                        oSkin: i.initSkin({sId: "qmPreViewERvidio", oContainer: g._moDomSkin, oSkinTemplate: h}),
                        oKernel: i.initKernel({
                            sId: "qmPreViewERvidio",
                            oContainer: g._moDomKernel,
                            oInfo: e.call(g, f.oFileInfo)
                        })
                    });
                }
                a.posShow(g._moDom);
