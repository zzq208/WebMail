var gsAgent = navigator.userAgent.toLowerCase(), gsAppVer = navigator.appVersion.toLowerCase(),
    gsAppName = navigator.appName.toLowerCase(), gbIsOpera = gsAgent.indexOf("opera") > -1,
    ...
    gbIsQPlus = gsAgent.indexOf("qplus") > -1, gbIsSogou = gsAgent.indexOf("se 2.x metasr 1.0") > -1,
    ...
    gbIsQBIE = gbIsIE && gsAppVer.indexOf("qqbrowser") != -1, gbIsFF = gsAgent.indexOf("gecko") > -1 && !gbIsKHTML,
    gbIsTrident = gsAppVer.indexOf("trident") != -1, gbIsEdge = gsAgent.indexOf('edge') != -1,
    ...
    gbIsLinux = gsAgent.indexOf("linux") > -1, gbIsAir = gsAgent.indexOf("adobeair") > -1,
    gnIEVer = /MSIE (\d+.\d+);/i.test(gsAgent) && parseFloat(RegExp["$1"]), gnIEDocTypeVer = 0,
    ...
    gsQBVer = "" + (/qqbrowser\/((\d|\.)+)/i.test(gsAgent) && RegExp["$1"]), _gsForEBuiltTag = "_For_E_Built";
(function () {
    if (gbIsTrident) {
        gbIsFF = false;
        gbIsIE = true;
...
function numToTimeStr(a, b) {
    var c = b || "$HH$:$MM$:$SS$";
    return T(c).replace({
        SS: formatNum(parseInt(a) % 60, 2),
        MM: formatNum(parseInt(a / 60) % 60, 2),
        HH: formatNum(parseInt(a / 3600) % 60, 2)
    });
}

function formatDate(a, b, c) {
    var e = a || new Date(), d = formatNum;
    return T(b, c).replace({
        YY: d(e.getFullYear(), 4),
        MM: d(e.getMonth() + 1, 2),
        DD: d(e.getDate(), 2),
        hh: d(e.getHours(), 2),
        mm: d(e.getMinutes(), 2),
        ss: d(e.getSeconds(), 2),
        ww: outputDayOfWeek(e.getDay())
    });
}
...
function formatDayByLocale(a, b, c) {
    ...
    return T(f[g][b], c).replace({
        YY: d(e.getFullYear(), 4),
        MM: outputMonth(e.getMonth()),
        DD: d(e.getDate(), 2),
        WW: outputDayOfWeek(e.getDay(), true),
        HH: d(e.getHours(), 2),
        MMMM: d(e.getMinutes(), 2)
    });
}
...
function subAsiiStr(d, b, c, a) {
    var e = function (i) {
            return i;
        }, f = a ? htmlEncode : e, n = (a ? htmlDecode : e)(trim((d || "").toString())), m = c || "",
        j = Math.max(b - m.length, 1), l = n.length, h = 0, k = -1, g;
    for (var o = 0; o < l; o++) {
        g = n.charCodeAt(o);
...
function setCookie(d, f, b, e, c, a) {
    if (d) {
        document.cookie = T(['$name$=$value$; ', !b ? '' : 'expires=$expires$; ', 'path=$path$; ', 'domain=$domain$; ', !a ? '' : '$secure$']).replace({
            name: d,
            value: encodeURIComponent(f || ""),
            expires: b && b.toGMTString(),
            path: e || '/',
            domain: c || ["mail.", getDomain()].join(""),
            secure: a ? "secure" : ""
        });
        return true;
    }
...
function evalCss(b, a, c) {
    if (b) {
        var d = a ? a.document || a : document, h = "cssfrom", j = "style",
            g = d.getElementsByTagName("head")[0].getElementsByTagName(j), f = g[g.length - 1];
        if (c && f) {
...
function createIframe(b, c, a) {
    ...
    b[f][g] = a.onload;
    if (!d) {
        insertHTML(e.obj || b.document.body, e.where || "afterBegin", TE(['<iframe frameborder="0" scrolling="$scrolling$" id="$id$" name="$id$" ', '$@$if($transparent$)$@$allowTransparent$@$endif$@$ class="$className$" ', 'onload="this.setAttribute(\x27loaded\x27,\x27true\x27);$cb$(\x27$id$\x27,this);" ', 'src="$src$" style="$style$" $attrs$>', '</iframe>']).replace(extend({
            "id": g,
            "cb": f,
            style: "display:none;",
            scrolling: "no",
...
(function (a) {
    ...
    function c(s, r, q) {
        ...
        var D = (H.match(j) || m)[1], y = p(H), G = (H.match(k) || m)[1], x = o(H), u = x ? x.length : 0, C = [],
            w = -1, v = -1, z, B, t;
        G && (G = G == "*" ? "" : G.toUpperCase());
        while ((z = r[++v])) {
            B = z.parentNode;
    ...
    function n(r, q) {
        ...
        var z = r.match(l), D = z.pop(), B = (D.match(j) || m)[1], v = p(D), u = o(D), s = u ? u.length : 0,
            C = (D.match(k) || m)[1], y = [], w = [], G = -1, t = -1, x;
    ...
    function d(r, q) {
        ...
        var D = r.match(l), I = D.pop(), G = (I.match(j) || m)[1], v = p(I), u = o(I), s = u ? u.length : 0,
            H = (I.match(k) || m)[1], w;
        if (G) {
...
function calcAdjPos(d, c, a, e, b) {
    ...
    var i = Scale.fixBodyHeight(bodyScroll(e, 'clientHeight')), j = Scale.fixBodyWidth(bodyScroll(e, 'clientWidth')),
        l = Scale.fixOffsetTop(bodyScroll(e, 'scrollTop')), k = Scale.fixOffsetLeft(bodyScroll(e, 'scrollLeft')),
        f = l + i, g = k + j, m = [0, 0, 0, 0];
    if (b < 2) {
        var h = k - d[1];
...
T._QMTemplate.prototype = {
    toString: function () {
        return this._msTmplStr;
    }, replace: function (b, c, a) {
        return this._replace(b, c, a);
    }, _replaceWithParse: function (b, a, c) {
        var h = this, k = h._msTmplReplaceVar, j = h._moTmplData, g = h._moLinkData, d = !j,
            e = a ? h._getWithNoReplace : h._get;
        if (d) {
        ...
        var j = this, a = 0, c = [], e = [], h = [], g = j._moSecDatas = [], m = j._msTmplReplaceVar,
            f = new RegExp(["", "(.*?)", ""].join(regFilter(m)), "g"), l = "_afG('$1'.split('.'),_oD,_aoD,_aoR)",
            k = j._moTmplDatas = j._msTmplStr.split(["", "@", ""].join(m)), n;
        ...
        var a = {};
        return {
            htmlEncode: htmlEncode, SetVar: function (b, c, d) {
                b[c] = d;
                return '';
            }
        };
...
function loadJsFile(e, a, d, b, c, f) {
    var n = getTop(), j = d || document, h = typeof b == "function", l, m, k = n.loadJsFile, o = n.getRes(e),
...
function goUrl(b, c, a) {
    ...
    try {
        var g = (b.contentWindow || b).location, f = g.href.split("#"), h = c.split("#"), d = h[0] == f[0],
            i = d ? h[0] : c;
        if (a) {
            g.href = i;
        }
...
function generateFlashCode(d, c, a, b) {
    var g = [], l = [], i = [], n = b || {}, h = T(' $name$=$value$ '),
        m = T('<param name="$name$" value="$value$" />'),
        j = gbIsIE ? T(['<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ', '$codebase$ ', '$attr$ $id$ >', '$param$', '<embed class="needed" $embed$ type="application/x-shockwave-flash" ', '$pluginspage$ ', ' $name$ ></embed>', '</object>']) : T(['<embed class="needed" $embed$ type="application/x-shockwave-flash" ', '$pluginspage$ ', ' $name$ $id$ ></embed>']);
...
function zoomFuncCreater(a) {
    return function (e, b, d, c) {
        var h = d || a.limitWidth || 1, g = c || a.limitHeight || 1, k = (e / h) || 1, f = (b / g) || 1,
            n = [k < 1 ? "w" : "W", f < 1 ? "h" : "H"].join(""), m = a[n] || a.all, l = {};
        switch (m) {
            case "stretch":
                l.width = h;
                l.height = g;
...
function scrollIntoMidView(e, d, b, c, a) {
    ...
    var l = calcPos(e)[0] - calcPos(d)[0] - (f ? d.scrollTop : 0), i = l, k = e.offsetHeight, h = d.clientHeight,
        g = c || 0;
    if (b || i < 0 || i + k > h) {
        var j = 0, m;
        if (h > k + g) {
...
function inherit(e, d, b, c, a) {
    ...
    extend(g.prototype = new d("__inherit__"), h, {
        toString: function () {
            return "";
        }
    });
...
function cacheByIframe(a, b) {
    ...
    var q = n.id || unikey("_"), h = [n.attrs], m = [n.header], k = [],
        c = !gbIsEdge && cacheByIframe._bIsSupportVirtual && (n.virtual !== false);
    ...
    createIframe(p, (c ? ["javascript:(function(){document.open();document.domain='", document.domain, "';frameElement['_render_']=1;", "try{document.write('<head><script>window.onerror=function(){return true};<\/script>'+", "parent['", r, "']['", q, "_h']+'</head>'+parent['", r, "']['", q, "_b']);", "parent['", r, "']['", q, "_h']=parent['", r, "']['", q, "_b']=null;}catch(e){alert(e.message);}", "document.close();})()"] : [getRes("$base_path$zh_CN/htmledition/domain21801b7.html"), "#", encodeURIComponent(document.domain), "&", r + "&" + encodeURIComponent(q) + "&" + (n.destroy !== false ? "1" : "")]).join(""), extend({}, n, {
        id: q, attrs: h.join(""), onload: function (i) {
            var j = this;
            if (!c || j["_render_"]) {
...
function clearCache() {
    arguments.length > 0 && getTop().cacheByIframe(arguments, {
        virtual: false, destroy: false, onload: function () {
...
;(function () {
    ...
    window.createForm = function (b, c) {
        ...
        b.oInputs = e;
        insertHTML(b.oWin.document.body, "beforeEnd", a.replace(extend({
            sFormId: f,
            sTarget: "_self",
            sMethod: "POST"
        }, b)));
...
function OprATagForDistributeDomain(a) {
    var b = getEventTarget(a), d = b.tagName, c = QMDistributeDomain.removeHost(b.href || ''),
        c = QMDistributeDomain.removeDefaultHost(c);
...
function isSupportSSnap(a) {
    ...
    if (b.gbIsChrome && parseInt(gsChromeVer) > 41) {
        if ((b.gbIsMac || b.gbIsEdge) && a) {
            var c = b.gbIsEdge ? "Microsoft Edge\u6D4F\u89C8\u5668" : "Chrome\u6D4F\u89C8\u566842\u6216\u4EE5\u4E0A\u7248\u672C",
                d = b.gbIsEdge ? "" : '<a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&id=10000&&no=1001245" target="_blank">\u4E86\u89E3\u66F4\u591A</a>';
            b.confirmBox({
                title: "\u6E29\u99A8\u63D0\u793A",
                msg: ['<div class="dialog_f_t" style="font-weight: normal;">\u4F60\u6B63\u5728\u4F7F\u7528\u7684\u662F', c, '\uFF0C\u6682\u4E0D\u652F\u6301\u622A\u5C4F\u529F\u80FD\u3002<br/>\u62B1\u6B49\u7ED9\u4F60\u5E26\u6765\u4E86\u56F0\u6270\uFF0C\u6211\u4EEC\u5C06\u5C3D\u5FEB\u4F18\u5316\u3002', d, '</div>'].join(""),
                confirmBtnTxt: '\u786E\u5B9A',
                mode: "alert",
                onreturn: function (e) {
                }
...
function isCanConnectGoogle(a) {
    ...
    if (b.isCanConnectGoogle.result === undefined) {
        ...
        createIframe(b, ["javascript:(function(){document.open();document.domain='", document.domain, "';document.close();})()"].join(""), {
            onload: function (c, e, d) {
...
var QMDistributeDomain = (function () {
    ...
    if (window.location.hostname.indexOf('mail.qq.com') != -1) {
        waitFor(function () {
            ...
            if (n) {
                d.createIframe(d, f() + "/zh_CN/htmledition/ajax_proxy.html?mail.qq.com&v=140521", {
                    id: "iframe_distributeDomain_proxy_", onload: function () {
                        c = this;
                    }
                });
            }
...
var gsMsgNoSubject = "\u8BF7\u586B\u5199\u90AE\u4EF6\u4E3B\u9898",
    ...
    gsMsgSettingOk = "\u8BBE\u7F6E\u4FDD\u5B58\u6210\u529F", gsMsgLinkErr = "\u7F51\u7EDC\u5E94\u7B54\u5931\u8D25",
...
function doPageError(b, c, a) {
    var d = arguments.callee.caller, f = d && d.caller, e = f && f.caller, m = (d || "null").toString(),
        l = (f || "").toString(), k = (e || "").toString(), n;
    try {
...
QMHistory.tryBackTo = function (a) {
    try {
        var h = getTop().QMHistory._moParam, j = QMHistory.getId(a), g = getTop().QMHistory._moCaches[j],
            i = g && g._sUrl, b = g && g._nHistoryLen >= getTop().history.length, c = g && h._sPreMainWinUrl == i,
            d = g && !h._bIsActionFrameUrlChange;
...
rdVer.log = function (a, b) {
    var f = new QMCache({appName: "preload"}), d = new Date().getTime(), e = f.getData(a),
        c = e && (d - e) < rdVer.maxage(a) * 1000;
    switch (b) {
        case "pre":
            if (!c) {
                f.setData(a, d);
...
rdVer.url = function (i, h, j, e, b, d, a, f, c, g) {
    var r = '/cgi-bin/$cgi$?folderid=$folderid$&folderkey=$folderkey$$s$&t=$t$&mailid=$mailid$$cache$&sid=$sid$', k, p,
        o, q, n = "readmail";
    if (a) {
        p = "readmail&s=draft";
    }
    ...
    q = T(r).replace({
        ...
        s: o,
        sid: getSid(),
        cache: l ? T("&mode=pre&maxage=$maxage$&base=$base$&ver=$ver$").replace({
            maxage: rdVer.maxage(i),
...
function rollback(a) {
    ...
    if (b && b.rbkey) {
        confirmBox({
            ...
            mode: "prompt",
            height: 135,
            msg: T(['\u64A4\u9500\u6700\u8FD1\u4E00\u6B21$msg$\u5417\uFF1F']).replace(b),
            onreturn: function (c) {
                if (c) {
                    QMAjax.send("/cgi-bin/mail_mgr", {
                        method: "POST",
                        content: ["sid=", getSid(), "&mailaction=mail_revert&t=mail_mgr2&timekey=", b.rbkey, "&logtype=", a].join(''),
                        onload: function (d, e) {
...
var QMPageInit = {
    _oMouseUpListener: [], addPageMouseUpListener: function (a) {
        ...
        var s = b.srcElement || b.target, e = b.ctrlKey, i = b.altKey, g = b.shiftKey, d = b.metaKey, k = b.keyCode,
            j = s.type == "text" || s.tagName == "TEXTAREA", f = a && (s.tagName == "INPUT" && s.type != "button"),
            c = s.tagName == "BUTTON" || s.type == "button";
        switch (k) {
            case 8:
                if (!j && goBackHistory()) {
                    preventDefault(b);
            ...
            case 46:
                if (!j) {
                    var l = S(g ? "quick_completelydel" : "quick_del", getMainWin()),
                        m = g ? S("quick_del", getMainWin()) : null, n = S("del", getMainWin());
                            ...
                            if (j.getAttribute("initlized") != "true") {
                                ...
                                j.onclick = function (k) {
                                    ...
                                    if (!isNaN(r) && r > 0) {
                                        ...
                                        j.setAttribute("md", "0");
                                        var q = s.shiftKey, l = s.ctrlKey, o = s.metaKey,
                                            p = q || l || o || j.target == '_blank', v = j.getAttribute("nocheck"),
                                            u = trim(j.href), n = !(u == "" || u.indexOf("javascript:") == 0),
                                            m = trim(j.href).indexOf("http") == 0;
                ...
                case "4":
                    ...
                    if (c == "over") {
                        ...
                        if (i) {
                            ...
                            k[0] -= 3;
                            k[2] += 3;
                            var d = parseInt(i.offsetHeight), f = parseInt(i.offsetWidth),
                                g = calcAdjPos([k[0], e, k[2], e], f, d, b, 2), m = i.className,
                                l = g[2] == k[0] ? "smt_down" : "smt_up";
        ...
        a.setTimeout(function () {
            ...
            addEvents(a.document, {
                mousedown: OprMouseDown, touchend: getTop().iPadCloseMenu || function () {
                }, keydown: function (d) {
...
function goNewWin(d, b, a, c) {
    ...
    var j = T(g + '/cgi-bin/frame_html?t=$t$&sid=$sid$&url=$url$').replace({
        t: i,
        sid: getSid(),
        url: encodeURI(f + _trimUrlSearchParam(h))
    });
    if (c) {
        j += c.frametmplparam;
    }
...
function maximizeMainFrame(a) {
    ...
    var c = getTop().maximizeMainFrame,
        b = c._bIsMaximizeMainFrame = a == 2 ? !isMaximizeMainFrame() : (a ? true : false);
    if (b) {
...
if (!getTop().goUserInfo) {
    getTop().goUserInfo = {
        _sStatus: 'init', _fCallbacks: {}, _oData: {}, isLoaded: function () {
            ...
            var a = T(["/cgi-bin/getcomposedata?t=signature&fun=compose&sid=$sid$&qzonesign=$qzonesign$&r=$rand$"]).replace({
                sid: getSid(),
                qzonesign: "",
                rand: now()
            });
...
showProcess.createProcessBox = function (a) {
    ...
    if (!b) {
        insertHTML(Scale.getContainer(), "afterBegin", T(['<table id="$id$" cellspacing=0 cellpadding=0 border=0 ', 'style="position:absolute;top:$top$px;left:0;width:100%;display:none;z-index:9999;">', '<tr><td align="center">', '<table id="$id$_pos" cellspacing=0 cellpadding=0 border=0 class="autosave autosave_txt" style="height:20px;"><tr>', '<td style="width:2px;"></td>', '<td id="$id$_img" style="padding:0 0 0 5px;">', '<img src="$image_path$ico_loading1e9c5d.gif" style="width:16px;height:16px;vertical-align:middle;">', '</td>', '<td id="$id$_plan" valign=center style="padding:0 0 0 5px;">', '<div style="font:1px;border:1px solid white;width:104px;text-align:left;">', '<div id="$id$_plan_bar" style="font:1px;background:#fff;height:8px;margin:1px 0;width:50%;"></div>', '</div>', '</td>', '<td id="$id$_plan_info" style="padding:0 0 0 5px;"></td>', '<td id="$id$_plan_rate" style="width:40px;text-align:right;padding:0;"></td>', '<td id="$id$_info" style="padding:0 0 0 5px;"></td>', '<td id="$id$_cancel" style="padding:0 0 0 5px;">', '[<a onclick="getTop().cancelDoSend();" nocheck="true" style="color:white;">\u53D6\u6D88</a>]', '</td>', '<td style="padding:0 0 0 5px;"></td>', '<td style="width:2px;"></td>', '</tr></table>', '</td></tr>', '</table>']).replace({
            id: c,
            top: isNaN(a) ? (getTop().bnewwin ? 0 : 45) : a,
...
function _getLogoSrc(b, a) {
    var c = getTop();
    return !a && c.gLogoUrl ? c.gLogoUrl.replace(/(.*)_[^_]+_([^_]+)/, "$1_" + b + "_$2") : TE(['$images_path$logo', '$@$if($bFoxmail$)$@$', '_foxmail', '$@$else$@$', '$sSubfolder$', '$@$endif$@$', '/logo_$nSkinId$_', '$@$if($bFoxmail$)$@$', '0', '$@$else$@$', '$sLogoid$', '$@$endif$@$.gif']).replace({
        images_path: getPath("image"),
        bFoxmail: a,
        sSubfolder: c.gsLogoFolder,
        nSkinId: b,
        sLogoid: (c.gsLogoFolder || b == 0) ? (c.gLogoId || 0) : 0
    });
}
...
function changeStyle(a, b) {
    var d = false, c = false;
    var g = getTop().getGlobalVarValue("DOMAIN_MAIL_LOGO_URL") || {},
        h = getTop().goUserInfo.get("DEF_MAIL_FROM") || '';
    if (b) {
    ...
    var f = typeof a == "undefined" || a == "" ? getTop().skin_path : a, j = getTop().gsLogoFolder,
        m = d ? 0 : (j || f == 0 ? (getTop().gLogoId || 0) : 0), i = d ? "_foxmail" : "", e = getTop().changeStyle,
        k = e._sProcessId, l = e._sProcessId = ["skinCssCache", f, i, b || m].join("_");
    if (l != k) {
        cacheByIframe([["css", getPath("style"), "skin" + f + ".css"], !!b ? ["img", "", b] : ["img", _getLogoSrc(f, d)]], {
            onload: function () {
...
function osslogCompose(a, c, e, d, b) {
    getTop().ossLog("delay", "all", T(['stat=compose_send', '&t=$time$&actionId=$actionId$&mailid=$mailid$', '&isActivex=$isActivex$&failCode=$failCode$', '&$other$']).replace({
        time: a,
        actionId: c,
        mailId: e,
        failCode: d || 0,
        other: ["&cgitm=", getTop().g_cgiTimeStamp || -1, "&clitm=", getTop().g_clientTimeStamp || -1, "&comtm=", b && b.valueOf ? b.valueOf() : -1].join('')
    }));
}
...
function osslogAjaxCompose(b, a, d, e, c) {
    ...
    ossLog("delay", "all", T(['stat=compose_ajax_send', '&server=$server$&browser=$browser$', '&status=$status$&code=$code$&section=$section$&sendtype=$type$&ran=$ran$', '&filesuffix=$filesuffix$']).replace({
        ran: now(),
...
;(function () {
    ...
    k.prototype = {
        mnMaxWaitTime: e, moListItems: ['WScreen', 'editor', 'addr', 'page'], _refreshTimer: function () {
            var l = this;
            if (l._moWaitTimer) {
            ...
            debug(l, 2);
            ossLog("delay", "all", T(['stat=compose_init_time', '&browser=$browser$', '&uin=$uin$', '&$data$&ran=$ran$']).replace({
                ran: h.now(),
                uin: h.getUin(),
                browser: a(),
                data: l.join('&')
...
function quickDoSend(a, c, b) {
    ...
    createBlankIframe(getTop(), {
        id: "sendmailFrame", onload: function (e) {
            if (d) {
...
function verifyCode(a, b) {
    ...
    setVerifyCallBack();
    loadingBox({
        model: "\u9A8C\u8BC1\u7801", js: "$js_path$qmverify29f984.js", oncheck: function () {
...
function openComposeDlg(c, b, a) {
    ...
    loadJsFileToTop(["$js_path$com/kits/qmeditor/qqmail/release/editor38a71a.js"]);
    loadingBox({
        model: "\u53D1\u4FE1",
        js: ["$js_path$libcompose3847ad.js", "$js_path$qmaddrinput24e6ae.js"],
        oncheck: function () {
...
function emptyFolder(a, b, c) {
    confirmBox({
        title: "\u6E05\u7A7A\u6587\u4EF6\u5939",
        msg: T(['<div class="dialog_f_t">$name$</div>', '<div class="dialog_f_d">\u6E05\u7A7A\u540E\u90AE\u4EF6\u5C06\u65E0\u6CD5\u6062\u590D\u3002</div>']).replace({name: (c ? "\u662F\u5426\u8981\u6E05\u7A7A\u6B64\u6587\u4EF6\u5939\u4E2D\u7684\u90AE\u4EF6\uFF1F" : "\u662F\u5426\u8981\u6E05\u7A7A" + c + "\u4E2D\u7684\u90AE\u4EF6")}),
        confirmBtnTxt: '\u662F',
        cancelBtnTxt: '\u5426',
        onreturn: function (d) {
            d && b();
...
function renameFolder(c, d, a, b) {
    promptFolder({
        defaultValue: b || '', type: "rename" + (d || 'folder'), onreturn: function (f) {
            var e = S("frm", a);
            if (d == 'tag') {
...
function promptFolder(a) {
    var b = {
        shortcutgroup: {
            ...
            name: '\u8054\u7CFB\u4EBA\u5206\u7EC4',
            maxascii: 32,
            description: "\u5199\u4FE1\u65F6\uFF0C\u53EA\u9700\u8981\u8F93\u5165\u8FD9\u4E2A\u7FA4\u7EC4\u540D(\u6C49\u5B57\u9700\u8F93\u5165\u62FC\u97F3)\uFF0C\u5C31\u53EF\u4EE5\u5FEB\u6377\u7FA4\u53D1\u4E86\u3002"
        },
        folder: {
            title: '\u65B0\u5EFA\u6587\u4EF6\u5939',
            msg: '\u8BF7\u4F60\u8F93\u5165\u6587\u4EF6\u5939\u540D\u79F0',
...
function optFolderUnread(c, f, d, a, e, b) {
    ...
    var j = typeof (d) == "number" && d > 0 ? d : 0, t = l.innerText || l.textContent || "", h = t.lastIndexOf("("),
        i = h == -1 ? 0 : parseInt(t.substring(h + 1, t.lastIndexOf(")")));
    if (c == 0) {
        return i;
    }
    if (i == j) {
    ...
    var g = j == 0, p = {info: htmlEncode(h != -1 ? t.substring(0, h) : t), title: s, unread: j},
        m = GelTags("div", l)[0];
    if (f == "1") {
    ...
    if ((f != "tag" && f.indexOf("tag") >= 0) || (f == "" + parseInt(f) && f >= 129 && m)) {
        ...
        var o = new Date(),
            r = (o.valueOf && o.valueOf() >= 1384099200000 && o.valueOf() <= 1384185600000) ? '<input class="ico_input drifticon drifticon_single" type="button" hidefocus />' : '<input class="ico_input drifticon" type="button" hidefocus />';
...
function openFullSelect(a) {
    var b = getTop();
    QMAjax.send(T('/cgi-bin/do?action=openfullsearch&sid=$sid$&r=$r$&t=$t$').replace({
        sid: getSid(),
        r: Math.random(),
        t: "open_fullsearch.json"
    }), {
        method: "GET",
        headers: {"If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0"},
        onload: function (c, d) {
...
function fakeReadmail(a) {
    QMAjax.send(T('/cgi-bin/readmail?sid=$sid$&mailid=$mailid$&t=readsubmail&mode=fake&base=$base$&pf=$pf$').replace({
        sid: getSid(),
        mailid: a.sMailId,
        pf: rdVer.isPre(a.sFolderId) ? 1 : 0,
        base: rdVer("BaseVer", 0)
    }), {
        method: "GET",
        headers: {"If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0"},
...
function SG(b, a) {
    ...
    var e = GelTags("input", b.parentNode)[0], f = e && e.className,
        d = (a ? b.parentNode.parentNode.parentNode : b.parentNode).nextSibling;
    if (f == "one" || f == "all") {
...
function getSelectGroupUrl() {
    var b = [], c = getMainWin(), d = S("sortinfo", c), e = getUrlParams(c.location)['s'],
        a = e === "search" || e === "searchcontact";
...
function selectGroupCheck(b, a) {
    var e = b.parentNode.parentNode.parentNode, f = GelTags("input", e)[0], h = b.parentNode.parentNode,
        g = getMainWin(), j;
    if (a) {
        var d = parseInt(finds("span[un='nowcnt']", h)[0].innerHTML, 10) || 0,
            c = parseInt(finds("span[un='totalcnt']", h)[0].innerHTML, 10) || 0;
        ...
        if (h.className == "toarea") {
            ...
            if (b) {
                if (d && (j && j.style.visibility === "hidden") || !j) {
                    var c = checkNodeLocate(h, "toarea", false), e = checkNodeLocate(h, "toarea", true), k = {
                            "5": "\u53D1\u4EF6\u4EBA\u4E0B|sender",
                            "6": "\u65F6\u95F4\u5185|day",
                            "7": "\u4E3B\u9898\u5185|subject",
                            "8": "\u5927\u5C0F\u4E0B|size",
                            "9": "\u6536\u4EF6\u4EBA\u4E0B|receiver",
                            "13": "\u56DE\u590D\u4E0B|unread"
                        }, n = attr(S("sortinfo", getMainWin()), "isorttype"),
                        f = getUrlParams(getMainWin().location)["s"] === "search", o;
                    if (e || c) {
                        ...
                        if (!l.getAttribute("groupcnt")) {
                            ...
                            QMAjax.send(o, {
                                method: "GET", onload: function (q, r) {
                                    if (q && r) {
...
RD.goFolderPage = function (a) {
    goUrlMainFrm(T("/cgi-bin/$cgi$?sid=$sid$&folderid=$fid$&page=0&t=$t$").replace({
        cgi: a == "9" ? "readtemplate" : "mail_list",
        fid: a,
        sid: getSid(),
        t: a == "9" ? "sms_list_v2" : ""
    }), false);
...
RD.getURL = function (g, i, b, e, h, d, a, f, j, c) {
    ...
    var q = rdVer.url(i, h, j, e, c, d, a, f, false, getUrlParams(getMainWin().location).folderkey), p = "&hitmailid=",
        k = false, o;
    if (g) {
        if (g.donadel) {
            k = true;
...
function ListMouseClick(_aoEvent, _aoWin) {
    ...
    if (_oTargetObj.className.indexOf("cir") == 0) {
        var _sFakeEventModal = T(['{', 'shiftKey:true,', 'hitmailid:"$hitmailid$"', '}']).replace({"hitmailid": _oTargetObj.getAttribute("hitmailid") || parents("td[hitmailid]", _oTargetObj)[0] || ""}),
            _oClickElem = GelTags("table", _oTargetObj.parentNode.parentNode)[0].parentNode,
            _sClickStr = _oClickElem.onclick;
        if (_sClickStr) {
...
function reportSpam(c, b, e, d, a) {
    ...
    var o = (d !== 1 ? ["<div style='padding:10px 10px 0 25px;text-align:left;'>", "<form id='frm_spamtype'>", "<div style='margin:3px 0 3px 3px'><b>\u8BF7\u9009\u62E9\u8981\u4E3E\u62A5\u7684\u5783\u573E\u7C7B\u578B\uFF1A</b></div>", m.replace({
        value: (b ? 11 : 8),
        checked: "checked",
        content: "\u5176\u4ED6\u90AE\u4EF6"
    }), m.replace({
        ...
        checked: "",
        content: "\u6B3A\u8BC8\u90AE\u4EF6"
    }), "<div style=\"padding:5px 0 2px 0;\">", (c ? "&nbsp;" : getRefuseText(p)), "</div><div style='margin:10px 3px 0px 3px' class='addrtitle' >\u6E29\u99A8\u63D0\u793A\uFF1A\u6211\u4EEC\u5C06\u4F18\u5148\u91C7\u7EB3\u51C6\u786E\u5206\u7C7B\u7684\u4E3E\u62A5\u90AE\u4EF6\u3002</div>", "</form>", "</div><div style='padding:3px 15px 12px 10px;text-align:right;'>", "<input type=button id='btn_ok' class='btn wd2' value=\u786E\u5B9A>", "<input type=button id='btn_cancel' class='btn wd2' value=\u53D6\u6D88>", "</div>"] : ["<div class='cnfx_content'>", "<img style='float:left; margin:5px 10px 0;' src='", getPath("image"), "ico_question.gif' />", "<div class='b_size' style='padding:10px 10px 0 0;margin-left:65px;line-height:1.5;height:80px;text-align:left;'>", "<form id='frm_spamtype'>", "<strong>\u60A8\u8981\u4E3E\u62A5\u8FD9\u4E2A\u6F02\u6D41\u74F6\u5417\uFF1F</strong><br>", "<div style=\"display:none\">", m.replace({
        value: 8,
        checked: "checked",
        content: ""
    }), "</div>", "\u4E3E\u62A5\u4EE5\u540E\uFF0C\u60A8\u5C06\u4E0D\u518D\u6536\u5230\u8FD9\u4E2A\u6F02\u6D41\u74F6\u7684\u56DE\u5E94\u3002", "</form>", "</div></div><div class='cnfx_btn'>", "<input type=button id='btn_ok' class='btn wd2' value=\u786E\u5B9A>", "<input type=button id='btn_cancel' class='btn wd2' style='margin-left:5px' value=\u53D6\u6D88>", "</div>"]).join("");
    new (getTop().QMDialog)({
        sId: "reportSpam",
        sTitle: d === 1 ? "\u7838\u6389\u8FD9\u4E2A\u74F6\u5B50" : "\u4E3E\u62A5\u5E76\u62D2\u6536\u9009\u4E2D\u90AE\u4EF6",
        sBodyHtml: o,
        nWidth: 450,
        nHeight: d === 1 ? 150 : 220,
        onload: function () {
    ...
    var _sSid = getSid(), _sMask = unikey("allread"), _fSetAllRead = function () {
        QMAjax.send("/cgi-bin/mail_mgr?mailaction=read_all&t=unreadmail_reg_data&loc=setFolderUnread,,,32", {
            ...
            content: T('sid=$sid$&folderid=$folderid$&groupid=$groupid$$flags$').replace({
                sid: _sSid,
                folderid: _asFolderId != "all" ? _asFolderId : "1&folderid=3&folderid=8&folderid=9&folderid=11&folderid=personal&folderid=pop&folderid=subscribe",
                groupid: _asGroupId,
                flags: _asFolderId == 'all' && !_asFlag ? '&flag=all' : (_asFlag ? _asFlag : "")
            }),
    ...
    if (!a) {
        ...
        addEvents(a, {
            mouseover: function (d) {
                ...
                try {
                    var m = getTop(), l = m.calcPos(k), i = m.S("showcalpanel", m.getMainWin()), j = m.calcPos(i),
                        g = m.S("contentDiv", m.getMainWin()) || m.parents("div.qm_converstaion_body", k)[0],
                        h = m.calcPos(g);
                    if (g && j[2] > h[2]) {
...
function linkMaker(c, b) {
    var f = "([a-z0-9.!#$%&'+/=?^_`{|}~-]{3,}@(?:[A-Z0-9-]+\\.)+[A-Z]{2,4})",
        g = ['(', '(?:https?:\\/\\/|www\d{0,3}[.]|[a-z0-9.\\-]+[.][a-z]{2,4}\\/)', '(?:', '(?:&amp;amp;)', '|', '(?:&amp;)', '|', '[^\\s`!()\uFF08\uFF09\\[\\]{};\'"<>\u201C\u201D\u2018\u2019\u3002\uFF0C\uFF1B]', '|', '(?:[(\uFF08][^\\s()\uFF08\uFF09<>]+[)\uFF09])', '|', '(?:[(\uFF08][^\\s()\uFF08\uFF09<>]*?[(\uFF08][^\\s()\uFF08\uFF09<>]*?[)\uFF09][)\uFF09])', ')+', '(?:', '(?:[(\uFF08][^\\s()\uFF08\uFF09<>]+[)\uFF09])', '|', '(?:[(\uFF08][^\\s()\uFF08\uFF09<>]*?[(\uFF08][^\\s()\uFF08\uFF09<>]*?[)\uFF09][)\uFF09])', '|', '[^\\s`!()\uFF08\uFF09\\[\\]{};:\'".,<>?\u201C\u201D\u2018\u2019\u3002\uFF0C\uFF1B]', ')', ')'].join(""),
        h = ['(', '[=\\u2248]?', '(?:', '(?:\uFF08\\+?\\d{1,5}\\-?\uFF09|\uFF08\\+?\\d{1,5}\\-?|\\(\\+?\\d{1,5}\\-?\\)|\\(\\+?\\d{1,5}\\-?|\\+?\\d{1,5}\\-?)?', '(?:', '1\\d{3}(?:\\-?\\d{3,4}){2}', '|', '(?:[(\uFF08]?\\d{2,4}[)\uFF09]?)?\\d{3,5}\\-?\\d{3,5}(?:\\-?(?:\\d{1,8}|\uFF08\\d{1,8}\uFF09|\\(\\d{1,8}\\)))?', ')', ')', '(?:(?![\\d\\-\\+\\*\\/=\\u2248]))', ')'].join(""),
        e = (/((?!0000)[0-9]{4}(?:[-/.]{1})?(?:(?:0?[1-9]|1[0-2])(?:[-/.]{1})?(?:0?[1-9]|1[0-9]|2[0-8])|(?:0?[13-9]|1[0-2])(?:[-/.]{1})?(?:29|30)|(?:0?[13578]|1[02])(?:[-/.]{1})?31)|(?!0000)[0-9]{4}(?:[-/\u5E74]{1})(?:(?:0?[1-9]|1[0-2])\u6708(?:0?[1-9]|1[0-9]|2[0-8])\u65E5|(?:0?[13-9]|1[0-2])\u6708(?:29|30)\u65E5|(?:0?[13578]|1[02])\u670831\u65E5)|(?!\u5E74)(?:(?:0?[1-9]|1[0-2])\u6708(?:0?[1-9]|1[0-9]|2[0-8])\u65E5|(?:0?[13-9]|1[0-2])\u6708(?:29|30)\u65E5|(?:0?[13578]|1[02])\u670831\u65E5)|(?![/-])(?:(?:0?[1-9]|1[0-2])(?:[-/.]{1})?(?:0?[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])(?:[-/.]{1})?(?:29|30)|(?:0[13578]|1[02])(?:[-/.]{1})?31))\b/g).source;
...
function pushTelp(a) {
    var c = 4, e = getTop(), f = a, d = parseInt(e.goUserInfo.get("IOSWEBAPPVERNEW"), 10) || 0,
        b = parseInt(e.goUserInfo.get("ANDROIDWEBAPPVERNEW"), 10) || 0;
    if (d >= c || b >= c) {
...
function telphonePushWizard(a) {
    ...
    confirmBox({
        title: "\u62E8\u53F7\u786E\u8BA4",
        msg: T(['<div class="dialog_f_t">\u901A\u8FC7QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF\u8FDB\u884C\u62E8\u53F7\uFF1A$telphonenumb$\uFF1F</div>', '<div class="dialog_f_d">\uFF08\u6B64\u529F\u80FD\u9700\u8981QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF4.0\u7248\u672C\u53CA\u4EE5\u4E0A\u914D\u5408\u4F7F\u7528\uFF0C</br>\u672A\u5B89\u88C54.0\u7248\u672C\uFF0C\u8BF7<a href="http://app.mail.qq.com/" target="_blank" style="color:rgba(25, 99, 255, 1);">\u70B9\u6B64\u4E0B\u8F7D</a>\uFF09</div>']).replace({telphonenumb: c}),
        confirmBtnTxt: '\u786E\u5B9A',
        cancelBtnTxt: '\u53D6\u6D88',
        onreturn: function (d) {
            if (d) {
                b.QMAjax.send("/cgi-bin/webapnscheck", {
                    content: b.T("sid=$sid$&key=$key$&action=pushphoneno&phoneno=$phoneno$").replace({
                        sid: b.getSid(),
                        key: "",
                        phoneno: encodeURIComponent(c)
                    }), method: "POST", onload: function () {
                        confirmBox({
                            title: "\u65B0\u6D88\u606F\u63D0\u9192\u5DF2\u53D1\u51FA",
                            msg: ['<div class="dialog_f_t">\u624B\u673A\u7AEF\u4F1A\u6536\u5230\u65B0\u6D88\u606F\u63D0\u9192\uFF0C\u8BF7\u70B9\u51FB\u65B0\u6D88\u606F\u901A\u77E5\u5F00\u59CB\u62E8\u53F7</div>', '<div class="dialog_f_d">\uFF08\u82E5\u957F\u65F6\u95F4\u672A\u6536\u5230\u65B0\u6D88\u606F\u901A\u77E5\uFF0C\u8BF7\u68C0\u67E5\u662F\u5426\u6709\u5F00\u542F\u624B\u673A\u7CFB\u7EDF\u901A</br>\u77E5\u6216\u5C1D\u8BD5\u91CD\u65B0\u62E8\u53F7\uFF09</div>'].join(""),
                            onload: function () {
...
function installAppWizard() {
    var a = getTop();
    var b = new (a.QMDialog)({
        sId: "iphoneuploadimg",
        sTitle: "\u8BF7\u5B89\u88C5QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF\u6700\u65B0\u7248\u672C",
        sBodyHtml: ['<div class="QMEditorToolPop">', '<div class="qmEditorPicContent" id="content">', '<div id="loading" style="padding-bottom:25px;overflow:hidden;">', '<div class="iphonetel_phone_code"></div>', '<p class="ufa_intro" style="margin-top:14px;width:320px">\u62E8\u53F7\u529F\u80FD\u9700\u8981QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF4.0\u7248\u672C\u53CA\u4EE5\u4E0A\u914D\u5408\u4F7F\u7528\uFF0C\u8BF7\u5148\u626B\u63CF\u4E8C\u7EF4\u7801\u4E0B\u8F7D\u5B89\u88C5\uFF0C\u767B\u5F55\u8BE5QQ\u90AE\u7BB1\u540E\u5373\u53EF\u4F7F\u7528\u3002</p>', '</div>', '</div>', '</div>'].join(""),
        nWidth: 384,
        bAnimation: false
    });
}
...
function _openExtLink(a, b, c) {
    ...
    if (a.href.indexOf("mailto:") == 0 && a.href.indexOf("@") != -1) {
        ...
        getMainWin().location = T('/cgi-bin/cardlist?sid=$sid$&t=$t$&s=$s$&today_tips=$tips$&loc=readmail,readmail,sendnewcard,1&ListType=$listtype$&email=$email$$newwin$').replace({
            sid: getSid(),
            t: f ? "compose_card" : "card",
            s: d ? "replybirthcard" : "",
            tips: r.indexOf("btn") != -1 ? "112" : "111",
            listtype: f ? "No" : "Cards&Cate1Idx=listall",
            email: t,
        ...
        I = trim2(I);
        QMAjax.send(I, {
            method: "POST", content: "sid=" + getSid(), onload: function (e, O) {
                if (e) {
        ...
        var i = parents("td.qqmail_appleid_verify_code_container", a),
            j = finds("td.qqmail_appleid_verify_code_desc", i[0])[0],
            o = finds("a.qqmail_appleid_verify_code_sendBtn", i[0])[0], G = attr(o, "data-type"),
            p = {"appleid": "appleid_wx", "appleid_wx": "appleid"}, k = {
                "appleid": "\u9A8C\u8BC1\u7801\u53D1\u9001\u81F3 \u624B\u673AQQ-\u670D\u52A1\u53F7-QQ\u5B89\u5168\u4E2D\u5FC3",
                "appleid_wx": "\u9A8C\u8BC1\u7801\u53D1\u9001\u81F3 \u624B\u673A\u5FAE\u4FE1-\u670D\u52A1\u53F7-\u5FAE\u4FE1\u5B89\u5168\u4E2D\u5FC3"
            }, h = {
                "appleid": "\u5207\u6362\u81F3QQ\u5B89\u5168\u9A8C\u8BC1",
                "appleid_wx": "\u5207\u6362\u81F3\u5FAE\u4FE1\u5B89\u5168\u9A8C\u8BC1"
            }, C = p[G];
        if (C) {
            j.innerHTML = k[C];
            attr(o, "data-type", C);
        ...
        function N() {
            showInfo("\u53D1\u9001\u9A8C\u8BC1\u7801...");
            QMAjax.send("/cgi-bin/gen_safecode", {
                method: "POST",
                content: ["t=apple_id_verify.json&mailid=", encodeURIComponent(y), "&type=", encodeURIComponent(G)].join(""),
                onload: function (e, O) {
                    var P = evalValue(O || "{}");
                    if (e && P && P.resCode == "0") {
                        showInfo("\u9A8C\u8BC1\u7801\u5DF2\u53D1\u9001");
        ...
        function J() {
            ...
            QMAjax.send("/cgi-bin/gen_safecode", {
                method: "POST",
                content: ["type=appleid_check&t=apple_id_verify.json&mailid=", encodeURIComponent(y), "&safecode=", encodeURIComponent(e)].join(""),
                onload: function (P, Q) {
                    var R = evalValue(Q || "{}");
                    if (P && R && R.resCode == "0") {
                        showInfo("\u9A8C\u8BC1\u901A\u8FC7\uFF0C\u8BFB\u4FE1\u4E2D...");
        ...
        g = new QMDialog({
            oEmbedWin: getMainWin(),
            sId: "id_appleIdVerifyCode",
            sTitle: "\u8F93\u5165\u9A8C\u8BC1\u7801",
            nWidth: 440,
            sBodyHtml: ['<div class="addAccount_step addAccount_step_Username">', '<div id="div_warning" class="addAccount_errorTip"></div>', '<div style="position: relative;left: 60px;top: -10px;/*color: #969696;*/">', '\u9A8C\u8BC1\u7801\u5DF2\u53D1\u9001\u81F3 <span style="font-weight: bold;">\u624B\u673AQQ-\u670D\u52A1\u53F7-QQ\u5B89\u5168\u4E2D\u5FC3</span>', '</div>', '<div id="div_frame_container" class="addAccount_text" style="left:60px">', '<input type="text" id="ipt_username" class="addAccount_ipt"/>', '</div>', '</div>', '<div class="dialog_operate addAccount_foot" id="div_foot">', '<a href="javascript:;"  id="geConfirmBtn" class="qui_btn qui_btn_Blue">\u786E\u5B9A</a>', '<a href="javascript:;"  id="geCancelBtn" class="qui_btn addAccount_foot_cancel">\u53D6\u6D88</a>', '</div>'].join(""),
            bAnimation: false,
            onshow: function () {
        ...
        var t = attr(a, "email"),
            M = ["\u5929\u4E86\u565C\uFF0C\u592A\u611F\u4EBA\u4E86\uFF0C\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\uFF01", "\u6536\u5230\u4F60\u7684\u8D3A\u5361\uFF0C\u771F\u662F\u592A\u5F00\u5FC3\u5566\uFF01\uFF01", "\u597D\u5F00\u5FC3\u54E6\uFF0C\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\u54E6\uFF01", "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\uFF0C\u5E38\u8054\u7CFB\uFF01", "\u6709\u4EBA\u60E6\u8BB0\u7684\u611F\u89C9\u771F\u597D\uFF0C\u611F\u8C22\u6709\u4F60\uFF01", "\u8C22\u8C22\u4F60\u5728\u8FD9\u4E2A\u7F8E\u597D\u7684\u65E5\u5B50\u8BB0\u5F97\u6211\uFF01\u5E38\u8054\u7CFB\uFF01", "\u6536\u5230\u4F60\u7684\u8D3A\u5361\u5566\uFF0C\u611F\u52A8\u5F97\u4E0D\u8981\u4E0D\u8981\u7684\u3002\u3002\u3002", "\u563F\uFF0C\u6211\u6536\u5230\u8D3A\u5361\u4E86\u54E6\uFF0C\u597D\u68D2\u5594\uFF0C\u8C22\u8C22\u4F60\uFF01", "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\uFF0C\u6211\u7684\u670B\u53CB\uFF01", "\u8C22\u8C22\u4F60\u7684\u8D3A\u5361\uFF0C\u4E5F\u795D\u4F60\u5E78\u798F\u5FEB\u4E50\uFF01"],
            L = M[(Math.floor(Math.random() * M.length))];
        openComposeDlg("card", {
            sTitle: "\u7B54\u8C22\u597D\u53CB",
            sDefAddrs: t,
            bAddrEdit: true,
        ...
        var t = a.name;
        openComposeDlg("postcard", {
            sTitle: "\u7B54\u8C22\u597D\u53CB",
            sDefAddrs: t,
            bAddrEdit: true,
            nWidth: 495,
            sDefContent: "\u8C22\u8C22\u4F60\u7684\u660E\u4FE1\u7247\uFF01 \u4EE5\u540E\u8981\u5E38\u8054\u7CFB\u54E6\u3002",
            bContentEdit: true,
            sDefSubject: "\u8C22\u8C22\u4F60\u7684\u660E\u4FE1\u7247!",
            bRichEditor: false,
            oncomplete: function () {
        ...
        if (B.indexOf("follow=1") >= 0) {
            ...
            QMAjax.send(I, {
                method: "POST",
                content: "fun=followshare&followuin=" + v + "&sid=" + getSid(),
                onload: function (e, O) {
                    if (e) {
    ...
    D || (D = c);
    window.open(T('$baseDomain$/cgi-bin/mail_spam?action=check_link&url=$url$&mailid=$mid$&spam=$spam$').replace({
        baseDomain: getTop().getTopHost(),
        mid: D,
        spam: b == "spam" ? 1 : 0,
...
var QMMLCache = {
    _NAME: "maillist", _MAX_AGE: 3600 * 2, _FLAG_ON: 1, useCache: function () {
        ...
        if (this._FLAG_ON) {
            ...
            addEvent(S("navMidBar"), "mousedown", function (g) {
                ...
                if (i && i.tagName == "A") {
                    if (j) {
                        var m = attr(j, "dr"), o = attr(j, "dp"), p = attr(j, "dn"), n = attr(i, "name"),
                            h = n == "book";
                        if (m && p != "0" && m != "morefunction" && m != "attach" && m != "3" && m != "4") {
                            ...
                            b(function (r, t, s, u, q) {
                                return function () {
                                    try {
                                        if (hasClass(i, 'empty_link') && QMMLCache.folder(r, {
                                                dr: r,
                                                dp: q ? s : t
                                            }, true).split('#')[0] == getMainWin().location.pathname + getMainWin().location.search) {
                                            return;
                                        }
                                    }
                                    catch (v) {
                                    }
                                    QMMLCache.log("hit", [r, t, u].join("|"), QMMLCache.folder(r, {
                                        dr: r,
                                        dp: q ? s : t
                                    }, true));
            ...
            E(finds("li[dr] a", S("navMidBar")), function (g) {
                var k = attr(g.parentNode, "dr"), j = attr(g.parentNode, "dp"), i = attr(g.parentNode, "dn"),
                    h = attr(g, "name");
        ...
        var d = -1, c = -2, b = -3, e = -4, f = -5, a = -6,
            n = TE(['/cgi-bin/mail_list?sid=$sid$&folderid=$folderid$&folderkey=$folderkey$']).replace({
                sid: getSid(),
                folderid: i,
                folderkey: i
            }), j = h || {};
        ...
        if (!g && (!j.dp || j.dp == j.dr)) {
            ...
            ossLog(l, "all", T("stat=nothing&$locname$=folderlist,,,$id$").replace({
                id: k,
                locname: l == "realtime" ? "loc" : "locval"
            }));
        }
        delete j.dp;
        delete j.dr;
        ...
        var f = CommVer.get(this._NAME), d = cookQueryString(c.split("#").shift(), extend(b, this._FLAG_ON ? {
            ver: f,
            cachemod: this._NAME,
            cacheage: this._MAX_AGE,
            r: ""
        } : {}));
        ...
        try {
            var d = CommVer.get(this._NAME), c = a || getTop().getMainWin(), b = c.location,
                f = getUrlParams(b)["cachemod"], g = getUrlParams(b)["ver"];
...
function MLI(b, a, c, d) {
    ...
    var h = n.getAttribute("uw") == "1", p = a.oPreMails, i = p.length, k = a.gnPreloaded, j = 3,
        e = new Date() - new Date(parseInt(n.getAttribute("totime"))) < 1728000000,
        f = !/^(LP|ZP)/.test(r) && e && !rdVer.log(r);
...
function MLJump(b, c, d, a) {
    var h = SN("maillistjump", a.document), j = SN("prevpage", a.document), i = SN("nextpage", a.document),
        l = "_MlJuMp_", f = parseInt(b) || 0, g = parseInt(c) || 0;
    ...
    function e(m) {
        ...
        if (QMMLCache.useCache()) {
            QMMLCache.url(getTop().getMainWin().location.href, {
                page: n,
                selectall: (getTop().isSelectAllFld(getMainWin()) ? 1 : 0)
            });
        }
        else {
            ...
            addEvents(m, {
                click: function (n) {
                    ...
                    new (getTop().QMMenu)({
                        ...
                        nWidth: p,
                        nX: q[1] - p,
                        nY: bodyScroll(a, "scrollHeight") - q[2] < o ? (q[0] - o - 13) : q[2],
                        bAutoClose: false,
                        oItems: [{nHeight: o, sItemValue: MLJump._oTemplate.replace({id: r})}],
                        onshow: function () {
                            this.S("txt").focus();
                        }
                    });
...
function initDropML() {
    ...
    var h = S('dragtitle'), k = S('OutFolder'), o = 'inidrop', f = BaseMailOper.getInstance(getMainWin()),
        a = QMDragDrop, n = 'mail_list';
    if (k.getAttribute(o) == 'true') {
        return false;
    }
    k.getAttribute(o, 'true');
    a.delGroup(n);
    var j = null, c = false, l = null, g = null, e = null, m = /^([489]|personal|pop|tag)$/,
        i = new a.DropTarget(S('OutFolder'), {
            ondragover: function (p) {
                if (l == g) {
                    return;
                }
                var t = l && l.id || '', r = g && g.id || '', u = l && l.getAttribute('dp'),
                    s = g && g.getAttribute('dp'), q = g && g.getAttribute('dr');
                if (s) {
                ...
                q.play({
                    speed: "slow", onaction: function (u, t) {
...
function dragML(b, a) {
    ...
    var f, e = new QMDragDrop.Draggable(b, {threshold: 5, oTitle: d}, {
    ...
    var c = b.ownerDocument, h = c.parentWindow || c.defaultView,
        j = dragML._sMarkMainWin = dragML._sMarkMainWin || unikey('drag');
    if (!h[j]) {
...
MLI._remarkTip = function (d) {
    var f = getTop(), e = arguments.callee, a = Scale.fixFrameCursorPos(d.clientX),
        b = Scale.fixFrameCursorPos(d.clientY), c = getEventTarget(d);
...
function getMailListInfo() {
    ...
    return {
        totle: (c && parseInt(c.innerHTML)) || 0,
        unread: (d && parseInt(d.innerHTML)) || 0,
        star: (b && parseInt(b.innerHTML)) || 0
    };
}
...
function showSimpleRuleFilter(_asAddr) {
    ...
    var _oDialog = new (getTop().QMDialog)({
                ...
                if (_abIsOk) {
                    ...
                    function _fAddOption(_asName, _asValue) {
                        ...
                        if (_oUserFolder.length == 1) {
                            _oUserFolder = _fAddItem(_oUserFolder, {
                                bDisSelect: true,
                                nHeight: 10,
                                sItemValue: '<hr/>'
                            }, 0);
                    ...
                    function _fCreateFolder() {
                        promptFolder({
                            ...
                            onreturn: function (_asName) {
                                QMAjax.send("/cgi-bin/foldermgr", {
                                    method: "POST",
                                    content: ["sid=", getSid(), "&fun=new&from=simple&ef=js&resp_charset=UTF8&name=", _asName].join(''),
                                    onload: function (_abIsOk, _asResp) {
                                        try {
                                            if (_abIsOk) {
                    ...
                    _oQMSelect = new QMSelect({
                        oContainer: S("selectfolder", _oDialogWin),
                        oMenu: {nWidth: "auto", nMaxWidth: 180, nMaxItemView: 4, oItems: _oUserFolder},
                    ...
                    addEvent(S("confirm", _oDialogWin), "click", function () {
                        ...
                        if (_sFolderId == "-1") {
                            ...
                            QMAjax.send("/cgi-bin/foldermgr", {
                                method: "POST",
                                content: ["sid=", getSid(), "&fun=addfilter&from=simple&ef=js&action=move&oldmail=", _nOldMail, "&sender=", _asAddr, "&folderid=", _sFolderId].join(''),
                                onload: function (_abIsOk, _asResp) {
                                    try {
                                        if (_abIsOk) {
                                            var _oData = eval("(" + _asResp + ")");
                                            if (_oData.errcode == "0") {
                                                if (_nOldMail && _oData.affected > 0) {
                                                    showInfo(TE(['\u64CD\u4F5C\u6210\u529F\uFF0C', '$@$if($num$>0)$@$', '\u79FB\u52A8\u4E86$num$\u5C01\u90AE\u4EF6\u3002', '$@$else$@$', '\uFF0C\u60A8\u6CA1\u6709\u9700\u8981\u79FB\u52A8\u6216\u6807\u8BB0\u7684\u90AE\u4EF6\u3002', '$@$endif$@$', '<a href="/cgi-bin/mail_list?sid=$sid$&folderid=$fid$&page=0"', 'style="color:white" onclick="getTop().gotoCheckMovedEmail();" target="mainFrame">', '[\u67E5\u770B]', '</a>']).replace({
                                                        sid: getSid(),
                                                        fid: _oData.folderid,
                                                        num: _oData.affected
                                                    }), 30000);
...
function applyRulesConfirm(a) {
    QMAjax.send("/cgi-bin/mail_mgr", {
        method: "POST",
        content: ["sid=", getSid(), "&fname=&mailaction=mail_filter"].join(''),
        headers: {"If-Modified-Since": "0", "Cache-Control": "no-cache, max-age=0"},
        onload: function (b, c) {
            if (b) {
...
function getPaths() {
    if (getLocale() == "zh_CN") {
        var a = {
            ...
            swf_path: window.location.protocol + '//' + window.location.host + "/zh_CN/htmledition/swf/",
...
function outputJsReferece(c, a, b) {
    var i = c || outputJsReferece._msPath, f = a || outputJsReferece._moFileList, h = b || window,
        g = T(['<script $crossorigin$ src="$file$$r$"></', 'script>']), j = c ? '' : 'r=' + Math.random(), e = [];
    outputJsReferece._msPath = i;
    outputJsReferece._moFileList = f;

    function d(k) {
        var m = trim(k || ""), n = /[0-9a-fA-F]{6}\.js$/.test(m) ? k.substr(0, k.length - 9) : k.split(".")[0],
            l = loadJsFile.checkCrossOrigin(i + k), o = '';
        if (n && (c || !h[n + "_js"])) {
            if (j) {
                o = k.indexOf('?') > 0 ? '&' + j : '?' + j;
            }
...
function createBlankIframe(b, a) {
    cacheByIframe(a && a.defcss == false ? [] : [["css", "", getRes("$css_path$comm327bfb.css")], ["css", getPath("style"), "skin"]], extend({
        className: "menu_base_if",
        transparent: false,
        destroy: false
    }, a, {
        win: b,
        header: ["<script>", getTop.toString().replace(/[\r\n]/g, ""), "<\/script>", a && a.header || ""].join(""),
        onload: function (c) {
...
function confirmBox(a) {
    var c = 2, b = a.defaultChecked || false, e = a.confirmBtnTxt || "\u786E\u5B9A",
        d = a.cancelBtnTxt || "\u53D6\u6D88", f = a.neverBtnTxt;
    return new (getTop().QMDialog)({
        bAlignCenter: a.bAlignCenter,
        sId: a.id || "QMconfirm",
        sTitle: a.title || "\u786E\u8BA4",
        bAnimation: a.bAnimation || false,
        sClassName: a.sClassName,
        nWidth: a.nWidth,
        sBodyHtml: TE(['<div class="$sStyle$" style="$sStyle$">', '$@$if($sType$=="custom")$@$', '$msg$', '$@$else$@$', '<div class="cnfx_content">', '<span class="dialog_icon icon_info_b"></span>', '<div class="dialog_f_c">$msg$</div>', '</div>', '<div class="cnfx_status" style="display:$statusdisp$;">', '<input id="recordstatus" class="cnfx_status_checkbox" type="checkbox" $checked$/><label for="recordstatus">$recordinfo$</label>', '</div>', '$@$endif$@$', '</div>']).replace({
            sStyle: a.style || '',
            sType: a.sType || "",
            msg: a.msg,
            caceldisp: a.mode == "alert" ? "none" : "",
            imgdisp: a.mode == "prompt" ? "none" : "block",
            recordinfo: a.recordInfo,
            statusdisp: a.enableRecord ? "" : "none",
            checked: a.defaultChecked ? "checked" : "",
            confrim: e,
            confirmcss: getAsiiStrLen(e) > 5 ? "" : "wd2",
            cancel: d,
            cancelcss: getAsiiStrLen(d) > 5 ? "" : "wd2",
            never: f,
            neverdisp: f ? '' : 'none',
            nevercss: getAsiiStrLen(f) > 5 ? "" : "wd2"
        }),
        sFootHtml: TE(['$@$if($bIsFromExBook$)$@$', '<style>', '.createRule_checkbox{margin-top: 0;vertical-align: middle;*vertical-align: -4px;_vertical-align: -1px;}', '</style>', '<div style="float: left;"><input type="checkbox" id="rule_for_history" checked class="createRule_checkbox"><label for="rule_for_history">\u540C\u65F6\u5F52\u6863\u6536\u4EF6\u7BB1\u7684\u5386\u53F2\u90AE\u4EF6</label></div>', '$@$endif$@$', '<div class=" txt_right cnfx_btn">', '<a class="btn_gray confirm $confirmcss$ $confirmClass$" id="confirm" href="javascript:;">$confirm$</a>', '<a class="btn_gray cancel $cancelcss$ $cancelClass$" id="cancel" style="display:$caceldisp$;" href="javascript:;">$cancel$</a>', '<a class="btn_gray $nevercss$" id="never" style="display:$neverdisp$;" href="javascript:;">$never$</a>', '</div>']).replace({
            bIsFromExBook: a.bIsFromExBook,
            caceldisp: a.mode == "alert" ? "none" : "",
            confirm: e,
            confirmcss: getAsiiStrLen(e) > 5 ? "" : "wd2",
            confirmClass: a.confirmClass || "",
            cancel: d,
            cancelcss: getAsiiStrLen(d) > 5 ? "" : "wd2",
            cancelClass: a.cancelClass || "",
            never: f,
            neverdisp: f ? '' : 'none',
            nevercss: getAsiiStrLen(f) > 5 ? "" : "wd2"
        }),
...
function promptBox(a) {
    ...
    return confirmBox(extend({
        sType: "custom", height: 160, onload: function () {
            var d = this;
...
function loadingBox(a) {
    if (!callBack(a.oncheck)) {
        var b = new QMDialog({
            sId: "LoAdINgBOx",
            sTitle: a.model + "\u6A21\u5757\u52A0\u8F7D\u4E2D...",
            nWidth: 400,
            nHeight: 187,
            sBodyHtml: T(['<div style="text-align:center;padding:58px; padding-bottom:78px;">', '<img id="load" src="$images_path$ico_loading21e9c5d.gif">', '<span id="err" style="display:none;">$model$\u6A21\u5757\u52A0\u8F7D\u5931\u8D25</span>', '</div>']).replace(extend(a, {images_path: getPath("image")})),
            onclose: function () {
                b = null;
            }
        });
...
(function () {
    ...
    function d(e) {
        ...
        new QMPanel({
            ...
            sBodyHtml: a.replace({
                noclose: e.bNoCloseBtn,
                html: e.sBodyHtml,
                images_path: getPath("image"),
                offsetTop: (100 - e.nHeightPercent) / 2,
                offsetLeft: (100 - e.nWidthPercent) / 2,
                width: e.nWidthPercent,
                height: e.nHeightPercent
            }),
            onclose: e.onclose,
            onload: function () {
                var f = this;
...
var QMAXInfo = {
    _moInfos: {
        ...
        obj: [["TXGYMailActiveX.ScreenCapture", "TXGYMailActiveX.UploadFilePartition", "TXGYMailActiveX.Uploader", "TXFTNActiveX.FTNUpload", "TXGYMailActiveX.DropFile"]],
        available: ["ScreenCapture", "Uploader", "FTNUpload", "DropFile", "UploadFilePartition"],
        lastVer: ["1.0.1.54", "1.0.1.29", "1.0.1.54", "1.0.3.2", "1.0.0.53"],
        miniVer: [(getDomain() == "foxmail.com") ? "1.0.0.5" : "1.0.1.28", "1.0.1.28", "1.0.1.28", "1.0.0.16", "1.0.0.7"]
    },
    _moInfos_FF: {
        path: "/xpi/",
        ...
        lastVer: ["1.0.1.56", "", "1.0.1.56", "1.0.0.6", "1.0.0.1"],
    ...
    _moInfos_WebKit: {
        ...
        obj: ["ScreenCapture", "", "Uploader", "FTNUpload", "", "PPFTNUpload"],
        available: ["ScreenCapture", "FTNUpload"],
        name: ["QQMail Plugin", "", "QQMail Plugin", "Tencent FTN plug-in", "", "Native Client"],
        type: ["application/x-tencent-qmail-webkit", "", "application/x-tencent-qmail-webkit", "application/txftn-webkit", "", "application/x-pnacl"],
        lastVer: ["1.0.1.56", "", "1.0.1.56", "1.0.0.6", "", "1.0.0.0"],
        miniVer: ["1.0.1.28", "", "1.0.1.28", "1.0.0.4", "", "1.0.0.0"]
    },
    _moInfos_chrome42: {
        path: "/crx/",
        exe: "QQMailScreenCapturePlugin.exe",
        obj: ["ScreenCapture"],
    ...
    _moInfos_WebKitForMac: {
        ...
        name: ["QQMailPlugin", "", "QQMailPlugin", "Tencent FTN Plug-in", "", "Native Client"],
        type: ["application/x-tencent-qmail-webkit", "", "application/x-tencent-qmail-webkit", "application/txftn", "", "application/x-pnacl"],
        lastVer: ["1.0.1.34", "", "1.0.1.34", "1.0.0.3", "", "1.0.0.0"],
        miniVer: ["1.0.1.34", "", "1.0.1.34", "1.0.0.3", "", "1.0.0.0"]
    },
    ...
    get: function (b, a) {
        ...
        var d = {
            IE: this._moInfos,
            FF: this._moInfos_FF,
            chrome: this._moInfos_WebKit,
            chrome42: this._moInfos_chrome42,
            WebKit: this._moInfos_WebKit,
            mac: this._moInfos_WebKitForMac
        }[a];
...
function getMailPluginVersion() {
    var i = getActiveXVer(0), h = getActiveXVer(3), g = QMAXInfo.get("lastVer")[3], f = i.split("."), e = h.split("."),
        d = g.split("."), c = parseInt(f[f.length - 1]), b = parseInt(e[e.length - 1]), a = parseInt(d[d.length - 1]);
    if (a >= b && b > 4) {
        c += (b - 4);
        f[f.length - 1] = c;
        if (a == b && i != "1.0.1.54") {
...
function createPlugin(b, a, c, d) {
    ...
    if (!a && checkInstallPlugin(b)) {
        getTop().ossLog("delay", "all", T(['stat=ff_addon', '&type=%type%&info=%info%'], '%').replace({
            type: !e ? "failcreatePlugin" : "successcreatePlugin",
            info: ["ver:", gsFFVer, ",pluginId:", b, ",brtpe:", (gbIsFF ? 1 : (gbIsChrome ? 2 : (gbIsSafari ? 3 : (gbIsOpera ? 4 : 5))))].join("")
        }));
    }
    return e;
}
...
createPlugin._createQQMailPlugin = function (a, b, c) {
    ...
    if (checkInstallPlugin(a)) {
        ...
        if (!(d = S(g, b))) {
            insertHTML(b.document.body, "beforeEnd", T('<embed class="needed" id="$id$" type="$type$" hidden="true" style="position:absolute;top:-999px;"></embed>').replace({
                type: h,
                id: g
            }));
            d = S(g, b);
...
createPlugin._createFTNPlugin = function (a, b) {
    ...
    a = a || getTop();
    if (!(c = S(d, a))) {
        insertHTML(a.document.body, "beforeEnd", T('<embed class="needed" id="$id$" type="$type$" style="z-index:99999;position:absolute;top:0;left:0;width:1px;height:1px;"></embed>').replace({
            type: e,
            id: d
        }));
        c = S(d, a);
...
function createFTNPlugin(a, b) {
    ...
    if (b) {
        getTop().ossLog("delay", "all", T(['stat=ff_addon', '&type=%type%&info=%info%'], '%').replace({
            type: c && c.Version ? "successcreatePlugin" : "failcreatePlugin",
            info: ["ver:", gsFFVer, ",pluginId:3,insId:", b].join("")
        }));
    }
...
createPlugin._createPPFTNPlugin = function (a, b) {
    ...
    if (!(c = getTop().finds("[id=" + e + "]", getTop().ppContainer)[0])) {
        ...
        if (d) {
            ...
            insertHTML(d, "afterBegin", T('<embed class="needed" style="left:0px;position:absolute;" name="$id$" id="$id$" type="$type$"  width="$width$" height="$height$" source_module_name="ppapi" multi_select="1" path="" usr_id_name="1021274442" src="../zh_CN/htmledition/upload/ftn_nacl.nmf"></embed>').replace({
                type: f,
...
function detectPnacl() {
    ...
    if (a) {
        ...
        if (checkInstallPlugin(5)) {
            ...
            insertHTML(a, "beforeEnd", T('<embed class="needed" name="$id$" id="$id$" type="$type$"  width="$width$" height="$height$" source_module_name="ppapi" multi_select="1" path="" usr_id_name="1021274442" src="../zh_CN/htmledition/upload/ftn_nacl.nmf"></embed>').replace({
                type: e,
                height: 1,
                width: 1,
                id: d
...
function requestShowTip(c, d, b, a) {
    var e = T('/cgi-bin/tip?sid=$sid$&args=$dom$,$tip$&r=$r$').replace({
        sid: getSid(),
        dom: c,
        tip: d,
        r: Math.random()
    ...
    QMAjax.send(e, {
        method: 'GET', onload: function (f, h, g) {
...
function calcMainFrameDomInGlobalPos(a, b) {
    var k = calcPos(a), j = calcPos(S("mainFrame", getTop())), h = getMainWin().document, i = h.documentElement,
        g = h.body, d = k[3] + j[3] - (i.scrollLeft || g.scrollLeft || 0),
        e = k[0] + j[0] - (i.scrollTop || g.scrollTop || 0), f = k[4], c = k[5];
    return b == "json" ? {
        top: e,
        bottom: e + c,
        left: d,
...
var QMLocalStorage = {
    sVer: "Storage/11.9.16", _gsSaveKeyName: "QM_UD_key", _gnRetryTimes: 3, _oTmp: {}, _fIsLegal: function (a) {
        return this._gsSaveKeyName != a;
    }, _fDeleteItem: function (b, a) {
        return b.slice(0, a).concat(b.slice(a + 1, b.length));
    }, _fReportFull: function () {
        var a = getTop(), b = "STORAGE_USERDATA_FULL", c = a.T("type=$type$&info=$info$&locval=$loc$").replace({
            type: b,
            info: _asInfo,
            loc: [b, _asInfo].join(",")
        });
...
function jumpToAttachFlag(b, a) {
    var d = [b, a, a].join("|"),
        c = T("/cgi-bin/attachfolder?topmails=0&sid=$sid$&s=search&folderid=attach&hflag=attach&page=0&t=attachfolder&subject=&sender=&receiver=&searchmode=attach&advancesearch=0&showattachtag=1&action=list&mailattach=$mailattach$&loc=readmail,attachfolder");
...
function attachSetFlag(d, a, b, c) {
    ...
    attachSetFlag._setFlag({
        bIsSetStarred: a,
        oMailAttachs: e,
        loc: (c && c.sLoc) || "attachfolder,col_readmail",
        osstype: (c && c.sOsstype) || "attach_collect_atRead",
        resp_charset: (c && c.sCharset) || ""
    }, function (f) {
        b && b.call(null, f);
...
;attachSetFlag._setFlag = function (_aoParam, _afCallback) {
    var _oCfg = _aoParam || {},
        _sValidTxt = _oCfg.bIsSetStarred ? "\u9644\u4EF6\u5DF2\u6536\u85CF" : "\u9644\u4EF6\u5DF2\u53D6\u6D88\u6536\u85CF",
        _sErroTxt = _oCfg.bIsSetStarred ? "\u6536\u85CF\u5931\u8D25" : "\u53D6\u6D88\u6536\u85CF\u5931\u8D25";
    QMAjax.send("/cgi-bin/attachfolder?t=attachfolder.json", {
        method: "POST",
        content: TE(['$@$for($mailattach$)$@$', '&mailattach=$_this_$', '$@$endfor$@$', '&action=$action$&loc=$loc$&osstype=$osstype$', '$@$if($resp_charset$!="")$@$', '&$resp_charset$', '$@$endif$@$']).replace({
            'mailattach': _oCfg.oMailAttachs,
            'action': _oCfg.bIsSetStarred ? "setflag" : "cancelflag",
            'loc': _oCfg.bIsSetStarred ? _oCfg.loc : "",
            'osstype': _oCfg.osstype,
            'resp_charset': _oCfg.resp_charset
        }),
        onload: function (_abIsOk, _avParam) {
            if (_abIsOk) {
                try {
...
function getAttachList(_avParam, _afCallback, _aoOption) {
    ...
    QMAjax.send(T("/cgi-bin/readmail?sid=$sid$&t=$t$&s=forward&from=attachfolder&disptype=html&ef=js$param$").replace({
        sid: getSid(),
        t: "compose.json",
        param: _oParam.join('&mailattach=')
    }), {
        method: "GET", onload: function (_abIsOk, _avData, _aoXhr) {
            var _bFlag = true;
            if (_abIsOk) {
                try {
...
function recallConfirm(c, b, a) {
    getTop().confirmBox({
        ...
        defaultChecked: true,
        title: "\u64A4\u56DE\u90AE\u4EF6",
        msg: ['<div class="dialog_f_t">\u786E\u5B9A\u64A4\u56DE\u6B64\u90AE\u4EF6\u5417\uFF1F</div>', '<div class="dialog_f_d">\u5982\u679C\u64A4\u56DE\u6210\u529F\uFF0C\u5BF9\u65B9\u5C06\u53EA\u80FD\u770B\u5230\u90AE\u4EF6\u7684\u4E3B\u9898\uFF0C\u5E76\u5F97\u5230\u5DF2\u88AB\u64A4\u56DE\u7684\u63D0\u793A\u3002</div>', '<div class="dialog_f_d graytext" style="margin:12px 0 0 -43px;">', '\u8BE6\u7EC6\u8BF4\u660E\uFF1A', '<ol style="list-style:decimal;padding:0;margin:0 0 0 2em;" >', '<li style="list-style: decimal inside none;">\u4EC5\u5C1D\u8BD5\u64A4\u56DE\u53D1\u5F80QQ\u90AE\u7BB1\u7684\u90AE\u4EF6\uFF0C\u4E0D\u652F\u6301\u4ECE\u5176\u4ED6\u90AE\u7BB1\u64A4\u56DE\u3002</li>', '<li style="list-style: decimal inside none;">\u5982\u679C\u5BF9\u65B9\u5DF2\u7ECF\u9605\u8BFB\uFF0C\u5C06\u4E0D\u4E88\u64A4\u56DE\u3002</li>', '<li style="list-style: decimal inside none;">\u64A4\u56DE\u7ED3\u679C\u5C06\u901A\u8FC7\u7CFB\u7EDF\u90AE\u4EF6\u901A\u77E5\u60A8\u3002 </li>', '</ol>', '</div>'].join(""),
        onreturn: function (d) {
            d && recall(c, b, a);
        }
    });
...
function recall(c, b, a) {
    ...
    var l = function (m) {
        var n = setInterval(function () {
            ...
            getTop().mailRecall(1, {taskid: m.taskid, mailid: recall._msMailid, msgid: c}, {
                onbeforesend: function () {
                    ...
                    if (o.maildatacnt > 0) {
                        if (!d) {
                            new (getTop().QMDialog)({
                                sId: "query_recall_status_dlg",
                                sTitle: "\u64A4\u56DE\u90AE\u4EF6",
                                nWidth: 460,
                                sBodyHtml: k.replace(o),
                                onshow: function () {
                                    var p = this;
    ...
    getTop().mailRecall(0, {msgid: c, mailid: recall._msMailid, time: recall._msTime}, {
        onbeforesend: function () {
            f.apply(recall);
...
function mailRecall(_anType, _aoParam, _aoCallbacks) {
    ...
    QMAjax.send("/cgi-bin/send_status", {
        method: "POST",
        content: !_anType ? T('t=send_status.json&s=mailrecallv2&messageid=$msgid$&time=$time$&sid=$sid$&r=$r$&ef=js' + (_oPostData.mailid ? "&mailid=$mailid$" : "")).replace(_oPostData) : T('t=send_status.json&s=mailrecall_queryv2&taskid=$taskid$&messageid=$msgid$&sid=$sid$&r=$r$&ef=js' + (_oPostData.mailid ? "&mailid=$mailid$" : "")).replace(_oPostData),
        onload: function (_abIsOk, _avParam) {
            if (_abIsOk) {
                try {
...
function bindAccount() {
    var e = S("useraddr"), d = S("useraddrArrow"), a = getTop().goUserInfo.get('RealBindAccount'), b = {
        nHeight: 10,
        sItemValue: '<div style="background:#CCC; height:1px; margin-top:5px; overflow:hidden;"></div>'
    }, c = [], f = e && subAsiiStr(e.innerHTML, 20, "...");
    if (!e || !a) {
        return;
    }
    if (a.mastermail.length) {
        c.push({
            nHeight: 54,
            sItemValue: ['<div style="line-height:24px;">', '<div class="ml">\u8FD4\u56DE\u5173\u8054\u5E10\u53F7</div>', '<div><a href="javascript:;" class="btn_gray" style="width:192px;" id="back_to_master">', a.mastermail[0].email, '</a></div>', '</div>'].join('')
        });
    }
    else if (a.othermail.length || a.bizmail.length) {
        c.push({sItemValue: '<a id="manage" href="javascript:;" style="float: right;">\u7BA1\u7406</a><span class="ml">\u5173\u8054\u5E10\u53F7\uFF1A</span>'}, {
            sId: 'self',
            bDisSelect: true,
            sItemValue: T('<div class="unread_num"><span class="ico_unreadnum"></span>$unread$</div><input type="button" class="ft_upload_success" id="self"/><span style="overflow:hidden;margin-left:0" >$email$</span>').replace({
                email: subAsiiStr(f, 19, "..."),
                unread: a.self.unread > 99 ? '99+' : a.self.unread
            })
        });
        E(['othermail', "bizmail"], function (h, g) {
            ...
            for (var j = a[h].length, l = 0; l < j; l++) {
                ...
                c.push({
                    ...
                    sId: k.uin,
                    email: k.email,
                    bNeedLogin: k.type == "1" ? true : false,
                    sItemValue: ['<div class="unread_num"><span class="ico_unreadnum"></span>', k.unread > 99 ? '99+' : k.unread, '</div>', '<span style="overflow:hidden;">', subAsiiStr(k.email, 19, "..."), '</span>'].join('')
                });
            }
        });
    }
    else {
        c.push({sItemValue: '\u60A8\u7684\u5F53\u524D\u90AE\u7BB1\u5E10\u53F7\uFF1A'}, {sItemValue: T('<strong class="ml black">$myemail$</strong>').replace({myemail: f})}, b, {sItemValue: '\u62E5\u6709\u5907\u7528\u90AE\u7BB1\uFF0C\u6765\u9002\u7528\u4E8E\u4E0D\u540C\u7528\u9014\u3002'}, {sItemValue: '\u5B83\u4EEC\u53EF\u4EE5\u5173\u8054\u5728\u4E00\u8D77\uFF0C'}, {sItemValue: '\u65B9\u4FBF\u968F\u610F\u5207\u6362\u4E0D\u540C\u7684\u90AE\u7BB1\u3002'}, {
            nHeight: 35,
            sItemValue: T('<a id="bind" class="btn_gray btn_space ml" href="http://zc.qq.com" target="_blank">\u7533\u8BF7\u5907\u7528\u90AE\u7BB1</a><a href="/cgi-bin/readtemplate?t=pt_index&sid=$sid$&kvclick=readtemplate|bindother|exist|click&resp_charset=UTF8" target="mainFrame" id="bind_a" class="btn_gray">\u5173\u8054\u5DF2\u6709\u90AE\u7BB1</a>').replace({sid: getSid()})
        });
    }
    if (d) {
            ...
            new QMMenu({
                    ...
                    if (h._sType == 'bizmail') {
                        ...
                        var k = function (l) {
                            ...
                            n.ptlogin2_onLoginSucc = function (p) {
                                m.close();
                                showInfo("\u9A8C\u8BC1\u6210\u529F");
                                QMAjax.send(["/cgi-bin/uplinktime?t=login_relate_after&sid=", getSid(), "&uin=", i].join(""), {
                                    onload: function (q, r) {
                                        l && l();
                                    }
                                });
                ...
                onload: function () {
                    ...
                    addEvent(i.S("bind"), 'click', function (k) {
                        ...
                        getTop().confirmBox({
                            title: "\u63D0\u793A",
                            msg: ['<div class="dialog_f_t" style="font-weight: normal;">\u8BF7\u5728\u6253\u5F00\u7684\u7A97\u53E3\u4E2D\u5B8C\u6210\u65B0\u90AE\u7BB1\u6CE8\u518C\uFF0C\u6210\u529F\u6CE8\u518C<br/>\u540E\u53EF\u4EE5\u8FDB\u884C\u5907\u7528\u90AE\u7BB1\u7684\u8BBE\u7F6E</div>'].join(""),
                            confirmBtnTxt: '\u5DF2\u6CE8\u518C',
                            cancelBtnTxt: '\u53D6\u6D88',
                            onreturn: function (l) {
                                l && toBindAccountPage();
                    ...
                    addEvent(i.S("back_to_master"), "click", function (k) {
                        goUrlTopWin(T('/cgi-bin/login?vt=relate&uin=$uin$&old_sid=$sid$&master=true').replace({
                            uin: a.mastermail[0].uin,
                            sid: getSid()
                        }));
                        i.close();
                        preventDefault(k);
...
function bindLinkedInAccount() {
    ...
    a._oDialog = new b.QMDialog({
        sId: "id_bindLinkedIn",
        sTitle: "\u7ED1\u5B9ALinkedIn\u5E10\u53F7",
        nWidth: 400,
        sBodyHtml: a._oTmpl.replace({}),
        bAnimation: false,
        onload: function () {
            var c = this;
...
bindLinkedInAccount.unBindLinkedIn = function () {
    var d = this, e = getTop(), f = e.getMainWin(), a = e.S("bindLinkedIn", f), b = e.S("bindedLinkedIn", f),
        c = e.S("linkedInCount", f);
    e.showInfo("\u6B63\u5728\u53D6\u6D88\u5173\u8054LinkedIn\u9886\u82F1\u5E10\u53F7...", 1500);
    e.QMAjax.send("/cgi-bin/bind?sid=" + e.getSid() + "&fun=unbindlinkedin", {
        method: "GET", onload: function (g) {
            if (g) {
...
bindLinkedInAccount.doOauth = function () {
    var a = this, b = getTop(), c = "linkedInOauthCode",
        d = ["https://www.linkedin.com/uas/oauth2/authorization?", "response_type=code", "&client_id=75pp0iurxmlt50", "&scope=r_fullprofile%20r_emailaddress%20r_basicprofile%20r_contactinfo", "&state=STATE", "&redirect_uri=https%3A%2F%2Fmail.qq.com%2Fcgi-bin%2Freadtemplate%3Fcheck%3Dfalse%26t%3Dlinkedin_oauth"].join("");
...
bindLinkedInAccount.onSuccess = function (a) {
    var e = this, f = getTop(), g = f.getMainWin(), b = f.S("bindLinkedIn", g), c = f.S("bindedLinkedIn", g),
        d = f.S("linkedInCount", g);
    ...
    e._oDialog.close();
    f.QMAjax.send("/cgi-bin/get_netres", {
        method: "POST", content: i, onload: function (j, m) {
            if (j) {
...
bindLinkedInAccount.getLinkedInProfile = function (b, a, e) {
    ...
    c.QMAjax.send("/cgi-bin/get_netres", {
        method: "POST", content: d, onload: function (f, k) {
            ...
            if (f) {
                ...
                e && e(f, {
                    ...
                    "publicProfileUrl": h.publicProfileUrl,
                    "title": h.title || h.headline,
                    "companyName": h.companyName,
                    "mainAddress": LinkedInData.location[h.location.name || ""] || h.location.name || h.mainAddress,
                    "industry": LinkedInData.industry[h.industry]
                });
            }
            else {
...
bindLinkedInAccount.saveLinkedInProfile = function (b, a, d) {
    ...
    _oTop.QMAjax.send("/cgi-bin/bind", {
        method: "POST", content: c, onload: function (e) {
            d && d(e);
        }
    });
};
...
bindLinkedInAccount.operateLinkedInSignature = function (a, b, c, g) {
    ...
    e.QMAjax.send("/cgi-bin/setting1", {
        method: "POST", content: f, onload: function (h, i) {
            g && g(h);
        }
    });
};
...
function securityTip() {
    ...
    addEvent(a, 'mouseover', function () {
        ...
        _oConfig = {
            ...
            tipid: b,
            domid: 'securityTip',
            click_id: 'security_center',
            msg: '<span id="securityTipTxt" style="color:#000;">\u5E10\u53F7\u5C1A\u672A\u8BBE\u7F6E\u5BC6\u4FDD\uFF0C\u5FD8\u8BB0\u5BC6\u7801\u6216\u88AB\u76D7\u540E\u5C06\u65E0\u6CD5\u53D6\u56DE\u3002<br/>\u5EFA\u8BAE\u4F60\u5C3D\u5FEB\u524D\u5F80\u5B89\u5168\u4E2D\u5FC3\u7533\u8BF7\u5BC6\u4FDD\u3002</span>',
            operation: '<a id="security_center" href="http://aq.qq.com/cn2/manage/my_mb?source_id=3004" onClick="' + "getTop().LogKV({sValue : 'getinvestigate|frame_html|logotips|security_center'}); return true;" + '"' + ' style="color:#3D5E86" target="_blank">\u73B0\u5728\u53BB\u7533\u8BF7</a>',
            closetemporary: '<span style="color:#3D5E86">\u5173\u95ED</span>',
            bForceShow: true,
            height_offset: 5,
            tip_offset: -40
        };
...
function initSpreadSetAliasEmail() {
    ...
    function d(e) {
        _oConfig = {
            ...
            tipid: a,
            domid: 'setAliasTip',
            click_id: 'setAlias_center',
            msg: '<span id="setAliasTipTxt" style="color:#000;">\u63A8\u8350\u8BBE\u7F6EQQ\u90AE\u7BB1\u82F1\u6587\u5E10\u53F7\uFF0C\u4E0D\u4EC5\u4FDD\u62A4QQ\u53F7\u7801\u5B89\u5168\uFF0C</br>\u66F4\u9002\u5408\u7528\u4E8E\u53D1\u9001\u6B63\u5F0F\u90AE\u4EF6\u3002</span>',
            operation: '<a id="setAlias_center" href="/cgi-bin/setting4?fun=list&acc=1&sid=' + getSid() + '&kvclick=today_topright|navigate|setalias|inset#div_defaultemail" onClick="' + "getTop().LogKV({sValue : 'frame_html|navigate|setalias|kvclick'}); return true;" + '"' + ' style="color:#3D5E86" target="mainFrame">\u73B0\u5728\u53BB\u8BBE\u7F6E</a>',
            closetemporary: '<span style="color:#3D5E86">\u5173\u95ED</span>',
            bForceShow: true,
            height_offset: 5,
            tip_offset: -40
...
function initComposeNewFuncTips() {
    var e = getTop(), d = {
        tipId: 95,
        dom: S("moreupload", getMainWin()),
        tipsDomId: "moreupload",
        localItem: "hasShowScanUploadTip",
        desc: "\u7528\u624B\u673A\u626B\u63CF\u4E0A\u4F20\u7EB8\u8D28\u6587\u6863\uFF0C\u5373\u53EF\u6DFB\u52A0\u5230\u9644\u4EF6\u3002"
    }, b = {
        tipId: 96,
        dom: S("span_online_doc", getMainWin()),
        tipsDomId: "span_online_doc",
        localItem: "hasShowOnlineDocTip",
        desc: "\u6DFB\u52A0\u5728\u7EBF\u6587\u6863\uFF0C\u9080\u8BF7\u597D\u53CB\u4E00\u8D77\u5728\u7EBF\u7F16\u8F91\u3002"
    }, a, c;
    ...
    function f(g) {
        _oConfig = {
            ...
            tipid: a.tipId,
            domid: a.tipsDomId,
            click_id: 'tips_center',
            arrow_direction: "down",
            msg: '<span id="setAliasTipTxt" style="color:#000;">' + a.desc + '</span>',
            closetemporary: '<span style="color:#3D5E86">\u5173\u95ED</span>',
            bForceShow: true,
            height_offset: -1,
            tip_offset: -40
...
function _getCookieMutiName() {
    var a = arguments.callee;
    return (a._oCookieMutiName || (a._oCookieMutiName = {
        "sid": 1,
        "username": 1,
        "foxacc": 1,
        "m3gmsid": 1,
...
Scale = (function () {
    var c = 1, b = 1.10, a = 1.25, l = c, m = l, k = 650, r = "normal", q = "", e = true, p = null, o = null, n = null,
        i = function (t, s) {
            if (s > 1.0) {
                if (s == 1.10) {
            ...
            var s = p.clientHeight, t = p.clientWidth,
                u = S("qqbrowser_pop", getTop()) ? S("qqbrowser_pop", getTop()).offsetHeight : 0;
            m = l;
            if (t < 1060 && m > c) {
                m = c;
            }
            ...
            if (gnIEDocTypeVer && gnIEDocTypeVer < 8 && gnIEVer < 9) {
                debug('ie6 resize');
                var z = S("mainFrame"), x = S("folder"), y = S("leftPanel"), w = finds(".bodybgbt", window)[0],
                    v = getTop().document.body.offsetHeight;
                if (z) {
...
function getReaderDataInterval(b, a) {
    if (window != getTop()) {
        ...
        var d = arguments.callee,
            e = (window.gsRssDomain || '') + "/cgi-bin/reader_data2?sid=" + getSid() + "&t=rss_data.js";
        if (d.nTimer) {
...
function initSendTimeInput(a, c, b) {
    ...
    n.document.write(getTop().T(['<textarea style="display:none;" name="sendtimetip" disabled>', '\u53D1\u4FE1\u65F6\u95F4\u5DF2\u8BBE\u5728<b class="grn">%nick%</b>\u597D\u53CB\u751F\u65E5\uFF0C\u60A8\u53EF\u4EE5\u81EA\u884C\u4FEE\u6539\uFF1A', '</textarea>', '<input type="hidden" name="sendtimeyear" value="%year%" />', '<input type="hidden" name="sendtimemonth" value="%month%" />', '<input type="hidden" name="sendtimeday" value="%day%" />', '<input type="hidden" name="sendtimehour" value="0" />', '<input type="hidden" name="sendtimemin" value="0" />'], "%").replace({
        nick: getTop().htmlEncode(c),
        year: g,
        month: h[0],
        day: h[1]
    }));
...
function audioPlay(a) {
    ...
    waitFor(function () {
        ...
        if (c) {
            ...
            if (a.global) {
                var e = QMPlayer.initKernel({sId: g, oContainer: d()}),
                    f = QMPlayer.initSkin({sId: g, sSkin: "Global", oContainer: a.globalcontainer});
                b.QMPlayer.init({oSkin: f, oKernel: e});
            }
            b.QMPlayer.delUIById(h);
            b.QMPlayer.init({
                oSkin: QMPlayer.initSkin({sId: h, oContainer: a.container, sSkin: a.skin || "Mini"}),
                oKernel: a.global ? e.setInfo(a) : QMPlayer.initKernel({sId: h, oContainer: a.container, oInfo: a})
            });
        }
        else if (a.container) {
...
function searchMusic(c, b, a) {
    ...
    var d = function (g) {
        if (g.indexOf("qqmusic.qq.com") == -1) {
            ...
            if (g.indexOf(".wma") != -1) {
                var m = "stream", r = g.substring(g.indexOf(m) + m.length), q = r.substring(0, r.indexOf(".")),
                    l = g.substring(0, g.indexOf(".")), n = g.substring(g.indexOf(".")), j = n.split("/"), k = j[0],
                    o = j[1], i = parseInt(q) + 10;
    ...
    e.fCallBack = function (g) {
        ...
        for (var q = 0, h = m.length; q < h; q++) {
            var l = {
                song: m[q].songname.replace(/<\/?strong>/gi, "").replace(/&lt;\/?strong&gt;/gi, ""),
                singer: m[q].singername.replace(/<\/?strong>/gi, "").replace(/&lt;\/?strong&gt;/gi, "")
            }, o = htmlDecode(m[q].songurl).replace(/\|/g, "").split(";");
    ...
    e._oDataDomObj = createBlankIframe(getTop(), {
        id: "getMusicUrlFromSoSo",
        style: "display:none;",
        virtual: false,
        header: T(['<meta http-equiv="Content-Type" content="text/html; charset=gb2312"/>', '<script>', 'function searchJsonCallback(a)', '{', 'window.gMusicInfo = a;', '}', '<\/script>', '<script src="$domain$/fcgi-bin/fcg_search_xmldata.q?w=$song$%20$singer$&source=3&r=$rand$&ie=utf-8"><\/script>']).replace({
            domain: (location.protocol == "https:" ? 'https://qqshow.mail.qq.com' : 'http://cgi.music.soso.com'),
            song: encodeURIComponent(c),
            singer: encodeURIComponent(b),
            rand: Math.random()
        }),
        destroy: true,
        onload: function (g) {
...
function showTwoDCodeImgMenu(b, a, d, c) {
    var k = this, i = b.document, j = calcPos(a), h = j[2] - 40, f = 0, g = bodyScroll(i, "scrollTop"),
        e = bodyScroll(i, "clientHeight");
    if ((f = h + 320 - g - e) > 0) {
        h -= (f + 10);
    }
    new QMMenu({
        ...
        oItems: [{
            ...
            sStyle: "padding:0;",
            nHeight: "auto",
            sItemValue: T(['<div style="width:300px;height:310px;padding-top:10px;">', '<div style="text-align:center;">', '<img id="twodcode" style="width:250px;height:250px;" src="$src$"/>', '</div>', '<div style="margin-top:-5px;">', '<p style="margin:0;text-align:center;padding:5px 0;">\u626B\u63CF\u4E8C\u7EF4\u7801\uFF0C\u5C06\u9644\u4EF6\u4E0B\u8F7D\u5230\u624B\u673A\u3002</p>', '<p style="margin:0;text-align:center;padding:5px 0;">\uFF08\u4E8C\u7EF4\u7801\u6709\u6548\u671F\u4E3A5\u5206\u949F\uFF09</p>', '</div>', '</div>']).replace({
                filename: d,
                src: twoDCodeImgUrl(c)
            })
        }]
    });
}
...
function endStatTime(b, a) {
    ...
    if (!isNaN(e) && !isNaN(c)) {
        addEvent(b, "load", function () {
            var f = now();
            ossLog("delay", "sample", T(['stat=cgipagespeed&type=$type$&t1=$t1$&t2=$t2$&t3=$t3$', '&rcgi=$appname$&rt=$t$&rs=$s$&allt=$allt$&flowid=$wm_flowid$&folderid=$folderid$&mailid=$mailid$']).replace(extend(a, {
                t1: e - c,
                t2: d - e,
                t3: f - d,
                allt: [c, e, d, f].join("|")
...
ossLog._ossLog = function (a, c, b) {
    var f = this, h = a || "realtime", g = f._pasteLog(b), e = f._oLogList || (f._oLogList = []),
        d = typeof c == "number" ? c : {all: 1}[c || "all"] || 0.1;
    if (h == "realtime") {
...
ossLog._doReport = function (a) {
    ...
    if (a || d.length > 0) {
        var f = getTop(), g = osslogDomain(), c = S("osslog_iframe", f), b = function (h) {
            QMAjax.send(g + "/cgi-bin/getinvestigate", {
                method: "POST",
                timeout: 500,
                content: T('sid=$sid$&$rl$&$ls$').replace({sid: getSid(), rl: a, ls: d.join("&")})
            }, h && new QMAjax(null, null, 0, h.contentWindow.xmlHttp()));
        };
        if (c || !g) {
            waitFor(function () {
            ...
            createIframe(f, g + "/zh_CN/htmledition/ajax_proxy.html?mail.qq.com&v=130132", {
                id: "osslog_iframe", onload: function () {
                    try {
                        b(this);
                    }
                    finally {
...
var AD = {
    _msTimeout: "", _ADLocs: [], _oADData: {}, init: function (a) {
        var b = this;
        a["AD_callback"] = function (c) {
            if (b._msTimeout != "timeout") {
                ...
                for (var m = 0; m < c.length; m++) {
                    var f = c && c[m] && c[m][0];
                    try {
                        var k = f.loc, d = f.oid, h = f.fodder, n = {loc: k, oid: d, hit: 0},
                            g = T("stat=log_ad_show&loc=$loc$&oid=$oid$&hit=$hit$&resource_url=$resource_url$&link_to=$link_to$&loc=ad_today,$loc$,$oid$,$hit$");
                        if (h[0] && k && !(d == "1" || d == "100")) {
                            var j = h[0].link_to;
                            if (location.protocol == "https:") {
                                h[0].link_to = j.replace(/^http:\/\//, "https://");
                            }
                            b._oADData[k] = extend(h[0], {
                                cid: f.cid,
                                loc: f.loc,
                                oid: f.oid,
                            ...
                            n = extend(n, {
                                hit: 1,
                                link_to: encodeURIComponent(h[0].link_to),
                                resource_url: encodeURIComponent(h[0].resource_url)
                            });
        ...
        var f = a || getTop().getMainWin(), b = S("qm_con_body", f), c = S("qqmail_readmail_AD_container", f),
            d = S("mainbody", f), e = S("plp_ad_container", f);
        rdVer("BaseVer", 1);
        if (e) {
        ...
        var e = strReplace(a, "http://", ""), d = e.indexOf("/"), b = e.substr(0, d),
            c = "https://stockweb.mail.qq.com";
        ...
        try {
            var m = this, l = this._getADDomByloc(c, d), n = d + "_showed", h = location.protocol == "https:",
                o = T("//p.l.qq.com/p?oid=$oid$&cid=$cid$&loc=$loc$"), g = attr(l, "bgimg") == "1" ? true : false,
                f = attr(l, "closebtn") == "1" ? true : false, i = attr(l, "pos");
            if (l && b.resource_url) {
                var k = l.parentNode;
                ...
                show(k, 1);
                insertHTML(k, "beforeEnd", _sADHtml.replace(extend(b, {
                    id: n,
                    loc: d,
        ...
        var e = [], h = "", g = this, d = location.protocol == "https:",
            f = d ? T("https://stockweb.mail.qq.com/lview?c=www&loc=$loc$&callback=AD_callback&rot=1&pdomain=l.qq.com") : T("http://l.qq.com/lview?c=www&loc=$loc$&callback=AD_callback&rot=1");
        this._ADLocs = [];
    ...
    _moCacheMap: {}, _init: function (a) {
        var e = this, c = function () {
            ...
            if (typeof (e._mnBaseVer) != "number") {
                var j = new Date(), g = 5, i = Math.ceil(+new Date() / 100) % Math.pow(10, g), h = Math.random() + "",
                    f = function (k) {
                        var l = k + "";
                        if (l.length < g) {
...
function LogPageSpeed(a) {
    ...
    setTimeout(function () {
        var c = window.webkitPerformance || window.performance, d = c && c.timing,
            f = ["navigationStart", "unloadEventStart", "unloadEventEnd", "redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"];
        if (d) {
            var b = [], e = d[f[0]], g;
            if (e < 1349020800000) {
...
function speedLog(b, a, c) {
    ...
    setTimeout(function () {
        (new Image(1, 1)).src = T([window.location.protocol, "//rl.mail.qq.com/cgi-bin/speed_report?stat=$stat$&$data$&r=$r$"]).replace({
            stat: c || 'comm',
            data: d,
            r: Math.random()
        });
...
function getFtnPreviewData(d, c, a, b) {
    var i = getTop();
    var f = d.toJSON(), h = {}, j = f.sName, l = j.split(".").pop().toLowerCase(), e = f.nFileTransCode == "1",
        m = e ? "mp4" : l, k = i.getViewTypeByExt(f.sStatus == "complete" ? m : "") || "other", g = {
            sid: i.getSid(),
            fid: encodeURIComponent(f.sFileId),
            code: f.sFetchCode,
            filename: f.sName,
            suffix: m,
            type: k,
    ...
    a && i.ossLog("delay", "all", i.T("stat=nothing&loc=ftnview,$sType$,0,$sTrans$").replace({
        sType: k,
        sTrans: f.nFileTransCode
    }));
...
var getPreviewView = (function () {
    ...
    return function (c, d) {
        var h = c.get('sName'), e = b.getFileExt(h), f = b.getFileTypeByExt(e || ""), j = b.getViewTypeByExt(e),
            g = c.get("mailid") ? [c.get("mailid"), c.get("attachid"), c.get("attachname")].join("|") : '';
        var i = b.T(['/cgi-bin/$appname$?sid=$sid$&upfilelistitem=$upfileid$&mailattach=$mailattach$', '&filename=$filename$&filetype=$filetype$&t=$t$&readprev=$compose$&filepath=$filepath$', '&action=$action$$viewdocparam$&viewtype=$viewtype$&r=$rand$&sc=false&nf=$nf$']).replace({
            sid: b.getSid(),
            rand: Math.random(),
            appname: {
                "txt": "readtemplate",
            ...
            action: j == "compress" ? "list" : (a(e) ? "view" : ""),
            compose: "normal",
            t: d || 'attachments_simple',
            upfileid: c.get("sFileId"),
            filename: b.encodeURI(h),
            filetype: f,
            filepath: (c.get("sFilePath")) || "",
            mailattach: g,
            viewdocparam: j == "doc" ? "&s=yozo&fromattach=1&from=attachfolder" : "",
            viewtype: e == "eml" ? "eml" : "",
            nf: c.get('sNf') || ''
        });
        return i;
...
var getOfficeRealContent = (function () {
    ...
    function dealPPT(_asContent, _aoCfg) {
        ...
        _oTop.QMAjax.send(_oIframeSrc.outline, {
            onload: function (_abOK, _asData) {
                if (_abOK && _asData && ('' + _asData).indexOf('<!--cgi exception-->') !== 0) {
                    var _oTempElem = createTempNode(_asData);
                    var _oNames = [];
    ...
    function loadIframes(_aoUrls, _aoNames, _aoLoadIframeCfg, _afCallback) {
        ...
        _oTop.E(_aoUrls, function (_asUrl, _anIndex) {
            loadIframe(_asUrl, _oTop.extend(getLoadIframeBodyCfg(), _aoLoadIframeCfg || {}, {
                isEnd: function () {
                    ...
                    if (_abOK) {
                        ...
                        if (--_nWaitLoadNum == 0) {
                            ...
                            _oTop.E(_oContent, function (_asContent, _anIndex) {
                                if (_asContent) {
                                    _oRealCcontent.push(_oTmp.replace({
                                        name: _oTop.htmlEncode(_aoNames[_anIndex] || ''),
                                        content: _asContent
                                    }));
                                }
                            });
...
var _oTop = getTop();
var _oOidbAccountBase = {
    enterPress: function (a, b) {
    ...
    checkPopInput: function () {
        var c = getTop(), b = this, d = b._oDialog.S("div_username"), a = b._oDialog.S("ipt_pwd"),
            f = (d.innerHTML || ""), e = (a.value || "");
        if (c.trim(e) == "") {
            b.showWarn("\u60A8\u8FD8\u6CA1\u6709\u8F93\u5165\u5BC6\u7801\uFF01");
    ...
    encrypt: function (a) {
        var d = "",
            b = new RSAKey();
        b.setPublic(d, "10001");
...
function toAddAccountPage() {
    ...
    a._oDialog = new b.QMDialog({
        ...
        sTitle: "\u6DFB\u52A0\u90AE\u7BB1\u5E10\u53F7",
        nWidth: 440,
        sBodyHtml: a._oTmpl.replace({"step": "1"}),
        bAnimation: false,
        onshow: function () {
            var c = this;
...
getTop().extend(toAddAccountPage, _oOidbAccountBase, {
    ...
    getDefaultCfg: function () {
        ...
        if (!a._oDefaultCfg) {
            a._oDefaultCfg = {
                "topHost": _oTop.getTopHost(),
                "sid": _oTop.getSid(),
                "topProtocol": _oTop.location.protocol,
                "ver": a.getCssVer(),
                "loginDesc": encodeURIComponent('\u9A8C\u8BC1'),
                "ptfun": "addother",
                "cssFilename": "addAccountPtlogin"
            };
        }
    ...
    ptlogin2OnResize: function (a) {
        return function (j, h) {
            var d = a.S("importFrame"), c = a._moPanelDom, f = a.S("div_stepPassword"), g = a.S("div_username"),
                b = a.S("geCancelBtn"), e = a.S("btlogin");
            if (d) {
                d.style.height = h + 'px';
    ...
    showQQPwdItem: function (a) {
        ...
        b.setHtml("_body_", c._oTmpl.replace({
            "step": a.step,
            "username": a.username,
            "uInfo": "qq",
            "ptloginurl": c.getPtloginUrl({"uin": a.username})
        }));
    ...
    doAddQQAction: function (a) {
        ...
        c.QMAjax.send("/cgi-bin/foldermgr", {
            content: c.T(["sid=#sid#&enter=new&fun=createpop&folderid=&acctid=0&taskid=&step=", "&fromtips=&popfolder=#popmail#&popnickname=#popnickname#&popmail=#popmail#&addstep=2&ptfun=addother&poppwd=", "&popsvr=&popport=&timeflag=1&delflag=0&isenddef=1&needspam=1&smtpneedpwd=0&showsmtppanel=0", "&agentsend=0&smtpsvr=&smtpport=25&nosmtppwd=#nosmtppwd#&smtppwd=&t=mailpotl.json&secpwd=#secpwd#"], "#").replace({
                sid: c.getSid(),
                popmail: a.sLoginaccount,
                popnickname: encodeURIComponent((c.S("useralias") && c.S("useralias").innerHTML) || ""),
                nosmtppwd: encodeURIComponent("\u6CBF\u7528\u90AE\u7BB1\u5BC6\u7801"),
                secpwd: a.secpwd
            }), method: "POST", onload: function (d, f) {
                if (d) {
                    var g = c.evalValue(f);
                    try {
                        if (g.succ == "0") {
    ...
    doAction: function (b, a) {
        ...
        if (this.checkPopInput()) {
            var d = {
                _sTaskid: b || "",
                _sPopmail: e._oDialog.S("div_username").innerHTML || "",
                _sPoppwd: e._oDialog.S("ipt_pwd").value || "",
                _sPopsvr: e._oDialog.S("ipt_popserver").value || "",
                _sPopport: e._oDialog.S("ipt_port").value || 110,
                _nIspopssl: e._oDialog.S("ckb_ssl").checked && 1 || 0
            };
    ...
    doRealAction: function (b, c) {
        ...
        var g = T('poppwd=$poppwd$&ispopssl=$ispopssl$').replace({
            poppwd: encodeURIComponent(e.encrypt(b._sPoppwd)),
            ispopssl: encodeURIComponent(b._nIspopssl)
        });
        if (c) {
            var a = [];
            for (var h in c) {
        ...
        f.QMAjax.send(f.T("/cgi-bin/foldermgr?sid=#sid#&enter=new&fun=createpop&folderid=&acctid=0&step=&fromtips=&popmail=#popmail#&popfolder=#popmail#&popnickname=&popsvr=#popsvr#&popport=#popport#&timeflag=1&delflag=&isenddef=1&needspam=1&smtpneedpwd=0&showsmtppanel=0&agentsend=&smtpsvr=&smtpport=25&nosmtppwd=&smtppwd=&taskid=#taskid#&t=mailpotl.json", "#").replace({
            sid: f.getSid(),
            popmail: encodeURIComponent(b._sPopmail),
            popsvr: encodeURIComponent(b._sPopsvr),
            popport: encodeURIComponent(b._sPopport),
            taskid: b._sTaskid || ""
        }), {
            content: g, method: "POST", onload: function (i, j) {
                if (i) {
                    var k = f.evalValue(j);
                    try {
                        if (k.waiting == "true") {
    ...
    doGoogleOauth: function (a, C) {
        var u = getTop(), t = this, z = a._sPopmail, B = a._sPoppwd, q = t._oDialog.S("ipt_pwd"),
            h = t._oDialog.S("geConfirmBtn");
        ...
        var k = t._oDialog.S("div_verifycode"), v = t._oDialog.S("verifyImage"), n = t._oDialog.S("loginData"),
            m = t._oDialog.S("loginCookies"), o = t._oDialog.S("loginVerify");
        var j = t._oDialog.S("div_challenge"), g = t._oDialog.S("challengeData"), f = t._oDialog.S("challengeCookies"),
            e = t._oDialog.S("challengeAction"), r = t._oDialog.S("secondPin"), p = t._oDialog.S("phoneNumber"),
            c = t._oDialog.S("androidTablet"), w = t._oDialog.S("verifySmsChallengeAnswer"),
            l = t._oDialog.S("emailAnswer"), i = t._oDialog.S("deviceAddress"), s = t._oDialog.S("secretAnswer"),
            d = t._oDialog.S("challengeTip");
        var H = function (J, K) {
        ...
        if (k.style.display != "none") {
            ...
            u.QMAjax.send("/cgi-bin/googleoauth/verifyLogin", {
                content: D, method: "POST", onload: function (J, K) {
                    var L = u.evalValue(K);
                    if (J) {
            ...
            u.QMAjax.send("/cgi-bin/googleoauth/challenge", {
                content: D, method: "POST", onload: function (J, K) {
                    var L = u.evalValue(K);
                    if (J) {
                        if (!L.errCode && L["access_token"]) {
            ...
            u.showInfo("\u6B63\u5728\u9A8C\u8BC1\u5176\u4ED6\u90AE\u7BB1\u5E10\u53F7...");
            u.QMAjax.send("/cgi-bin/googleoauth", {
                content: D, method: "POST", onload: function (J, K) {
                    var L = u.evalValue(K);
                    if (J) {
                        if (!L.errCode && L["access_token"]) {
...
function toBindAccountPage() {
    ...
    a._oDialog = new b.QMDialog({
        ...
        sTitle: "\u5173\u8054\u5DF2\u6709\u90AE\u7BB1",
        nWidth: 440,
        sBodyHtml: a._oTmpl.replace({"step": "1", "ptloginurl": c}),
        bAnimation: false,
        onload: function () {
            var d = this;
...
getTop().extend(toBindAccountPage, _oOidbAccountBase, {
    ...
    getDefaultCfg: function () {
        ...
        if (!a._oDefaultCfg) {
            a._oDefaultCfg = {
                ...
                "topProtocol": _oTop.location.protocol,
                "ver": a.getCssVer(),
                "loginDesc": encodeURIComponent('\u786E\u8BA4\u5173\u8054'),
                "cssFilename": "qui_dialogPtlogin"
            };
        }
        return a._oDefaultCfg;
    },
    ...
    doBindQQAction: function (a) {
        ...
        _oTop.QMAjax.send(_oTop.T(["/cgi-bin/bind?sid=$sid$&fromzc=&fun=bind&mailaddr=$mailaddr$&fromzc=&t=mailpotl.json", "&uin=$uin$&aliastype=$aliastype$&verifycode="]).replace({
            "sid": a.sid,
            "mailaddr": a.sLoginaccount,
            "uin": a.uin,
            "aliastype": a.sAliasType
        }), {
            content: "", method: "POST", onload: function (c, d) {
                if (c) {
    ...
    complete: function (a) {
        ...
        if (a.succ === "0") {
            ...
            d.insertHTML(b, "beforeEnd", c._oTmpl.replace({
                "step": "3",
                "username": a.account,
                "uin": a.uin,
                "sid": d.getSid(),
...
function toAuthorizeWeiyun() {
    ...
    b.loadCssFile("$css_path$login/addAccount327bfb.css", true, b.document);
    a._oDialog = new b.QMDialog({
        sId: "id_AuthorizeWeiyun",
        sTitle: "\u6388\u6743\u5FAE\u4E91",
        nWidth: 440,
        sBodyHtml: a._oTmpl.replace({"username": b.getUin(), "ptloginurl": a.getPtloginUrl({"uin": b.getUin()})}),
        bAnimation: false,
        onshow: function () {
            var c = this;
    ...
    getDefaultCfg: function () {
        ...
        if (!a._oDefaultCfg) {
            a._oDefaultCfg = {
                ...
                "topProtocol": _oTop.location.protocol,
                "ver": a.getCssVer(),
                "loginDesc": encodeURIComponent('\u6388\u6743'),
                "ptfun": "addother",
                "cssFilename": "addAccountPtlogin"
            };
        }
