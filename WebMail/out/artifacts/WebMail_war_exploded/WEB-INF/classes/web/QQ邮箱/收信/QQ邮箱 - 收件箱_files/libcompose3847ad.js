(function (_aoWin, _aoUndefined) {
    ...
    _oComposeLib.getAttachList = function (_aoList, _afCallback, _aoContainer) {
        ...
        function _err() {
            ...
            var _oDoc = _aoContainer.ownerDocument, _oDom = _oDoc.createElement("div"),
                _oMsg = _oDoc.createElement("span"), _oLink = _oDoc.createElement("a");
    ...
    _oComposeLib.getFormData = function (_aoForm) {
        var _oRegTextArea = /^(?:select|textarea)/i,
            _oRegInput = /^(?:color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,
            _oRegRadioCheck = /^(?:radio|checkbox)$/i, _oFormDatas = _aoForm.elements, _oResult = {};
    ...
    function _createForm(_aoConfig, _aoInputData) {
        var _sFormId = _aoConfig.sFormId || unikey(), _oForm = S(_sFormId, _aoConfig.oWin), _oInputs = [],
            _FORM_TMP = TE(['<form method="$sMethod$" id="$sFormId$" name="$sFormId$" target="$sTarget$" action="$sAction$" enctype="multipart/form-data">', '$@$for($oInputs$)$@$', '<input name="$name$" type="hidden" value="$@$html($value$)$@$"/>', '$@$endfor$@$', '</form>']);
        if (_oForm) {
            removeSelf(_oForm);
        }
    ...
    function _splashToCtrl(_avObj, _anTimes) {
        var _oCtrlObj = _avObj.style ? _avObj : getTop().S(_avObj, window), _nTimes = 0,
    ...
    var _CPS_DLG_CFG = {
            normal: {sTitle: "\u53D1\u90AE\u4EF6", nHeight: "auto", nWidth: "auto"},
            sms: {sTitle: "\u53D1\u77ED\u6D88\u606F", nHeight: "auto", nWidth: "auto"},
            note: {sTitle: "\u5FEB\u6377\u5199\u8BB0\u4E8B", nHeight: "auto", nWidth: "auto"},
            group: {sTitle: "QQ\u7FA4\u90AE\u4EF6", nHeight: "auto", nWidth: "auto"},
            card: {sTitle: "\u53D1\u8D3A\u5361", nHeight: "auto", nWidth: "auto"},
            postcard: {sTitle: "\u53D1\u660E\u4FE1\u7247", nHeight: "auto", nWidth: "auto"}
        }, _CPS_SEND_CFG = {
            normal: {
                sSendingDesc: "\u90AE\u4EF6\u6B63\u5728\u53D1\u9001\u4E2D...",
                sFailDesc: "\u90AE\u4EF6\u53D1\u9001\u5931\u8D25",
                sSuccessDesc: "\u53D1\u9001\u6210\u529F",
                sCgiPath: "/cgi-bin/compose_send"
            },
            sms: {
                sSendingDesc: "\u6B63\u5728\u53D1\u9001\u77ED\u6D88\u606F...",
                sFailDesc: "\u77ED\u6D88\u606F\u53D1\u9001\u5931\u8D25",
                sSuccessDesc: "\u77ED\u6D88\u606F\u5DF2\u6210\u529F\u53D1\u9001\u3002<br><a href='javascript:;' id='goSmsLink'>\u70B9\u51FB\u8FD9\u91CC\u67E5\u770B</a>",
                sCgiPath: "/cgi-bin/compose_send"
            },
            group: {
                sSendingDesc: "\u90AE\u4EF6\u6B63\u5728\u53D1\u9001\u4E2D...",
            ...
            card: {
                sSendingDesc: "\u8D3A\u5361\u6B63\u5728\u53D1\u9001\u4E2D...",
                sFailDesc: "\u8D3A\u5361\u53D1\u9001\u5931\u8D25",
                sSuccessDesc: "\u53D1\u9001\u6210\u529F",
                sCgiPath: "/cgi-bin/compose_send"
            },
            postcard: {
                sSendingDesc: "\u660E\u4FE1\u7247\u6B63\u5728\u53D1\u9001\u4E2D...",
                sFailDesc: "\u660E\u4FE1\u7247\u53D1\u9001\u5931\u8D25",
                sSuccessDesc: "\u53D1\u9001\u6210\u529F",
                sCgiPath: "/cgi-bin/compose_send"
            }
            ...
            sms: {t: "sms_mgr.json", s: "send", subject: "\u77ED\u6D88\u606F", savesendbox: "1", mailtype: "5", smstype: 1},
            note: {t: "compose.json", catid: "0", actiontype: "send"},
            group: {t: "compose.json"},
            card: {actiontype: "send", separatedcopy: "false", selfdefinestation: "-1", savesendbox: "1", domaincheck: "0"},
            postcard: {
                actiontype: "send",
                separatedcopy: "false",
                selfdefinestation: "-1",
            ...
            _TO: "\u8BF7\u586B\u5199\u6536\u4EF6\u4EBA\u540E\u518D\u53D1\u9001",
            _SUBJECT: ['<div class="dialog_f_t">\u60A8\u7684\u90AE\u4EF6\u6CA1\u6709\u586B\u5199\u4E3B\u9898\u3002</div>', '<div class="dialog_f_d" style="font-size:14px;">\u60A8\u786E\u5B9A\u7EE7\u7EED\u53D1\u9001\uFF1F</div>'].join(""),
            _GROUP_LIST: "\u52A0\u8F7DQQ\u7FA4\u5931\u8D25\uFF0C\u8BF7\u7A0D\u5019\u91CD\u8BD5",
            _GRP_TO: "\u8BF7\u9009\u62E9\u4E00\u4E2AQQ\u7FA4",
            _NO_GROUP: "\u52A0\u8F7DQQ\u7FA4\u5931\u8D25\uFF0C\u8BF7\u7A0D\u5019\u91CD\u8BD5"
        }, _ATT_LIST_URL = T("/cgi-bin/readmail?sid=$sid$&t=$t$&s=forward&from=attachfolder&disptype=html"),
        ...
        _SMS_LIST_URL = T("/cgi-bin/readtemplate?sid=$sid$&t=sms_list_v2#$hash$"),
        _TMPL_UI = T(['<span over="\u5DF2\u8D85\u51FA " default="\u8FD8\u53EF\u4EE5\u8F93\u5165 "></span><span style="font-family:Georgia;font-size:14px;font-weight:bold;"></span> \u5B57']);
    ...
    var _QMBaseCps = inherit("_QMBaseCps", Object, function (_aoSuper) {
        return {
            $_constructor_: function (_aoConfig) {
                ...
                var _oSelf = this;
                new QMDialog({
                    sId: _aoConfig.sType + "ComposeDlg",
                    sTitle: _aoConfig.sTitle,
                    nWidth: _aoConfig.nWidth,
                    nHeight: _aoConfig.nHeight,
                    sBodyHtml: _oSelf._getBodyHtml(),
                    onload: function () {
                ...
                var _oSelf = this;
                (_oSelf._moEditor = QMEditor.createEditor({
                    editorId: "ComposeDlg",
                    editorAreaWin: _oSelf._getBoxWin(),
                    editorAreaObj: _oSelf._S("QMEditorArea"),
                ...
                var _oSelf = this, _oConfig = _oSelf._moConfig, _oAttachs = _oConfig.oMailAttach || [],
                    _oEditor = _oSelf._moEditor, _sValue = _oEditor ? _oEditor.getContent() : "", _oTop = getTop(),
                    _oWin = _oSelf._moWin, _sUrl;
                if (_oConfig.oOnlineDocAttachs && _oConfig.oOnlineDocAttachs.length > 0) {
                    ...
                    _sUrl = (_oConfig.oMailAttach ? _ATT_LIST_URL : _NOR_LIST_URL).replace({
                        sid: getSid(),
                        t: "compose",
                        s: "forward",
                        from: "attachfolder",
                ...
                _createForm({
                    ...
                    initsubject: _oSelf._S("subject").value,
                    initaddress: _oSelf._moAddrInput.get().join(";"),
                    pluscontent: _sValue
                }).submit();
                ...
                if (_oConfig.bAddrEdit) {
                    ...
                    _oSelf._moAddrInput = _oAddrInput = new QMAddrInput({
                        id: "to",
                        win: _oSelf._getBoxWin(),
                        dom: {container: _oSelf._S("toAddrArea")},
                        tabIndex: 1,
                        dispMode: "onlynick",
                        isEnableTip: false,
                        maxItemView: 10,
                        onchange: function (_asType) {
                            var _oTop = getTop(), _oDlg = _oSelf._moCpsBox, _oInput = _oSelf._moAddrInput,
                                _oAddrUC = _oDlg.S("addrUrlCreator"), _bHasUC = _oInput.hasAddr(_sUrlCreator),
                                _bUCShow = _oTop.isShow(_oAddrUC), _oAddrQZ = _oDlg.S("addrQzone"),
                                _bHasQZ = _oInput.hasAddr(_sQzone), _bQZShow = _oTop.isShow(_oAddrQZ), _bToAdd = false,
                                _bToDel = false, _oDomAddrAdd, _oDomAddrDel, _sAddr;
                            if (_bHasUC && !_bUCShow) {
                                _bToAdd = true;
                                _sAddr = _sUrlCreator;
                ...
                var _oSelf = this;
                extend(_oSelf._moCpsConfig, _oSelf._cpsLoc(), {
                    onready: function () {
                ...
                var _oSelf = this, _oConfig = _oSelf._moConfig;
                return _oSelf.constructor._TEMPLATE._DLG.replace({
                    addredit: _oConfig.bAddrEdit,
                    addrs: QMAddrParser.parseAddr(_oConfig.sDefAddrs),
                    sCopy2shareUrl: _oConfig.sCopy2shareUrl
                });
            }, _cpsData: function () {
            }
        };
    ...
    var _QMNorCps = inherit("_QMNorCps", _QMBaseCps, function (_aoSuper) {
        return ({
            _cpsLoc: function () {
                ...
                var _oSelf = this, _oConfig = _oSelf._moConfig, _oAttachCon = _oSelf._S("attachArea"),
                    _oAttachList = _oSelf._S("attachList");
                ...
                var _oSelf = this, _oOnlineDocAttachs = _oSelf._moConfig.oOnlineDocAttachs, _oConfig = _oSelf._moConfig,
                    _oAttachCon = _oSelf._S("attachArea"), _oAttachList = _oSelf._S("attachList");
                _oAttachCon.style.display = "";
                ...
                var _oSelf = this, _oTop = getTop(), _oCopyBtn = _aoDialog.S('btn_copy2share'),
                    _oCopyTextarea = _aoDialog.S('textarea_copy'), _nTimeoutIndex;
                if (!_oCopyBtn) {
                    return;
                }
                ...
                extend(_oCpsData, {
                    ...
                    to: _oConfig.bAddrEdit ? _oSelf._moAddrInput.get().join(";") : _oConfig.sDefAddrs,
                    subject: _oSelf._S("subject").value,
                    content__html: _oSelf._moEditor.getContent()
                });
                ...
                return [function () {
                    ...
                    if (!_oSelf._subCheck("subject")) {
                        confirmBox({
                            msg: _CPS_ERR._SUBJECT, width: 430, onreturn: function (_aIsOk) {
                                if (_aIsOk) {
                                    _oSelf._checkNext();
                                }
                            }
    ...
    var _QMCardCps = inherit("_QMCardCps", _QMBaseCps, function (_aoSuper) {
        return ({
            _cpsLoc: function () {
                ...
                extend(_oCpsData, {
                    sendmailname: getUserInfoText("addr"),
                    to: _oSelf._moAddrInput.get().join(";"),
                    subject: _oSelf._S("subject").value,
                    content__html: _oSelf._moEditor.getContent()
                });
            }, _cpsSendOK: function (_avParam) {
    ...
    var _QMSmsCps = inherit("_QMSmsCps", _QMBaseCps, function (_aoSuper) {
        return ({
            _initWordCnt: function () {
                var _oSelf = this;
                _oSelf._moWordCntCtrl = new _oQMWordCntCtrl({
                    oText: _oSelf._S("content"),
                    oDisper: _oSelf._S("wordCnt")
                });
            }, _initContentEdit: function () {
                ...
                extend(_oCpsData, {
                    to: _oConfig.bAddrEdit ? _oSelf._moAddrInput.get().join(";") : _oConfig.sDefAddrs,
                    content: _oSelf._S("content").value
                });
                if (_oConfig.bUinEncrypt) {
                    _oCpsData.ue = 1;
                }
                ...
                alertBox({
                    msg: this._moCpsConfig.sSuccessDesc, onload: function () {
                        var _oDlg = this;
                        ...
                        var _oData = eval(_avParam),
                            _oItem = _oData.content && _oData.content.itms && _oData.content.itms[0] || {},
                            _sTid = _oItem.inf.tid || _oItem.inf.id, _sHash = _sTid ? ("mail," + _sTid) : "inbox";
    ...
    var _QMGrpCps = inherit("_QMGrpCps", _QMBaseCps, function (_aoSuper) {
        return ({
            _initGroupMenu: function (_aoGroupList) {
                ...
                if (_aoGroupList.oItems.length == 1) {
                    ...
                    new QMSelect({
                        oContainer: _oDomToArea,
                        nWidth: _oDomToArea.clientWidth || _oDomToArea.offsetWidth || 401,
                        oMenu: _aoGroupList,
                ...
                var _oSelf = this;
                QMAjax.send(_GRP_LIST_URL.replace({sid: getSid()}), {
                    method: "GET", onload: function (_abIsOk, _avParam) {
                        if (_abIsOk) {
    ...
    QMCgiExpt.prototype = {
        check: function (_abIsOk, _avParam) {
            var _oSelf = this;
            if (_abIsOk) {
    ...
    QMCpsSend.prototype = {
        send: function (_aoRuntimeCfg) {
            ...
            QMAjax.send(_oConfig.sCgiPath, {
                method: "POST",
                timeout: _oConfig.nTimeout || 30000,
                content: _oSelf._flat(_oRuntimeCfg.fCustomData),
                onload: function (_abIsOk, _avParam, _aoXhr) {
    ...
    _oQMWordCntCtrl.prototype = {
        check: function () {
            var _oSelf = this, _oTxtDisper = _oSelf._moTxtDisper,
                _nLeft = _oSelf._mnLimit - _oSelf._moText.value.length;
            ...
            addEvents(_oSelf._moText, {
                "keydown": _check, "keyup": _check, "paste": function () {
                    setTimeout(_check);
                }
            });
            return _oSelf;
