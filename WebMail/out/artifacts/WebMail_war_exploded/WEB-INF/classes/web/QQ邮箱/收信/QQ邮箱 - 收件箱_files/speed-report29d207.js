...
;(function () {
    ...
    g.globalHandlers = [{key: 'log', handler: g.log}, {key: 'stat', handler: g.stat}, {
        key: 'k',
        handler: g.k
    }, {key: 'u', handler: g.u}, {key: 'ku', handler: g.ku}, {key: 'speed', handler: g.speed}, {
        key: 'pageLine',
        handler: g.pageLine
    }, {key: 'pageSpeed', handler: g.pageSpeed}, {key: 'resSpeed', handler: g.resSpeed}, {
        key: 'assertTime',
        handler: h
    }];
