...
{
_oEditor.loadFile({"$js_path$/com/kits/qmeditor/base/release/plus/formatter24e6ae.js":true});
...
a.extend(QMEditor.CONST.getTemplate(),{DIALOG_FULLSCREEN:a.T(['<div style="text-align:center;padding:58px; padding-bottom:78px;">','<img src="$images_path$ico_loading21e9c5d.gif" style="position:relative; top: 12px;"> \u6B63\u5728\u5BFC\u5165\u2026 <span id="percent"></span>','</div>'])});
...
{
var o=l;
g.loadJsFileToTop(['$js_path$com/kits/qmeditor/qqmail/release/editor_toolbar_ext250c75.js']);
