...
(function (a, c) {
    ...
    b.prototype.getContentByHasMapWarpLink = function (f) {
        ...
        try {
            ...
            ;var j = i.createElement('div'), p = i.createElement('div'),
                k = q.TE(['<a href="$jump$" target="_blank" notForEdit="true" attr-hasmapwrap="1">$img$</a>']), s, l, n,
                r, m, g;
    ...
    b.prototype.setBgMusicInfo = function (g, f, h) {
        if ("txt" !== this._msEditCore) {
            var e = this._moBgMusicInfo || {}, k = e.song, j = e.singer, l = e.url,
                i = !k && !g ? h != l : (k != g || j != f);
    ...
    b.prototype.autoScaleImg = function (e, f) {
        ...
        if (l) {
            var q = f.match(/originalwidth=.*&/), o = f.match(/originalheight=.*/), p = q && q[0], n = o && o[0],
                j = p && parseInt(p.split('=')[1]), i = n && parseInt(n.split('=')[1]), g = !!j && !!i,
                k = parseInt(m._moEditorAreaObj.clientWidth * 0.8 || 960);
            if (g) {
                h(k, j, i);
        ...
        function h(t, s, r) {
            var y = s || parseInt(l.naturalWidth || l.offsetWidth),
                x = r || parseInt(l.naturalHeight || l.offsetHeight), B = l.getAttribute("modifysize"), z, A, w;
            ...
            if (B) {
                ...
                var w = parseInt(t * (x / y)), A = t, z = A / y, u = z < 0.25,
                    v = parseInt((z - (u ? 0 : 0.25)) * 60 * (u ? 1 : (100 / 175))) + (-1);
                l.style.width = A + "px";
                l.style.height = w + "px";
    ...
    b.prototype._fixHeight = function () {
        if (a.gbIsIE) {
            var i = this, h = i.getEditorArea(), e = h.clientHeight || h.offsetHeight || (+h.style.height),
                f = i.isShowToolBar() ? i._moToolBarObj.clientHeight : 0, g = e - f - 2;
    ...
    b.prototype.resizeEditor = function (f) {
        ...
        if (j && (f || !u._mbNoEditScroll || (s.scrollHeight <= l && v.style.display == "none") || (v.scrollHeight <= l && v.style.display == "block"))) {
            var t = u.getEditorArea(), q = u._moEditorAreaWin.document, r = q.documentElement, o = q.body,
                h = r.clientHeight,
                n = Math.min(o.scrollHeight, r.scrollHeight) + (a.gbIsIE && a.gnIEVer === 6 ? 10 : 0),
                k = t.clientHeight, g = h - n + k;
            g = g < j ? j : g;
    ...
    b.prototype.resizeNoScrollEditor = function (e, f) {
        var n = this, g = a.gbIsIE, h = g && a.gnIEVer === 6, m = n._moEditBody,
            j = n._mDefHeight || n._mnAutoRisizeMinHeight || (n._mDefHeight = m.clientHeight), k = m.scrollHeight;
    ...
    b.prototype._textResize = function () {
        ...
        var i = this, j = i._moTextBody, h = i._moEditorAreaObj, f = i._mDefHeight || i._mnAutoRisizeMinHeight,
            e = b.getTopWin().gbIsIE ? 10 : 0, g;
...
(function (a, b) {
    ...
    QMEditor.FUNCLIB.BASE.prototype._setup = function (c) {
        ...
        if (this._msType != "label") {
            if (typeof (this._mfOnClick) != "function") {
                var f = this,
                    d = {btn: f._doDefaultClick, checkbox: f._doDefaultClick, menu: f._doShowMenuClick}[f._msType];
    ...
    QMEditor.FUNCLIB.BASE.prototype._getUI = function () {
        var e = typeof (this._msUiType) != "string" ? (this._msUiType = "icon") : this._msUiType,
            d = this._moBindEditor._moTemplate[["BOTTON_", e.toUpperCase(), (this._msType == "custom" ? "_" + this._msId.toUpperCase() : "")].join("")] || "",
            c = {id: this._msId, ui: this._moUiConfig || {}};
        return d.replace(c);
    };
    ...
    QMEditor.FUNCLIB.MENU.prototype.showMenu = function (c, d) {
        ...
        var l = a.calcPos(d && d.oContainer || m._moContainer),
            f = !m._moBindEditor._mbNotAllowArrow && (d && d.nArrowPos || m._moUiConfig.arrowPos) || 0,
            h = f && l[3] - a.calcPos(m._moBindEditor.getEditorArea())[3],
            g = f && (h < 0 ? 1 : Math.min(l[3] - a.calcPos(m._moBindEditor.getEditorArea())[3], f - 7)),
            i = (d && d.nWidth) || this._moUiConfig.width,
            e = (m._moFuncConfig || {}).align == "right" || this._moUiConfig.align == "right",
            j = i && e ? Math.max(l[1] - i, a.calcPos(m._moBindEditor.getEditorArea())[3]) : l[3];
        if (c) {
...
(function (a, b) {
    ...
    QMEditor.EditMenu.prototype._setMouseDownEvent = function () {
        var h = this, e = h._moBindEditAreaWin, g = h._moEditMenuBar, f = h._moBindEditor,
            i = QMEditor.EditMenu._TEMPLATE;
        ...
        a.addEvent(g, "mousedown", function (j) {
            ...
            if (z) {
                ...
                switch (B) {
                    ...
                    case "modify": {
                        var v = a.S("QMEditMenuLink", e), p = a.S("QMEditMenuCommon", e),
                            w = a.S("QMEditMenuModify", e);
                        a.show(p, false);
                        a.show(w, true);
                        f.saveRange();
                        u.value = v.href;
                    ...
                    case "save": {
                        var v = a.S("QMEditMenuLink", e), p = a.S("QMEditMenuCommon", e),
                            w = a.S("QMEditMenuModify", e), A = u.value, r = h._moCurrentEditObj,
                            o = r.nodeName == "A" ? r : r.parentNode;
    ...
    QMEditor.EditMenu.prototype._checkEditMenuType = function (f, e) {
        var m = this, k = m._moBindEditor, i = null, j = null, g = true, h = 0, p = "", q = "", r = "",
            n = QMEditor.EditMenu._TEMPLATE, o = {
    ...
    QMEditor.EditMenu.prototype._adjustEditMenuPos = function (e) {
        var u = this, q = u._moBindEditor, p = u._moBindEditAreaWin, s = u._moEditMenuBar,
            t = a.calcPos(q._moEditorAreaObj), m = t[0], j = t[3], o = t[2], n = a.document.body.clientHeight,
            l = a.bodyScroll(p, "scrollTop"), i = a.bodyScroll(q._moEditWin, "scrollTop"), k, h = m, g = j,
    ...
    QMEditor.EditMenu.prototype._fView = function (f, e, g, h) {
        ...
        var p = m.getAttribute("scalingmode") || "zoom", r = {
            ...
            }[p], j = {"zoom": 200, "normal": 100}[p], k = {"zoom": 25, "normal": 1}[p], i = {"zoom": 25, "normal": 10}[p],
            l = {"zoom": 175, "normal": 100}[p], q = "";
    ...
    QMEditor.EditMenu.prototype.showEditMenu = function (e) {
        var l = this, i = l._moBindEditor, h = ("txt" === i._msEditCore ? i._moEditBody : i._moEditDoc),
            f = h.body ? h.body : h, j = l._moEditMenuBar, g = a.getEventTarget(e), n;
        if (!j) {
            return;
        }
...
(function (a, c) {
    ...
    QMEditor.CONST.FILES = {
        ...
        "$js_path$/com/kits/qmeditor/qqmail/release/editor_toolbar_plus38a71a.js": "ClipImg Photo ScreenSnap NetDisk Mo Word More Map"
    };
    ...
    QMEditor.prototype.rmNetDiskAction = function () {
        var k = this, i = k.getEditWin(), l = QMEditor.getTopWin(), h = a.S(b, i),
            g = a.finds("a[ui-type='shareLink']", h), j = [];
        a.E(g, function (m) {
    ...
    QMEditor.prototype._updateBtn = function (g, f) {
        var i = a.finds("td[ui-type='iconInit']", g)[0], h = a.finds("td[ui-type='iconFail']", g)[0],
            j = a.finds("td[ui-type='iconSucc']", g)[0];
        if (!i || !h) {
            return;
        }
        a.show(i, false);
    ...
    QMEditor.prototype._initEvents = function (g) {
        var f = QMEditorAdapter, j = this, k = QMEditor.getTopWin(), i = function (m) {
            ...
            var p = f.finds("td[ui-type='iconSucc'] img[ui-type='goIcon']", n)[0],
                o = f.finds("td[ui-type='iconSucc'] img[ui-type='delIcon']", n)[0];
            if (p) {
                f.show(p, !m);
...
(function (a, b) {
    ...
    QMEditor.EditMenu.prototype.rotateImg = function () {
        var d = this, c = d._moBindEditor.getImgDom(d._moCurrentEditObj),
            e = parseInt(c.getAttribute("degree") || 0) + 90, f = c.getAttribute("rotatekey");
        e == 360 && (e = 0);
        if (!f) {
