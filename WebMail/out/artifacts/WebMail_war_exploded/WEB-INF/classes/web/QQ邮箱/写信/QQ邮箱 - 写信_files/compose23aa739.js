var initComposeForPage = (function () {
    ...
    function _addrErrDlg(_aoCfg) {
        ...
        new _oTop.QMDialog({
            sId: _oCfg.sId || "Address_error",
            sTitle: _oCfg.sTitle || "\u6536\u4EF6\u4EBA\u683C\u5F0F\u9519\u8BEF",
            nHeight: null,
            sBodyHtml: _oTop.T(['<div class="dialog_feedback">', '<span class="dialog_icon icon_caution_b"></span>', '<div class="dialog_f_c">', '<div class="dialog_f_t">$desc$</div>', '<div class="dialog_f_d" style="max-height:64px;_height:53px;word-break:break-all;overflow:hidden;">" <span class="red">$result$</span> "</div>', '</div>', '</div>', '<div class="dialog_operate">', '<input type=button class="btn wd2" id="confirm" value="\u786E\u5B9A" >', '</div>']).replace({
                result: _oCfg.oErrorAddrs.join('</b>","<b style="color:red;">'),
                desc: _oCfg.sDesc || ""
            }),
            onload: function () {
                var _oSelfObj = this;
    ...
    function _uploadComposeEml() {
        new QMDialog({
            sId: "uploademldlg",
            sTitle: "\u4E0A\u4F20eml\u6587\u4EF6",
            sBodyHtml: TE(['<form style="width:100%;" method="post" id="uploademl" name="uploademl" target="actionFrame" action="/cgi-bin/qf_upload" enctype="multipart/form-data">', '<div class="dialog_txt">', '\u8BF7\u9009\u62E9eml\u6587\u4EF6\uFF1A<input type="hidden" name="sid" value="$sid$"/>', '<input type="file" name="UploadFile" class="btn" value=""/>', '</div>', '<div class="dialog_operate">', '<input type="submit" value="\u4E0A\u4F20" class="wd2 btn"/>', '<input type="button" value="\u53D6\u6D88" class="wd2 btn"  id="cancel"/>', '<div class="clr"></div>', '</div>', '</form>']).replace({sid: getSid()}),
            onload: function () {
                var _oDlg = this;
    ...
    var QMClipImg = (function () {
        ...
        function _clearSelectionBookmark(_aoBookmark, _aoWin, _aoEditor) {
            if (_aoBookmark) {
                _aoBookmark = {
                    oStartNode: _oTop.S(_aoBookmark.oStartNode.id, _aoWin),
                    oEndNode: _aoBookmark.oEndNode && _oTop.S(_aoBookmark.oEndNode.id, _aoWin)
                };
                setTimeout(function () {
                    try {
                        _aoEditor.focus(0);
        ...
        QMClipImg.prototype = {
            ...
            _getFileUploder: function () {
                ...
                if (!_oSelf._moFileUploder) {
                    ...
                    _oSelf._moFileUploder = _oTop.QMFileUpload.create('popup', {
                        oComlist: ['ActivexPopupMail'], onselect: function (_aoFiles) {
            ...
            _oPlaceholderImgTpl: _oTop.T('<img id="$id$" src="$img$" __clipimg__="imgitem" width="126px" height="91px" url="$url$" />'),
            _getReplaceFunc: function () {
                var _oSelf = this;
                ...
                return function (_asTags, _asTagStart, _asQute, _asUrl, _asPreUrl, _asFilePath, _asTagEnd) {
                    ...
                    if (_oUploader && _asPreUrl == 'file:///') {
                        setTimeout(function () {
                            _oUploader.onselect([_oUploader.addFile({
                                sFid: _sId,
                                sLocalPath: _asFilePath,
                                sImgTpl: [_asTagStart, _asTagEnd].join('')
                            })]);
                        });
                    }
                    return _oSelf._oPlaceholderImgTpl.replace({
                        id: _sId,
                        url: _oTop.htmlEncode(_asPreUrl + _asFilePath),
                        img: _oTop.getRes('$images_path$function/local_wait1e9c5d.gif')
                    });
                };
            },
            analyse: function () {
        ...
        QMClipImg.onclickImg = function (_aoEvent) {
            var _oEditor = this, _oTarget = _oTop.getEventTarget(_aoEvent),
                _sUnikey = _oTop.attr(_oTarget, "__clipimg__");
            if (_sUnikey) {
                window.open(_oTop.T("/cgi-bin/readtemplate?sid=$sid$&t=help_localpic&filepath=$path$").replace({
                    sid: _oTop.getSid(),
                    path: encodeURIComponent(_oTop.attr(_oTarget, "url"))
                }));
            }
        };
        return QMClipImg;
    ...
    var QMLinkDetector = (function () {
        ...
        QMLinkDetector.prototype = {
            processEnter: function (_aoEvent) {
    ...
    function initTimeSendDlg(_aoCfg, _afConfirm, _afBeforeClose) {
        var _oTop = getTop(), _oSendTimeYear = _aoCfg.sendtimeyear, _oSendTimeMonth = _aoCfg.sendtimemonth,
            _oSendTimeDay = _aoCfg.sendtimeday, _oSendTimeHour = _aoCfg.sendtimehour,
            _oSendTimeMin = _aoCfg.sendtimemin, _sConfirmBtn = _aoCfg.confirmbtn || "\u53D1\u9001",
            _sTitle = _aoCfg.title || "\u5B9A\u65F6\u53D1\u9001",
            _oTimeSendDlgTmpl = _oTop.T(['<div style="padding:20px 28px;text-align:left;">', '<div style="_zoom:1;">$tip$<span id="sendTimeType"></span></div>', '<div id="sendTimeContainer" style="margin:6px 0 8px -4px;font-family:Tahoma">\u52A0\u8F7D\u4E2D...</div>', '<div class="clr"></div>', '<div class="addrtitle" id="sendtimemsg" style="margin-top:10px;"></div>', '</div>']);
        _oTop.loadJsFile("$js_path$qmlunar24e6ae.js", true);
        _oTop.loadJsFile("$js_path$qmdatectrl24e6b9.js", true);
        var _sTimeTip = _aoCfg.timetips || "\u9009\u62E9\u5B9A\u65F6\u53D1\u9001\u7684\u65F6\u95F4\uFF1A",
            _oDateCtrl = null;
        new _oTop.QMDialog({
            sId: "timeSend",
            sBodyHtml: _oTimeSendDlgTmpl.replace({tip: _sTimeTip}),
            sFootHtml: _oTop.T(['<input id="confirm" class="wd2 btn btn_true" type="button" value="$confirmBtn$" />', '<input id="cancel"  class="wd2 btn btn_true" type="button" value="\u53D6\u6D88" />']).replace({confirmBtn: _sConfirmBtn}),
            sTitle: _sTitle,
            nWidth: 470,
            onshow: function () {
                this.S("cancel").focus();
        ...
        _oTop.waitFor(function () {
            ...
            _oDateCtrl = new _oTop.QMDateCtrl({
                container: _oDomSendTimeContainer,
                type: _oTop.QMDateCtrl.LUNAR_LEAP_SUPPORT,
                year: {current: _oSendTimeYear.value, end: parseInt(_oSendTimeYear.value) + 2},
                month: {current: _oSendTimeMonth.value},
                day: {current: _oSendTimeDay.value},
                hour: {current: _oSendTimeHour.value},
                minute: {current: _oSendTimeMin.value},
                onchange: function (_aoQMDateCtrl) {
        ...
        function _dispFormatDate(_aoQMDateCtrl) {
            ...
            if (_aoQMDateCtrl.get("isLunar")) {
                if (_oDom) {
                    ...
                    _oDom.innerHTML = _Tmpl.replace({
                        year: _oSolarDate.getFullYear(),
                        month: _oSolarDate.getMonth() + 1,
                        day: _oSolarDate.getDate(),
                        hour: _oSolarDate.getHours(),
                        minute: _oSolarDate.getMinutes()
                    });
                }
            }
            else {
    ...
    QMAddrCtrl.prototype = {
        _init: function () {
            ...
            var _oAddrDomain = _oWin.addrDomain = {}, _oInputObjs = _oWin.InputObjs = [],
                _oNewInputAddrs = _oWin.NewInputAddrs = [], _sAddrInputDef = "",
                _oNewRcptDom = _oTop.S("domnewRcpt", _oWin), _oAddExistFile = _oTop.S("domAddExistFile", _oWin);
            ...
            function _doShow() {
                var _oReplyExistAttach = _oTop.S("replyexistAttach", _oWin),
                    _oAttachContainer = _oTop.S("attachContainer", _oWin);
            ...
            function _addData() {
                var _oResult = [], _sName = "", _oNew_Addr1 = _oTop.S("new_addr1", _oWin),
                    _oNew_Addr2 = _oTop.S("new_addr2", _oWin);
                for (var i = 0; i < _oNewInputAddrs.length; i++) {
            ...
            function _handleHelper(_asType, _asAddrId) {
                var _oCtrl = _oAddrInputMain.get(_asAddrId, _oWin), _oAddrUC = _oTop.S("addrUrlCreator", _oWin),
                    _oAddrQZ = _oTop.S("addrQzone", _oWin),
                    _bHasUC = _oCtrl.hasAddr(_oCompose.getComposeVar().sUrlCreator), _bUCShow = _oTop.isShow(_oAddrUC),
                    _bQZShow = _oTop.isShow(_oAddrQZ), _bToAdd = false, _bToDel = false, _oDomAddrAdd, _oDomAddrDel,
                    _sAddr, _sAddrFullName;
                if (_bHasUC && !_bUCShow) {
                    _bToAdd = true;
            ...
            function _getRecentGroup(_aoAddrInput, _aoInput) {
                ...
                return _oTop.QMAddress.getRecentGroup({
                    searchId: _aoAddrInput.getId(),
                    addrList: _oAddrList,
                    searchStr: _aoInput.value
                });
            }
            ...
            _oTop.E(_aoTextAreas || ["to", "cc", "bcc", "sc"], function (_asAddrId) {
                var _oAddrCtrlArea = _oTop.S(_asAddrId + "AreaCtrl", _oWin), _oAddrObj = _oTop.S(_asAddrId, _oWin),
                    _nRequestTip = 0;
                if (_oAddrCtrlArea && _oAddrObj) {
                    var _bSupportGroup = _oSelfAddrCtrl._getSupportGroup(), _oAddrInput = new _oAddrInputMain({
                        id: _asAddrId,
                        win: _oWin,
                        tabIndex: _oAddrObj.tabIndex,
                        accessKey: _oAddrObj.accessKey,
                        dom: {container: _oAddrCtrlArea},
                        feature: {autoFold: _aoConfig.bAutoFold},
                        dispMode: _aoConfig.bNick ? 'onlynick' : 'full',
                        maxHeight: _aoConfig.nMaxHeight,
                        filterFunc: function (_aoAddrData) {
                        ...
                        getAutoCompleteData: _getAutoCompleteData,
                        onSelectRecentGroup: function (_aoData) {
                            var _oSelectedGroup = _oTop.QMAddress.getRecentGroupData()[_aoData.index],
                                _sSearchId = _aoData.searchId, _nMatchCnt = _aoData.matchAddrs[_sSearchId].length,
                                _nLastMatchIdx = _aoData.matchAddrs[_sSearchId][_nMatchCnt - 1],
                                _oMatchItem = _oSelectedGroup.data[_aoData.searchId][_nLastMatchIdx], _oAddrInput = {},
                                _oHash = {to: {}, cc: {}, bcc: {}}, _fMakeAddr = function (_asName, _asAddr) {
                        ...
                        onchange: function (_asType) {
                            ...
                            if (_oPageConfig && _oWin["attachflag"] != "replyAllAttach") {
                                ...
                                if ((_oPageConfig.subtmpl == "reply" || _oPageConfig.subtmpl == "reply_all") && ((_oPageConfig.attachs && _oPageConfig.attachs.length) || (_oPageConfig.bigattachs && _oPageConfig.bigattachs.length))) {
                                    _oTop.E(["to", "cc", "bcc", "sc"], function (_asId) {
                                        var _oTmpAddrCtrl = _oAddrInputMain.get(_asId, _oWin),
                                            _oAddrs = _oTmpAddrCtrl.get("json");
            ...
            var _oTop = getTop();
            var _oExistFileDom = _oTop.S("exist_file", _oWin), _oNew_Addrs = _oTop.S("new_addrs", _oWin),
                _oReplyExistAttach = _oTop.S("replyexistAttach", _oWin),
                _oExist_BigAttach = _oTop.S("exist_BigAttach", _oWin);
            ...
            getTop().E(["to", "cc", "bcc", "sc"], function (_asAddrId) {
                var _sUpAddrId = _asAddrId.toUpperCase(), _oAddrCtrl = _oAddrInputMain.get(_asAddrId, _oWin),
                    _oLink = getTop().S(["a" + _sUpAddrId], _oWin), _oBoxLink = getTop().S([_asAddrId + "_btn"], _oWin);
                ...
                if (_oAddrCtrl && _oBoxLink) {
                    _oBoxLink.onclick = function (_aoEvent) {
                        ...
                        _oTop.QMLinkman.showDlg(_asAddrId, _oAddrInputMain.get(_asAddrId, _oWin), {
                            bSupportGroup: _oSelfAddrCtrl._getSupportGroup(),
                            oMainGroup: ["hotgroup", "mailgroup", "ggroup", "domaingroup", "qqgroup", "tool"]
                        });
                        getTop().preventDefault(_aoEvent || _oWin.event);
                    };
                }
            ...
            for (var i = 0, len = _aoQMAddrInputs.length; i < len; i++) {
                var _oAddrInput = _aoQMAddrInputs[i],
                    _oAddrs = _oAddrInput && !_oAddrInput.isDisabled() && _oAddrInput.get("json") || [];
                ...
                if (_oCache[_sEmail = _oEmails.sort().join(';')]) {
                    ...
                    if (!_oAjax) {
                        ...
                        _oAjax.onComplete = function (_asResp) {
                            var _oRsp = eval(_asResp.responseText), _oHit = _oRsp && _oRsp.addrhistory || [],
                                _oInValidAcc = _oRsp && _oRsp.invalidlocalaccount || [],
                                _oInValidAccCache = _oCache['invalidaddr'] = _oCache['invalidaddr'] || [];
                    ...
                    _oAjax.abort();
                    _oAjax.send(_oTop.T("acttype=4&sid=$sid$&uin=$uin$&addrfilt=$addr$").replace({
                        sid: _oTop.getSid(),
                        uin: _oTop.getUin(),
                        addr: _sEmail
                    }));
            ...
            function _showHint(_aoItems) {
                var _oShowSpan = _oSelfAddrCtrl._oAddrAssociateShowSpan || (_oSelfAddrCtrl._oAddrAssociateShowSpan = _oTop.S("addrAssociation", _oWin)),
                    _oAddr, _oAddrItems = [], _oEvtTmpl = _oTop.T('addAddr("\\\"$name$\\\"&lt;$email$&gt;;")'),
                    _oAddrTmpl = _oTop.TE(['$@$for($_this_$)$@$$@$if($_idx_$<3)$@$', '<a style="pointer:cursor;" title="$email$" onclick=\'' + _oEvtTmpl + '\'>$htmlname$</a>', '$@$if($_idx_$<$_root_.length$-1&&$_idx_$<2)$@$, $@$endif$@$', '$@$endif$@$$@$endfor$@$']);
                if (!_oShowSpan) {
                    return;
                }
                if (_aoItems.length) {
                    for (var i = 0, len = _aoItems.length; i < len; i++) {
                        ...
                        if (_oAddr) {
                            _oAddrItems.push({
                                htmlname: _oAddr.name,
                                name: _oTop.htmlEncode(_oTop.encodeNick(_oTop.encodeNick(_oTop.htmlDecode(_oAddr.name)))),
                                email: _oAddr.email
                            });
                        }
                    }
            ...
            var _oAddrInputMain = _oCompose.getQMAddrInput();
            var _oTop = getTop();
            var _oQuickAddrDiv = _aoQuickAddrDiv, _sType = _aoParam.sType, _oQMAddress = _oTop.QMAddress,
                _oConfig = _oCompose.getPageConfig(),
                _oMailGroup = ["hotgroup", "mailgroup", "ggroup", "domaingroup", "qqgroup", "tool"];
            if (!_oQuickAddrDiv) {
                return false;
            }
            if (_sType == 'succeed') {
                if (_oQuickAddrDiv.innerHTML.indexOf('lm_panel') < 0) {
                    ...
                    _oSelfAddrCtrl.moLinkmanInstance = new _oTop.QMLinkman({
                        nType: 0,
                        bSupportGroup: _oSelfAddrCtrl._getSupportGroup(),
                        oMainGroup: _oMailGroup,
                        oContainer: _oQuickAddrDiv,
                        sFromaddr: _oConfig.subtmpl == "forward" ? _sFromAddr : null,
                        sFromname: _oConfig.subtmpl == "forward" ? _sFromName : null,
                        onselect: function (_aoAddress) {
                ...
                _oQuickAddrDiv.innerHTML = _oTop.T(['<div style="padding:155px 0 0;text-align:center;">', _sType == 'loading' ? '<img src="$images_path$ico_loading11e9c5d.gif" align="center"/> \u52A0\u8F7D\u4E2D...' : '<a href="javascript:\'\'" onclick="return getTop().QMAddress.$fun$();">$content$</a>', '</div>']).replace({
                    images_path: _oTop.getPath("image"),
                    fun: 'initAddress',
                    content: _aoParam.sMsg
                });
            }
            ...
            var _oTop = getTop(), _oContainer = _oTop.S("trSC", _oWin), _bSeparatedCopy = !_oTop.isShow(_oContainer),
                _oScAddrCtrl = _oAddrInputMain.get("sc", _oWin)[_bSeparatedCopy && !_abNotSetValue ? "clear" : "flush"](),
                _oScAddrJsonData = !_bSeparatedCopy ? _oScAddrCtrl.get("json") : null, _oNotExistAddrData = {};
            if (_oScAddrJsonData) {
    ...
    ;QMAttachDrag.prototype = {
        _init: function () {
            ...
            _oDragSelf._moFileDragUpload = _oTop.QMFileUpload.create("drag", {
                oContainer: _oDragSelf._moDragAndDropContainer.lastChild,
                sDragLeaveMsg: _oTop.detectActiveX(2, 1) && '\u5C06\u6587\u4EF6\u62D6\u62FD\u81F3\u6B64\u533A\u57DF\uFF0C\u4F60\u4E5F\u53EF\u4EE5\u4F7F\u7528\u5FEB\u6377\u952Ectrl+c\u3001ctrl+v\u6765\u6DFB\u52A0\u9644\u4EF6\u3002',
                onproxyclose: _oDragSelf._onProxyClose(),
                onerror: function () {
            ...
            function _uploadingDlg(_asOpt, _anPercent) {
                ...
                if (_asOpt == "close") {
                    ...
                    return new _oTop.QMDialog({
                        sId: "uploadimg_drag",
                        sTitle: '\u4E0A\u4F20\u56FE\u7247',
                        sBodyHtml: _oTop.T(['<div style="padding:40px 0;font:normal 12px;text-align:center">', '<div id="uploading">', '<img src="$imgPath$ico_loading2.gif" width="32" height="32" align=absmiddle style="margin:0 4px 0 0" />$langUploading$', '<span id="uploadProcess"></span>', '</div>', '<div id="uploadFail" style="height:32px;line-height:32px;display:none;" >', '$langUploadFail$', '</div>', '</div>']).replace({
                            imgPath: _oTop.getPath("image"),
                            langUploading: _oTop.TE(['\u6B63\u5728\u4E0A\u4F20', '$@$if($cnt$ > 1)$@$', '$idx$/$cnt$', '$@$endif$@$', '...']).replace({
                                cnt: _oImgUploadMgr.getUploadList().length,
                                idx: _oImgUploadMgr.getUploadList().length - _oImgUploadMgr.getUploadList('ready').length
                            }),
                            langUploadFail: '\u56FE\u7247\u4E0A\u4F20\u5931\u8D25\u4E86\uFF01'
                        }),
                        nWidth: 400,
                        bAnimation: false,
                        onclose: function () {
            ...
            _oDragSelf._moImgDragUpload = _oTop.QMFileUpload.create('drag', {
                bNoStyle: true,
                oContainer: _oDragSelf._moCfg.oImgUploadArea,
                sDragLeaveMsg: '<div style="' + _sCss + '">\u5C06\u56FE\u7247\u62D6\u62FD\u81F3\u6B64\u533A\u57DF\uFF0C\u53EF\u76F4\u63A5\u6DFB\u52A0\u81F3\u6B63\u6587\u3002</div>',
                sDragEnterMsg: '<div style="' + _sCss + '">\u91CA\u653E\u9F20\u6807</div>',
                oComlist: (_oTop.goExpers && _oTop.goExpers.h5cJsUploadNormal) ? ["H5CDragFMail", "Html5DragMail"] : ["Html5DragMail"],
                onproxyclose: _oDragSelf._onProxyClose(),
                onselect: function (_aoFiles) {
                    _oDragSelf._hideDragAndDropArea();
            ...
            if (!_oTop.gbIsIE && (_oDragSelf._moFileDragUpload || _oDragSelf._moImgDragUpload)) {
                _oTop.addEvents([_oWin, _oDragSelf._moCfg.oEditor.getEditWin()], {
                    dragleave: _oDragSelf._onDragLeave(),
                    dragenter: _oDragSelf._onDragEnter(),
                    drop: _oDragSelf._onDrop()
                }, _abIsRemove);
            }
    ...
    QMAttachMain.prototype = {
        ...
        _mnAttToFtnSize: 20,
        _msMode: "normal",
        _msWarnningTypes: "exe|msi|scr|cmd|bat|com",
        _mnSizeLimit: 50,
        _mnAttachId: 0,
        _moCurUploader: null,
        _moCurUploadAttachInfo: null,
        _moCurUploadTimeStamp: null,
        _mbIsDisableControl: false,
        onprogress: null,
        onfinish: null,
        _oWinProxyFuncArr: {
            'delAttach': false,
            'addOtherUploaderFileCell': false,
            'delExistAttach': true,
            'delBigAttach': true
        },
        S: function (_asId) {
        ...
        _initFileUploadMgr: function () {
            var _oSelfAttach = this;
            _oSelfAttach.oFileUploadMgr = new _qmFileMgr(_oSelfAttach._moWin, {
                onselect: function (_aoFiles) {
        ...
        getFileInfo: function (_asId) {
            ...
            if (_oDomCurr && _oTop.attr(_oDomCurr, "attachtype") == "big") {
                var _sFid = _oTop.attr(_oDomCurr, "fid"), _sKey = _oTop.attr(_oDomCurr, "key"),
                    _sCode = _oTop.attr(_oDomCurr, "code");
                _oInfo = {};
                ...
                _oInfo.sUrl = ({
                    "doc": _oTop.TE(["/cgi-bin/ftnfilefunc?sid=$sid$&code=$code$&k=$k$&oper=$oper$", "&appid=$appid$&t=$t$&nocheckframe=true&s=yozo&fromattach=1", "&ftnpreviewtype=$type$&filename=$filename$&nofixedname=$@$eval getTop().htmlEncode($filename$)$@$&ef=qfunc", "&filetype=$filetype$&viewtype=$viewtype$"]),
                    "compress": _oTop.TE(["/cgi-bin/ftnviewcompress?sid=$sid$&cpsfile=$@$eval getTop().encodeURI($filename$)$@$", "&fid=$fid$&filetype=$filetype$&action=list&t=cps.json&fromattach=1&k=$k$&code=$code$"])
                }[_oInfo.sType] || _oTop.T("/cgi-bin/ftnDownload302?sid=$sid$&fid=$fid$&code=$code$&k=$k$")).replace({
                    oper: "doc,xls,ppt,docx,xlsx,pptx,pdf,eml,pps,rtf,docm,dot,dotx,dotm,".indexOf(_oInfo.sSuffix + ",") != -1 ? "htmlopen" : "view",
                    sid: _oTop.getSid(),
                    code: _sCode,
                    fid: _sFid,
                    k: _sKey,
                    t: _oInfo.sSuffix == "eml" ? "preview_eml" : "attachments_content",
                    type: _oInfo.sType,
                    filetype: _oInfo.sFileType,
                    filename: _oTop.encodeURI(_oInfo.sName),
                    appid: _oTop.attr(_oDomCurr.parentNode, "appid") || 2,
                    viewtype: _oInfo.sSuffix == "eml" ? "eml" : ""
                });
            }
                ...
                _oTop.E(_oSelfAttach.oFileUploadMgr.getUploadList("complete"), function (_aoFile) {
                    if (_aoFile.get("sId") == _asId) {
                        var _sUploadType = _aoFile.get("sUploadMode") == "collection" ? "collection" : "attach",
                            _sUpFileId, _sMailAttach;
                        ...
                        var _sName = _aoFile.get("sName"), _sSuffix = _oTop.getFileExt(_sName),
                            _sType = _oTop.getViewTypeByExt(_sSuffix), _sTmpl;
                        switch (_sType) {
                            case "compress":
                                _sTmpl = "cps.json";
                                break;
                        ...
                        _oInfo.sType = _sType;
                        _oInfo.sFileType = _oTop.getFileTypeByExt(_oInfo.sSuffix || "");
                        _oInfo.sUrl = _aoFile.get("sFileUrl") || _oTop.T(['/cgi-bin/$appname$?sid=$sid$&upfilelistitem=$upfileid$&mailattach=$mailattach$', '&filename=$filename$&t=$t$&readprev=$compose$&filepath=$filepath$', '&action=$action$$viewdocparam$&filetype=$filetype$&viewtype=$viewtype$&nf=$nf$']).replace({
                            sid: _oTop.getSid(),
                            appname: {
                                "txt": "viewfile",
                                "html": "viewfile",
                                ...
                                "music": "viewfile",
                                "img": "viewfile"
                            }[_oInfo.sType] || "viewdocument",
                            action: _oInfo.sType == "compress" ? "list" : (_fIsTextDoc(_oInfo.sSuffix) ? "view" : ""),
                            compose: _aoFile.get("sComposePage") == "group" ? _aoFile.get("sComposePage") : "normal",
                            t: _sTmpl,
                            filetype: _oInfo.sFileType,
                            filename: _oTop.encodeURI(_oInfo.sName),
                            upfileid: _sUpFileId,
                            filepath: (_aoFile.get("sFilePath")) || "",
                            mailattach: _sMailAttach,
                            viewdocparam: _oInfo.sType == "doc" ? "&s=yozo&fromattach=1&from=attachfolder" : "",
                            viewtype: _oInfo.sSuffix == "eml" ? "eml" : "",
                            nf: _aoFile.get('sNf') || ''
                        });
                        return false;
                ...
                _oTop.E(_oDomList, function (_aoDom) {
                    if (_oTop.attr(_aoDom, "uploadid") == _asId) {
                        var _sName = _oTop.trim(_oTop.htmlDecode(_oTop.finds("span[ui-type='filename']", _fGetCtxDom(_oDomCurr))[0].innerHTML.replace(/\<.*?\>/gi, ""))),
                            _sSuffix = _oTop.getFileExt(_sName), _sType = _oTop.getViewTypeByExt(_sSuffix), _sTmpl;
                        switch (_sType) {
                            case "compress":
                                _sTmpl = "cps.json";
                                break;
                        ...
                        _oInfo.sType = _sType;
                        _oInfo.sFileType = _oTop.getFileTypeByExt(_oInfo.sSuffix || "");
                        _oInfo.sUrl = _oTop.attr(_oDomCurr, 'fileurl') || _oTop.T(['/cgi-bin/$appname$?sid=$sid$&upfilelistitem=$upfileid$&mailattach=$mailattach$', '&filename=$filename$&t=$t$&readprev=$compose$&filepath=$filepath$', '&action=$action$$viewdocparam$&filetype=$filetype$&viewtype=$viewtype$']).replace({
                            sid: _oTop.getSid(),
                            appname: {
                                "txt": "viewfile",
                                "html": "viewfile",
                            ...
                            action: _oInfo.sType == "compress" ? "list" : (_fIsTextDoc(_oInfo.sSuffix) ? "view" : ""),
                            compose: _oCompose.getPageId() == "group" ? _oCompose.getPageId() : "normal",
                            t: _sTmpl,
                            filetype: _oInfo.sFileType,
                            filename: _oTop.encodeURI(_oInfo.sName),
                            filepath: "",
                            mailattach: _oTop.encodeURI(_oTop.finds("input[name='replymailattach']", _fGetCtxDom(_aoDom)).length && _oTop.finds("input[name='replymailattach']", _fGetCtxDom(_aoDom))[0].value || _oTop.finds("input[name='mailattach']", _fGetCtxDom(_aoDom)).length && _oTop.finds("input[name='mailattach']", _fGetCtxDom(_aoDom))[0].value || ''),
                            viewdocparam: _oInfo.sType == "doc" ? "&s=yozo&fromattach=1&from=attachfolder" : "",
                            viewtype: _sSuffix == "eml" ? "eml" : ""
                        });
                        return false;
                    }
                });
        ...
        preview: function (_avParam) {
            ...
            _oTop.waitFor(function () {
                ...
                if (_abIsOk) {
                    var _sId = typeof (_avParam) == "string" ? _avParam : _oTop.attr(_avParam, "uploadid"),
                        _fCallback = function (_asType) {
                            return function (_aoCurrInfo) {
                                var _oDomList = _oTop.finds("div.attsep span[uploadid]", _oSelfAttach.S("attachContainer")),
                                    _nIdx = -1, _sAttId = _aoCurrInfo.sAttachId_, _oInfo;
                    ...
                    _oTop.QMPreviewer.show(_oSelfAttach.getFileInfo(_sId), {
                        fPrev: _fCallback("prev"),
                        fNext: _fCallback("next")
                    }, {bIsShowBreakLine: false, bShowDownBtn: false});
                }
            });
        },
        ...
        checkAttachWarnningType: function () {
            ...
            getTop().E(_oSelf._getExistAttachChildNode(), function (_aoObj) {
                if (_aoObj.tagName == "DIV") {
                    var _oObj = _oSelf.S("eas_" + _aoObj.id.split("_").pop()),
                        _sFileName = _oObj && (_oObj.innerText || _oObj.textContent) || "";
        ...
        missAttach: function (_aoAttachList) {
            ...
            var _oSelfAttach = this;
            _oTop.confirmBox({
                msg: _oTop.TE(['%@%if(%type%=="fw")%@%', '\u4EE5\u4E0B\u9644\u4EF6\u63D0\u53D6\u5931\u8D25\uFF0C\u8BF7\u5220\u9664\u540E\u91CD\u8BD5\uFF1A', '%@%else%@%', '\u4EE5\u4E0B%len%\u4E2A\u9644\u4EF6\u4E0A\u4F20\u5931\u8D25\uFF0C\u8BF7\u5220\u9664\u540E\u91CD\u8BD5\uFF1A', '%@%endif%@%<br/>', '%@%for(%list%)%@%', '<span style="color:red;" title="%name%">', '%@%eval subAsiiStr(%name%,%_root_.width%,"...",1)%@%', '</span>;&nbsp;', '%@%if(%_root_.len%<5)%@%<br/>%@%endif%@%', '%@%endfor%@%'], '%').replace({
                    len: _aoAttachList.length,
                    width: _aoAttachList.length < 5 ? 40 : 15,
                    list: _aoAttachList
        ...
        outputBtn: function (_abShowNor, _abShowPlus, _anSizeLimit, _abEasyMode) {
            var _oTop = getTop(), _oSelf = this,
                _nSizeLimit = typeof (_anSizeLimit) != "number" ? this._mnSizeLimit : (this._mnSizeLimit = _anSizeLimit);
        },
        isUploading: function () {
        ...
        attrUpload: function (_aoUpload, _oFileInfo) {
            ...
            _oTop.getAttachList(_oFileInfo._oFile, function (_abIsOk, _aoParam, _aoXhr, _asResp) {
                if (_abIsOk) {
                    var _oAttach = _aoParam.attach[0], _sSizeId = "SIZEUploader" + _oFileInfo.get("sId"),
                        _oSizeDom = _oSelf.S(_sSizeId);
        ...
        setUpAttInput: function () {
            ...
            var _oAppScanUploadFileInput = _oSelf.S("encryptattach"),
                _bHasAppScanUploadFile = (_oAppScanUploadFile && _oAppScanUploadFile.length > 0);
        ...
        _attachlistLog: function () {
            ...
            try {
                var _oAttachContainer = _oSelf.S("attachContainer"), _oCAInput = _oSelf.S("cattachlist"),
                    _oAttDivs = _oAttachContainer && _oTop.finds("div.attsep", _oAttachContainer);
                _nProcessId = 1;
        ...
        showAttachLimitByAddr: function (_anLimit, _afCallback) {
            ...
            new _oTop.QMDialog({
                sId: "attachAlert",
                sTitle: "\u63D0\u793A",
                sBodyHtml: _oTop.TE(['<div class="dialog_content" un="eve_complete_div">', '<div class="dialog_feedback">', '<span class="dialog_icon icon_info_b"></span>', '<div class="dialog_f_c">', '<div class="dialog_f_t" style="font-weight: normal;">\u4F60\u7684\u90AE\u4EF6\u5927\u5C0F\u8D85\u8FC7\u4E86', '$@$if($domain$)$@$', ' @$domain$ ', '$@$else$@$', '\u5BF9\u65B9', '$@$endif$@$', '\u7684\u9650\u5236\uFF0C\u8FD9\u53EF\u80FD\u4F1A\u5BFC\u81F4\u9000\u4FE1\uFF0C<span style="display:', _sDisplay, ';"><br></span>\u662F\u5426\u5C06\u666E\u901A\u9644\u4EF6\u8F6C\u4E3A\u8D85\u5927\u9644\u4EF6\u53D1\u9001\uFF1F</div>', '</div>', '</div>', '</div>', '<div class="dialog_operate">', '<a class="btn_blue btn_space" id="transfer">\u8F6C\u4E3A\u8D85\u5927\u9644\u4EF6\u53D1\u9001</a>', '<a class="btn_gray btn_space" id="gosend">\u7EE7\u7EED\u53D1\u9001</a>', '<a class="btn_gray" id="cancel">\u53D6\u6D88</a>', '</div>']).replace({
                    image_path: _oTop.getPath('image'),
                    domain: _oCompose.getComposeVar()._oDomainChecker.getAttachLimit().sDom,
                    size: this._formatSize(_anLimit)
                }),
                nHeight: null,
                nWidth: _nWidth,
                onload: function () {
        ...
        _addFileCell: function (_aoFile) {
            ...
            _oDiv.id = "D" + _sName;
            _oDiv.innerHTML = this._getFileCellTmpl(_aoFile.get("sUploadMode")).replace({
                id: _aoFile.get("sId"),
                name: _sName,
                value: _oTop.htmlEncode(_aoFile.get("sName")),
                images_path: _oTop.getPath("image", true),
                ext: _aoFile.get("sUploadMode"),
                filename: _oTop.htmlEncode(_aoFile.get("sName")),
                dispfname: _insertWbr(_aoFile.get("sName")),
                size: _aoFile.get("nSize") || 0,
                formatsize: this._formatSize(parseInt(_aoFile.get("nSize") || 0)),
                mailattach: _aoFile.get("sUploadMode") == "collection" ? [_aoFile.mailid, _aoFile.attachid, _aoFile.attachname].join("|") : "",
        ...
        _formatSize: getTop().QMFileUpload.oUtil.formatSize,
        ...
        _isWarnningType: function (_asFileName) {
            var _oWarningType = this._msWarnningTypes.split("|"), _bFlag = false,
                _sExFileName = (_asFileName || "").split(".").pop().toLowerCase();
        ...
        _subFileName: function (_asFileName) {
            var _nNameLen = _asFileName.length, _nFirstLen = _nNameLen - 6,
                _sFileFirst = _asFileName.substr(0, _nFirstLen), _sFileLast = _asFileName.substr(_nFirstLen);
        ...
        _updateAttachStatus: function (_aoAttachInfo, _asStatus, _asErrType, _asErrMsg) {
            ...
            var _oTop = getTop();
            var _oCompose = _oSelf._moCompose;
            var _sId = _aoAttachInfo.get("sId"), _sShowConfig = "", _sHideConfig = "",
                _bAttFlg = typeof _aoAttachInfo._oFile == "string",
                _sSPstr = (_aoAttachInfo.get("bUpToFtn") || _aoAttachInfo.get("bIsUptoFtnForNormal")) ? '|SP' : '';
            switch (_asStatus) {
                case "ready":
                ...
                case "complete":
                    ...
                    if (_aoAttachInfo.get("bUpToFtn")) {
                        ...
                        _oTop.insertHTML(_oUploaderDom, "afterEnd", _oSelf._getFileCellTmpl("exist_big").replace({
                            id: _aoAttachInfo.get("sId"),
                            downloadlink: _aoAttachInfo.get("sDownloadPage"),
                            exptime: _aoAttachInfo.get("nServerSecond") + _aoAttachInfo.get("nExpireTime"),
                            dispfname: _insertWbr(_aoAttachInfo.get("sName")),
                            filesize: this._formatSize(parseInt(_aoAttachInfo.get("nSize") || 0)),
                            fid: _aoAttachInfo.get("sFileId"),
                            sid: _oTop.getSid(),
                            code: _aoAttachInfo.get("sFetchCode"),
                            key: _aoAttachInfo.get("sKey"),
                            ispic: _oTop.getViewTypeByFileName(_aoAttachInfo.get("sName")) == "img",
                            bIsDoc: _oTop.isSupportImportWord(_aoAttachInfo.get("sName"))
                        }));
                ...
                case "error":
                    ...
                    if (_oEUploader) {
                        ...
                        _oEUploader.title = _oTop.T("\u9519\u8BEF\u7C7B\u578B\uFF1A$type$\n\u9519\u8BEF\u6D88\u606F\uFF1A$msg$").replace({
                            type: _aoAttachInfo.get("sType"),
                            msg: _sError.split(",").slice(0, 2).join(",")
                        });
                    }
        ...
        getInfoUid: function (_aoUploadIds) {
            ...
            getTop().E(this.oFileUploadMgr.getUploadList("complete"), function (_aoFile) {
                if (_aoUploadIds[_aoFile.get("sFileId")]) {
                    _oResult.push({
                        name: getTop().htmlEncode(_aoFile.get("sName")),
                        id: "Uploader" + _aoFile.get("sId")
                    });
                }
            });
            return _oResult;
        ...
        initFileUpload: function (_aoConfig) {
            ...
            _oTop.waitFor(function () {
                ...
                if (_abIsOk) {
                    ...
                    _oSelfAttach._moBindDragUpload = _oSelfAttach.initDragFileUpload({
                        oWin: _oWin,
                        nImgUploadOffsetY: 150,
                        oImgUploadArea: _oTop.finds("#QMEditorArea", _oWin)[0],
                        oEditor: _oCompose.getPageEditor()
                    });
                    ...
                    _oMoreUpload.onclick = function () {
                        ...
                        if (!_oMenu || !_oMenu.isShow()) {
                            ...
                            new _oTop.QMMenu({
                                ...
                                nY: _nPosAttY,
                                nItemHeight: 21,
                                nWidth: _oTop.getLocale() == "zh_CN" ? 150 : 200,
                                oItems: _oMenuItems,
                                onitemclick: function (_asId) {
                                    switch (_asId) {
                                        case 'drag':
        ...
        initDragFileUpload: function (_aoCfg) {
            ...
            var _oSelfAttach = this;
            var _oCompose = _oSelfAttach._moCompose;
            var _oDragUpload = new QMAttachDrag(_oTop.extend({
                oAttach: _oSelfAttach, attachInsertImage: function () {
        ...
        onmgrprocess: function (_aoFile) {
            ...
            var _oWin = _oSelf._moWin;
            var _oTop = getTop();
            var _oUtil = _oTop.QMFileUpload.oUtil, _sId = _aoFile.get("sId"), _oDom = _oSelf.S("PBUploader" + _sId),
                _nPercent = _aoFile.get('nPercent') || 0;
            ...
            if (_oSelf.onprogress) {
                try {
                    if (_nPercent < 0) {
                        ...
                        var _oMgr = _oSelf.oFileUploadMgr, _nSize = _oSelf._getAllFileSize(),
                            _oReadyFile = _oMgr.getUploadList("ready"), _nLeftSize = 0;
        ...
        _checkExeAndZeroSize: function (_aoFiles, _afCallback) {
            var _oTop = getTop(), _oSelf = this, _oBigSizeErrors = [], _oZeroSizeErrors = [], _oFileInfoErrors = [],
                _oTypeErrors = [], _oLinkFileErrors = [], _oTmpFiles = [];
            ...
            if (_oZeroSizeErrors.length || _oFileInfoErrors.length || _oTypeErrors.length || _oLinkFileErrors.length || _oBigSizeErrors.length) {
                ...
                if (_oZeroSizeErrors.length) {
                    _oErrorMsg.push(_oTmpl.replace({
                        title: '\u4EE5\u4E0B\u6587\u4EF6\u5927\u5C0F\u4E3A 0 \u5B57\u8282\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\u3002',
                        filelist: _oTop.htmlEncode(_oZeroSizeErrors.join(", "))
                    }));
                }
                if (_oFileInfoErrors.length) {
                    _oErrorMsg.push(_oTmpl.replace({
                        title: '\u4EE5\u4E0B\u6587\u4EF6\u8DEF\u5F84\u8BC6\u522B\u9519\u8BEF\u6216\u8D85\u51FA\u5927\u5C0F\u9650\u5236\u3002',
                        filelist: _oTop.htmlEncode(_oFileInfoErrors.join(", "))
                    }));
                }
                if (_oTypeErrors.length) {
                    _oErrorMsg.push(_oTmpl.replace({
                        title: '\u51FA\u4E8E\u5B89\u5168\u6027\u8003\u8651\uFF0C\u4E0D\u5141\u8BB8\u6DFB\u52A0\u4EE5\u4E0B\u53EF\u6267\u884C\u6587\u4EF6\u6587\u4EF6\u3002',
                        filelist: _oTop.htmlEncode(_oTypeErrors.join(", "))
                    }));
                }
                if (_oLinkFileErrors.length) {
                    _oErrorMsg.push(_oTmpl.replace({
                        title: '\u4EE5\u4E0B\u6587\u4EF6\u5185\u5BB9\u8BFB\u53D6\u5931\u8D25\uFF0C\u8BF7\u5C1D\u8BD5\u538B\u7F29\u540E\u518D\u53D1\u9001',
                        filelist: _oTop.htmlEncode(_oLinkFileErrors.join(", "))
                    }));
                }
                if (_oBigSizeErrors.length) {
                    _oErrorMsg.push(_oTmpl.replace({
                        title: '\u5355\u4E2A\u6587\u4EF6\u4E0D\u80FD\u8D85\u8FC7' + Math.round(_nFtnMaxFileSize / 1024 / 1024 / 1024) + 'G',
                        filelist: _oTop.htmlEncode(_oBigSizeErrors.join(", "))
                    }));
                }
                _oTop.alertBox({
                    msg: _oErrorMsg.join('<div style="height: 8px; width:100%;"></div>'),
                    title: "\u786E\u8BA4",
                    onreturn: function () {
        ...
        addExistAttach: function (_aoData, _abIsOriginAtt, _abIsReplyAttach) {
            ...
            var _oWin = _oSelfAttach._moWin;
            var _oTop = getTop(),
                _oMailAttach = _oTop.T('<input id="$id$" name="$attachname$" value="$mailattach$" type="hidden" />'),
                _oMailIds = _aoData.forward, _oAttachs = _aoData.attach;
            for (var i = 0, _nLen = _oAttachs.length; i < _nLen; i++) {
                ...
                if (!_abIsOriginAtt) {
                    _oTop.insertHTML(_abIsOriginAtt ? _oSelfAttach.S("exist_file") : _oWin.document.frm, 'beforeEnd', _oMailAttach.replace({
                        id: _sCompose_path,
                        mailattach: [_oAttachs[i].mailid, _sCompose_path, _oAttachs[i].name].join("|"),
                        attachname: _abIsReplyAttach ? "replymailattach" : "mailattach"
                    }));
                }
                    ...
                    _oTop.insertHTML(_abIsOriginAtt ? _oSelfAttach.S("exist_file") : _oWin.document.frm, 'beforeEnd', _oSelfAttach._getFileCellTmpl("exist").replace({
                        id: _sCompose_path,
                        attid: _oAttachs[i].attid,
                        value: [_oAttachs[i].mailid, _sCompose_path, _oAttachs[i].name].join("|"),
                        viewname: _insertWbr(_oAttachs[i].name),
                        newname: _oAttachs[i].newname,
                        size: _oAttachs[i].size,
                        viewfileurl: _oAttachs[i].viewfileurl,
                        bIsDoc: _oTop.isSupportImportWord(_oAttachs[i].name),
                        attachname: _abIsReplyAttach ? "replymailattach" : "mailattach"
                    }));
                }
            }
        ...
        addExistAttach_Big: function (_aoData, _asMod) {
            ...
            _oTop.E(_aoData.bigattach, function (_aoAttach) {
                if (!_oSelfAttach.S("eabig_" + _aoAttach.id)) {
                    _oTop.insertHTML(_oBigAttachDom, 'beforeEnd', _oSelfAttach._getFileCellTmpl("exist_big").replace(_oTop.extend(_aoAttach, {
                        dispfname: _insertWbr(_aoAttach.filename),
                        mode: _asMod == 'reply' ? "replaybigattach" : _asMod || "",
                        ispic: _oTop.getViewTypeByFileName(_aoAttach.filename) == "img",
                        sid: _oTop.getSid(),
                        bIsDoc: _oTop.isSupportImportWord(_aoAttach.filename)
                    })));
                }
            });
        },
        addExistNormalAttach: function (_aoData) {
            ...
            _oTop.E(_aoData, function (_aoAttach) {
                ...
                _oTop.insertHTML(_oBigAttachDom, 'beforeEnd', _oSelfAttach._getFileCellTmpl("exist_normal2Ftn").replace({
                    id: _oFile.get("sId"),
                    name: "Uploader" + _oFile.get("sId"),
                    value: _oTop.htmlEncode(_oFile.get("sName")),
                    images_path: _oTop.getPath("image", true),
                    ext: _oFile.get("sUploadMode"),
                    filename: _oTop.htmlEncode(_oFile.get("sName")),
                    dispfname: _insertWbr(_oFile.get("sName")),
                    size: _oFile.get("nSize") || 0,
                    formatsize: _oSelfAttach._formatSize(parseInt(_oFile.get("nSize") || 0)),
                    mailattach: "",
                    ftn: _oFile.get("bUpToFtn"),
                    bResumeAttach: _oFile.get('bResumeAttach'),
                    viewfileurl: _oFile.get('sDownloadPage'),
                    ispic: _oTop.getViewTypeByFileName(_oFile.get("sName")) == "img",
                    bIsDoc: _oTop.isSupportImportWord(_oFile.get("sName"))
                }));
            });
        },
        addExistAttach_normal2Ftn: function (_aoData) {
            ...
            _oTop.E(_aoData.attach, function (_aoAttach) {
                ...
                _oTop.insertHTML(_oBigAttachDom, 'beforeEnd', _oSelfAttach._getFileCellTmpl("exist_normal2Ftn").replace({
                    ...
                    dispfname: _insertWbr(_aoFile.get("sName")),
                    size: _aoFile.get("nSize") || 0,
                    formatsize: _oSelfAttach._formatSize(parseInt(_aoFile.get("nSize") || 0)),
                    mailattach: "",
                    ftn: _aoFile.get("bUpToFtn"),
                    bResumeAttach: _aoFile.get('bResumeAttach'),
                    viewfileurl: _aoFile.get('sDownloadPage'),
                    ispic: _oTop.getViewTypeByFileName(_aoFile.get("sName")) == "img",
                    bIsDoc: _oTop.isSupportImportWord(_aoFile.get("sName"))
                }));
            });
        },
    ...
    function versionCompare(v1, v2, options) {
        var lexicographical = options && options.lexicographical, zeroExtend = options && options.zeroExtend,
    ...
    _qmFileMgr.prototype = {
        _upload: function (_aoFile) {
            var _oSelf = this;
            ...
            if (_aoFile.uploadToFtn && _aoFile.get("bUpToFtn")) {
                ...
                if (_nUserUploadFreeSpace && _aoFile.get("nSize") > _nUserUploadFreeSpace) {
                    _oSelf.oCfg.onerror.call(_oSelf, (_aoFile.set({
                        sStatus: "error",
                        sError: "cgi,-25086,ftnCreatefile"
                    })));
                    return;
                }
    ...
    var QMOnlineAttachMain = _oTop.inherit("QMOnlineAttachMain", QMAttachMain, function (_aoSuper) {
        return {
            _msAllowTypes: ['doc', 'docx', 'xls', "xlsx"],
            _mnSingleLimitSize: 3 * 1024 * 1024,
            _oWinProxyFuncArr: {},
            $_constructor_: function (_aoCompose, _aoWin, _aoOnlineDoc) {
            ...
            initFileUpload: function (_aoConfig) {
                ...
                _oTop.waitFor(function () {
                    ...
                    if (_abIsOk) {
                        ...
                        _oSelfAttach._moAttfldUpload = _oTop.QMFileUpload.create("base", _oUploadCallBacks);
                        _oSelfAttach._moPoupuUpload = _oTop.QMFileUpload.create("popup", _oTop.extend({
                            oContainer: _aoConfig.oContainer,
                            bMulti: false,
                            sAcceptFileTypes: ".doc, .docx, .xls, .xlsx"
                        }, _oUploadCallBacks));
                        if (getTop().goExpers.uploadunite === false) {
                            if (/FlashPopup/.test(_oSelfAttach._moPoupuUpload.name)) {
                                var _oProxyData = _oTop["__UploadSvrProxy__"], _oCfg = {};
            ...
            _checkExeAndZeroSize: function (_aoFiles, _afCallback) {
                ...
                if (_oZeroSizeErrors.length || _oFileInfoErrors.length || _oTypeErrors.length || _oLinkFileErrors.length || _oBigSizeErrors.length) {
                    ...
                    if (_oTypeErrors.length) {
                        _oErrorMsg.push(_oTmpl.replace({
                            title: '\u53EA\u652F\u6301\u5BFC\u5165doc docx xls xlsx\u6587\u4EF6',
                            filelist: _oTop.htmlEncode(_oTypeErrors.join(", "))
                        }));
                    }
                    if (_oLinkFileErrors.length) {
            ...
            _addFileCell: function (_aoFile) {
                ...
                _oDiv.innerHTML = this._getFileCellTmpl(_aoFile.get("sUploadMode")).replace({
                    ...
                    mailattach: _aoFile.get("sUploadMode") == "collection" ? [_aoFile.mailid, _aoFile.attachid, _aoFile.attachname].join("|") : "",
                    ftn: _aoFile.get("bUpToFtn"),
                    bOnlineAttach: _aoFile.get('bOnlineAttach'),
                    loading2GifPath: _oTop.getRes('$images_path$ico_loading21e9c5d.gif')
                });
            ...
            getOnlineAttachIds: function () {
                var _oSelfAttach = this, _oOnlineAttachDom = _oSelfAttach.S("div_onlineAttach"), _oOnlineAttachIds = [],
                    _sOnlineAttachId;
                if (_oOnlineAttachDom) {
                    var os = _oOnlineAttachDom.childNodes;
                    for (var i = 0, len = os.length; i < len; i++) {
    ...
    ;QMOnlineDoc.prototype = {
        addFtnFile2OnlineDoc: function (_aoFtnFile) {
            var _oSelf = this;
            ...
            _oTop.QMAjax.send("/cgi-bin/docedit_new?t=online_doc.json", {
                content: _oTop.T("fun=import&fid=$sFileId$&filename=$sFileName$").replace({
                    sFileId: _sFileId,
                    sFileName: encodeURIComponent(_sFileName)
                }), method: "POST", onload: function (_abIsOk, _asParam) {
            ...
            function checkImport(_asFileId) {
                ...
                setTimeout(function () {
                    _oTop.QMAjax.send("/cgi-bin/docedit_new?t=online_doc.json", {
                        content: _oTop.T("fun=check&key=$sFileId$").replace({sFileId: _asFileId}),
                        method: "POST",
            ...
            function onerror(_asFileId) {
                ...
                _oTop.QMAjax.send("/cgi-bin/docedit_modify?t=online_doc.json", {
                    content: _oTop.TE(["func=del&key=$sFileId$", '$@$if($force$)$@$', '&force=$force$', '$@$endif$@$']).replace({
                        sFileId: _sFileId,
                        force: true
                    }), method: "POST", onload: function (_abIsOk, _asParam) {
                    }
            ...
            if (_oTop.gbIsIE) {
                new (_oTop.QMDialog)({
                    sTitle: _asTitle || "\u6DFB\u52A0\u5728\u7EBF\u6587\u6863",
                    sBodyHtml: _oTop.TE(['<div style="height:401px">', '<div id="" class="ftn_empty" style="padding:60px 0;margin-top:80px;font-size:14px;line-height:20px;color:#000;text-align:center;font-weight: normal;">', '\u5728\u7EBF\u6587\u6863\u6682\u4E0D\u652F\u6301IE\u6D4F\u89C8\u5668\u3002</br>\u5EFA\u8BAE\u4F60\u4F7F\u7528Chrome\u6216\u8005\u5B89\u88C5\u9002\u914D\u66F4\u597D\u7684QQ\u6D4F\u89C8\u5668\u3002', '<a href="http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Email_login.exe" target="_blank">\u7ACB\u5373\u5B89\u88C5</a>', '</div>', '</div>']).replace({}),
                    nWidth: 440,
                    nHeight: 437,
                    onshow: function () {
                    },
                        ...
                        rule: function () {
                            ...
                            return {
                                "addNew": function (_aoEvent, _aoTarget) {
                                    ...
                                    _oDlg.close();
                                    return new (_oTop.QMDialog)({
                                        sId: "selectExistOnlineDocInComposePage",
                                        sTitle: "\u4ECE\u5728\u7EBF\u6587\u6863\u4E2D\u9009\u62E9",
                                        sUrl: "/cgi-bin/docedit_list?t=online_doc_select&page=0&sid=" + _oTop.getSid(),
                                        nWidth: 467,
                                        nHeight: 476,
                                        onshow: function () {
                                        },
            ...
            _oTop.QMAjax.send("/cgi-bin/docedit_read?t=online_doc.json", {
                content: _oTop.T("key=$sFileId$").replace({sFileId: _asOnlineDocKey}),
                method: "POST",
                onload: function (_abIsOk, _asParam) {
                    _oSelf.checkError(_abIsOk, _asParam, function (_oResult) {
                        _oSelf.showDetailDlg({
                            sDlgTitle: "\u5728\u7EBF\u6587\u6863",
                            sDlgBtnDesc: "\u4FDD\u5B58"
                        }, _oResult.oFileInfo);
                    }, function () {
            ...
            var _oSelf = this;
            var _oDialog = new (_oTop.QMDialog)({
                sId: "editOnlineDocInComposePage",
                sTitle: _aoConfig.sDlgTitle || "\u6DFB\u52A0\u5728\u7EBF\u6587\u6863",
                sBodyHtml: _oTop.TE(['<div style="position:absolute;top:36px;bottom:39px;left:0;right:0;">', '<iframe style="display:block;width:100%;height: 100%;border:none;" src="$sOnlineEditUrl$"></iframe>', '<div class="dialog_operate">', '<a id="a_addDoc" ck="addDoc" key="$sFileId$" class="btn_blue btn_space" hidefocus="" href="javascript:;">', _aoConfig.sDlgBtnDesc || "\u6DFB\u52A0", , '</a>', '</div>', '</div>']).replace(_aoFile),
                bDraggable: false,
                nX: "auto",
                nY: "auto",
                sClassName: "newOnlineDocDialog",
                onload: function () {
                    var _oDialog = this;
                    _oTop.liveEvent(_oDialog.S("_content_"), {
                        rule: function () {
                            return {click: {"addDoc": {bPropagable: false}}};
                        }, events: function () {
                            return {
                                "addDoc": function (_aoEvent, _aoTarget) {
                                    var _sFileId = _aoFile.sFileId, _sIsNew = _aoConfig.bIsNew;
                                    if (_sIsNew) {
                                        _oTop.QMAjax.send("/cgi-bin/docedit_modify?t=online_doc.json", {
                                            content: _oTop.TE(["func=add&key=$sFileId$"]).replace({sFileId: _sFileId}),
                                            method: "POST",
                                            onload: function (_abIsOk, _asParam) {
                                                _oSelf.checkError(_abIsOk, _asParam, function (_oResult) {
                                                    doAdd();
            ...
            function doAdd() {
                _oTop.QMAjax.send("/cgi-bin/docedit_read?t=online_doc.json", {
                    content: _oTop.T("key=$sFileId$").replace({sFileId: _aoFile.sFileId}),
                    method: "POST",
                    onload: function (_abIsOk, _asParam) {
                        _oSelf.checkError(_abIsOk, _asParam, function (_oResult) {
                            if (_aoConfig.bIsNew) {
    ...
    QMProcess.prototype = {
        ...
        _initWinFunc: function () {
            ...
            _oWin.doVerifySubmit = function () {
                _oProcess.doProcess('', {
                    card: "card",
                    urlcreator: "save"
                }[_oCompose.getPageId()] || "send", false, false, 99);
            };
        },
        S: function (_asId) {
            return this._moCompose.S(_asId);
            ...
            _oProcess._doProcessSafe(_asTemplate, _asAction, function () {
                ...
                if (!_oEditor) {
                    ...
                    if (_oEditor.getContentTags("sign")[0] && _oEditor.getContentTags("sign").length >= 1) {
                        var _oSigns = _oEditor.getContentTags("sign"), _oEditorDoc = _oEditor.getEditDoc(),
                            _bSendMail = _asTemplate === "" && _asAction === "send",
                            _bSaveDraft = _asTemplate === "savedraft" && _asAction === "save", _sInnerHtml, _oTmpDiv;
                    ...
                    if (_asTemplate != "autosave") {
                        ...
                        if (_oEditor.isRunningShareLink() || _oEditor.hasTODOShareLink()) {
                            ...
                            _oTop.confirmBox({
                                msg: _oEditor.shareLinkErrorCnt() + " \u4E2A\u7F51\u76D8\u6587\u4EF6\u6DFB\u52A0\u5931\u8D25\uFF0C\u5C06\u4ECE\u6B63\u6587\u4E2D\u5220\u9664\u3002\u60A8\u786E\u5B9A\u7EE7\u7EED\u53D1\u9001\uFF1F",
                        ...
                        if (_oProcess.S(_asDomName)) {
                            ...
                            for (var i = 0, len = os.length; i < len; i++) {
                                if (os[i].nodeType == 1 && _oTop.isShow(os[i]) && !_oTop.GelTags("div", os[i]).length) {
                                    ...
                                    var _sFileSize = _oFileSize && _oFileSize.length > 3 && (_oFileSize[1] || _oFileSize[2] || _oFileSize[3].replace(/\s/ig, "")) || "1K",
                                        _sMode = _oTop.attr(os[i], "mode"), _nAppId = _oTop.attr(os[i], "appid"),
                                        _sExpiretimeStr = _nExpiretime > 0 ? _oTop.formatDate(new Date(_nExpiretime * 1000), "$YY$\u5E74$MM$\u6708$DD$\u65E5 $hh$:$mm$") : '';
                                    var _oFileInfo = {
                                        mode: (_sMode != "replaybigattach" && _sMode) || '',
                                        filename: _oTop.htmlEncode(_sFileName),
                                        filesize: _sFileSize,
                                        filetype: _sFileType,
                                        expiretime: _nExpiretime,
                                        expiredtimeString: _nExpiretime == -1 ? "\u65E0\u9650\u671F" : _sExpiretimeStr,
                                        expiredtimeDesc: _nExpiretime == -1 ? "\u65E0\u9650\u671F" : _sExpiretimeStr + " \u5230\u671F",
                                        downloadlink: _oLinker,
                                        appid: _nAppId
                                    };
                    ...
                    function _setBigAttachValue(_asDomName, _asCode) {
                        if (_asCode) {
                            ...
                            if (_bOnlyTextContent) {
                                ...
                                _oCompose.getInputObj(_asDomName, null).value = _oBigAttachTmpl.replace({
                                    domain: _sDomain,
                                    bigattachlist: _asCode
                                });
                            }
                        }
                        else {
                ...
                function _doRealSendProcess() {
                    var _oWin = _oCompose.getWin(),
                        _bIsText = ((_oEditor && (((_oEditor.getContentType && _oEditor.getContentType()) == "text") || (_oEditor._msEditCore == "txt"))) || false),
                        _bIsSend = (_asTemplate === "" && _asAction === "send");
                    ...
                    if (_asAction == "voice" || _asAction == "send" || (_asAction == "card" && _asTemplate == "")) {
                        ...
                        if (_oCompose.getPageId() != "note" && _oVfrm.action.indexOf("/cgi-bin/compose_send") != -1) {
                            ...
                            try {
                                var _oExistList = _oAttach.getExistList(), _oTimeObj = {
                                    cgitm: _oTop.g_cgiTimeStamp || 0,
                                    clitm: _oTop.g_clientTimeStamp || 0,
                                    comtm: _oTop.gSendTimeStart.valueOf(),
                                    logattcnt: _oExistList.length,
                                    logattsize: _oAttach.getAttachSize(),
                                    logattmethod: _oExistList.length ? _oExistList[_oExistList.length - 1].sUploadMode : ""
                                };
                    ...
                    if (_oCompose.getPageId() == "groupsms") {
                        var _sGrpContent = _oEditor.getContent().toLowerCase(), _sPlainText = _oEditor.getContent(true),
                            _sPureText = _oTop.trim(_sPlainText.replace(/&nbsp;/ig, ''));
                ...
                function _doFinishEvent(_abIsNotConfirm) {
                    _oProcess._doProcessSafe(_asTemplate, _asAction, function () {
                        ...
                        if (!_abIsNotConfirm && _oAttach.hasUploadError()) {
                            return _oTop.confirmBox({
                                msg: _asAction == "save" ? "\u4E0A\u4F20\u9644\u4EF6\u51FA\u9519\uFF01\n\u60A8\u786E\u5B9A\u8981\u4FDD\u5B58\u8FD9\u5C01\u7F3A\u5931\u9644\u4EF6\u7684\u90AE\u4EF6\u5417\uFF1F" : "\u4E0A\u4F20\u9644\u4EF6\u51FA\u9519\uFF01\n\u60A8\u786E\u5B9A\u8981\u53D1\u9001\u8FD9\u5C01\u7F3A\u5931\u9644\u4EF6\u7684\u90AE\u4EF6\u5417\uFF1F",
                                onreturn: function (_abIsOk) {
        ...
        _getBigAttachNameList: function (_aoDomNameList) {
            ...
            _oTop.E(_aoDomNameList, function (_asDomName) {
                if (_oProcess.S(_asDomName)) {
                    ...
                    for (var i = 0, len = os.length; i < len; i++) {
                        if (os[i].nodeType == 1 && _oTop.isShow(os[i]) && !_oTop.GelTags("div", os[i]).length) {
                            var _sTmpCode = "", _oSpan = _oTop.GelTags("span", os[i])[1], _oNode = _oSpan.firstChild,
                                _sFileName = _oNode.innerText || _oNode.textContent || "";
        ...
        doProcessCheck: function (_asTemplate, _asAction, _anStartStep, _afDoNextProcess) {
            ...
            try {
                var _oCheckObjs = {}, _oAddrTypeList = ["to", "cc", "bcc", "sc"], _bExistAddr = false,
                    _oErrorAddrs = [], _oErrorQQAddrs = [];
            ...
            try {
                ...
                if (_anStartStep < _nStep) {
                    if (!_oCompose.getComposeVar()._bIsSkinSubject && !_oTop.trim(_sSubject) && (_oCompose.getPageId() == "compose" || _oCompose.getPageId() == "qfcompose") && _asAction == "send") {
                        _oTop.confirmBox({
                            msg: ['<div class="dialog_f_t">\u60A8\u7684\u90AE\u4EF6\u6CA1\u6709\u586B\u5199\u4E3B\u9898\u3002</div>', '<div class="dialog_f_d" style="font-size:14px;">\u60A8\u786E\u5B9A\u7EE7\u7EED\u53D1\u9001\uFF1F</div>'].join(""),
                            width: 430,
                            onreturn: function (_aIsOk) {
                                if (_aIsOk) {
                                    _oWin.setTimeout(function () {
            ...
            try {
                ...
                var _nAttachSize = _oAttach.getAttachSize(), _nLimitSize = _oAttach.getAttachLimit(),
                    _nLimitSizeByAddr = _oAttach.getAttachLimitByAddr();
                ...
                var _bIsExistOtherDomain = false,
                    _sDomainEmail = _oTop.QMAddress && _oTop.QMAddress.getGroupMail() ? "" : "none";
                ...
                if ((_isFtnUploading() && !_isFtnComplete() || _isFtnCenterUploading() && !_isFtnCenterComplete()) && _asTemplate != "autosave") {
                    ...
                    if (_anStartStep < _nStep) {
                        _oTop.confirmBox({
                            ...
                            title: "\u6E29\u99A8\u63D0\u793A",
                            msg: ["\u6709\u8D85\u5927\u9644\u4EF6\u8FD8\u672A\u4E0A\u4F20\u5B8C\u6BD5", _asTemplate == "savedraft" ? "\uFF0C\u672A\u4E0A\u4F20\u5B8C\u7684\u9644\u4EF6\u4E0D\u4F1A\u5728\u8349\u7A3F\u4E2D\u4FDD\u5B58" : "\uFF0C\u73B0\u5728\u5F3A\u884C\u53D1\u9001\u90AE\u4EF6\u5C06\u4F1A\u4E22\u5931\u9644\u4EF6"].join(""),
                            onreturn: function (_abOk) {
                                if (_abOk) {
                                    _afDoNextProcess(_nStep);
                                }
                            }
                    ...
                    if (_oOnlineDocAttachMgr.isUploading() && _asTemplate != "autosave") {
                        ...
                        if (_anStartStep < _nStep) {
                            _oTop.confirmBox({
                                sId: "confirmcheckuploading",
                                title: "\u6E29\u99A8\u63D0\u793A",
                                msg: ["\u6587\u6863\u5BFC\u5165\u672A\u5B8C\u6210\uFF0C", _asTemplate == "savedraft" ? "\u73B0\u5728\u4FDD\u5B58\u8349\u7A3F\u5C06\u4F1A\u4E22\u5931\u9644\u4EF6\u3002" : "\u73B0\u5728\u53D1\u9001\u90AE\u4EF6\u5C06\u4F1A\u4E22\u5931\u9644\u4EF6\u3002"].join(""),
                                onreturn: function (_abOk) {
                                    if (_abOk) {
                                        _afDoNextProcess(_nStep);
                                    }
                    ...
                    if (_oOnlineDocAttachMgr.hasUploadError() && _asTemplate != "autosave") {
                        ...
                        if (_anStartStep < _nStep) {
                            _oTop.confirmBox({
                                sId: "confirmcheckuploading",
                                title: "\u6E29\u99A8\u63D0\u793A",
                                msg: _asTemplate == "savedraft" ? "\u6587\u6863\u5BFC\u5165\u51FA\u9519\uFF01\n\u4F60\u786E\u5B9A\u4FDD\u5B58\u8FD9\u5C01\u7F3A\u5931\u9644\u4EF6\u7684\u90AE\u4EF6\u5417\uFF1F" : "\u6587\u6863\u5BFC\u5165\u51FA\u9519\uFF01\n\u4F60\u786E\u5B9A\u53D1\u9001\u8FD9\u5C01\u7F3A\u5931\u9644\u4EF6\u7684\u90AE\u4EF6\u5417\uFF1F",
                                onreturn: function (_abOk) {
                                    if (_abOk) {
                                        _afDoNextProcess(_nStep);
                                    }
            ...
            if (_anStartStep < _nStep) {
                try {
                    if (_asTemplate != "autosave" && _oCompose._moClipImg && _oCompose._moClipImg.isUploading()) {
                        _oTop.confirmBox({
                            sId: "confirmcheckclipimguploading",
                            title: "\u6E29\u99A8\u63D0\u793A",
                            msg: ["\u6709\u5185\u5D4C\u56FE\u7247\u8FD8\u672A\u4E0A\u4F20\u5B8C\u6BD5", _asTemplate == "savedraft" ? "\uFF0C\u672A\u4E0A\u4F20\u5B8C\u7684\u56FE\u7247\u4E0D\u4F1A\u5728\u8349\u7A3F\u4E2D\u4FDD\u5B58" : "\uFF0C\u73B0\u5728\u5F3A\u884C\u53D1\u9001\u90AE\u4EF6\u5C06\u4F1A\u4E22\u5931\u56FE\u7247"].join(""),
                            onreturn: function (_abOk) {
                                if (_abOk) {
                ...
                try {
                    ...
                    if (!_oCompose.getComposeVar()._bIsSkinNoAttach && _asTemplate != "savedraft" && _asTemplate != "autosave" && _sSubTmpl != "reply" && _sSubTmpl != "reply_all" && _sSubTmpl != "forward" && _sSubTmpl != "draft" && _sSubTmpl != "content" && _oProcess.S("AttachFrame") && !_oAttach.hasAttach(true)) {
                        ...
                        if (!_oAttach.isUploading() && (_sSubject.indexOf("\u9644\u4EF6") != -1 || _sContent.indexOf("\u9644\u4EF6") != -1 || _sSubject.search(_sPatt) != -1 || _sContent.search(_sPatt) != -1)) {
                            _oTop.confirmBox({
                                msg: ['<div style="padding:0 10px 0 0;"><b>', '\u60A8\u7684\u90AE\u4EF6\u5185\u5BB9\u63D0\u5230\u9644\u4EF6\uFF0C\u4F46\u60A8\u53EF\u80FD\u5FD8\u8BB0\u4E86\u6DFB\u52A0\u9644\u4EF6\u3002', '</b></div>', '<div>', '\u60A8\u786E\u5B9A\u7EE7\u7EED\u53D1\u9001\uFF1F', '</div>'].join(""),
                                width: 430,
                                onreturn: function (_abIsOk) {
                                    if (_abIsOk) {
            ...
            if (_anStartStep < _nStep) {
                ...
                if (_oCompose.getPageId() == "compose" && _oInput && !_oInput.checked) {
                    _oTop.QMAjax.send(_oTop.T("/cgi-bin/tip?sid=$sid$&args=savesendbox,28&t=tipcheck").replace({sid: _oTop.getSid()}), {
                        method: "GET", timeout: 500, onload: function (_abIsOk, _asParam) {
                            if (_abIsOk) {
                                if (_asParam == "1") {
                                    _oTop.confirmBox({
                                        title: "\u63D0\u793A",
                                        msg: ['<div class="dialog_f_t">\u60A8\u6240\u53D1\u51FA\u7684\u90AE\u4EF6\u5C06\u4E0D\u4FDD\u5B58\u5230\u201C\u5DF2\u53D1\u9001\u201D\u4E2D</div>', '<div class="dialog_f_d">', '<div style="margin-bottom: 6px; margin-top: 5px;">\u8FD9\u53EF\u80FD\u662F\u60A8\u5728\u8BBE\u7F6E\u4E2D\u53D6\u6D88\u4E86\u8BE5\u9009\u9879\uFF0C\u60A8\u53EF\u4EE5\uFF1A</div> ', '<input type="radio" checked="checked" id="csavesendbox" value="1" name="cssb"><label for="csavesendbox">\u8BBE\u7F6E\u4E3A\u81EA\u52A8\u4FDD\u5B58\uFF0C\u5E76\u7EE7\u7EED\u53D1\u4FE1</label><br>', '<input type="radio" value="0" name="cssb" id="cdonotsavesendbox"><label for="cdonotsavesendbox">\u4E0D\u4FDD\u5B58\uFF0C\u7EE7\u7EED\u53D1\u4FE1</label>', '</div>'].join(""),
                                        onreturn: function (_abIsOk) {
                                            if (_abIsOk) {
                                                if (this.S("csavesendbox").checked) {
                                                    _oInput.checked = true;
                                                    _oTop.QMAjax.send(_oTop.T("/cgi-bin/setting1?sid=$sid$&savesendbox=0&fun=submit&loc=send,save,1,0").replace({sid: _oTop.getSid()}), {
                                                        method: "POST", timeout: 500, onload: function () {
            ...
            if (_anStartStep < _nStep && _oCompose.getPageId() != 'card' && _oCompose.getPageId() != 'voice' && _oCompose.getPageId() != 'postcard' && _oCompose.getPageId() != "group") {
                var _oAttachExistList = _oCompose.moAttach.getExistList(),
                    _oBigAttachExistList = _oProcess._getBigAttachNameList(["ResumeWorks", "BigAttach", "exist_BigAttach"]),
                    _sSubject = _oTop.isShow(_oProcess.S("subject")) ? _oProcess.S("subject").value : "",
                    _sContent = _oCompose.getPageEditor().getContent(true), _sAliasName = getUserInfo("alias"), _sName,
                    _bIsPassChecked = true, _sResumePatt = /resume|\u7B80\u5386|\u5E94\u8058/ig;
                var _bshowResumeConfirmFlag = QMLocalStorage.getUserItem("showResumeConfirmFlag"),
                    _oShowResumeConfirmFlagDom = _oProcess.S("ipt_showResumeConfirmFlag"),
                    _bIsHasShowResumeConfirm = (_bshowResumeConfirmFlag == "2" || (_oShowResumeConfirmFlagDom && (_oShowResumeConfirmFlagDom.value == "2")));
                if (_asAction != "save" && _asTemplate != "savedraft" && _asTemplate != "autosave" && _oCompose.getPageId() != "note" && !_bIsHasShowResumeConfirm) {
                    ...
                    if (!_bHasShowConfirmName && !_bIsPassChecked) {
                        new QMDialog({
                            ...
                            sTitle: "\u786E\u8BA4\u4F60\u7684\u53D1\u4FE1\u6635\u79F0",
                            sBodyHtml: TE(['<div class="resume_confirmName">', '<span class="dialog_icon qui_icoPrompt qui_icoPrompt_InfoB"></span>', '<div class="resume_confirmName_cnt">', '<div class="resume_confirmName_tip">\u4F60\u6B63\u5728\u4F7F\u7528\u6635\u79F0\u300E$sAliasName$\u300F\u53D1\u9001\u8FD9\u5C01\u90AE\u4EF6\u3002\u5982\u9700\u4FEE\u6539\uFF0C\u8BF7\u70B9\u51FB\u300E\u4FEE\u6539\u6635\u79F0\u300F\uFF0C\u6216\u5728\u5DE6\u4E0B\u89D2\u53D1\u4EF6\u4EBA\u5904\u4FEE\u6539\u3002</div>', '<div class="resume_confirmName_img"></div>', '</div>', '</div>']).replace({
                                images_path: getPath("images"),
                                sAliasName: _sAliasName
                            }),
                            sFootHtml: '<a id="a_continue" class="qui_btn qui_btn_Space" href="javascript:;">\u7EE7\u7EED\u53D1\u9001</a><a id="a_reedit_aliasname" class="qui_btn qui_btn_Space" href="javascript:;">\u4FEE\u6539\u6635\u79F0</a><a id="a_cancel" class="qui_btn" href="javascript:;">\u53D6\u6D88</a>',
                            nWidth: 550,
                            onshow: function () {
                                var _oSelf = this;
                    ...
                    try {
                        var _oSendAddr = _oCompose.S("sendmailname"),
                            _sSendEmail = _oSendAddr && _oSendAddr.value || _oTop.getUserInfo('addr') || "",
                            _oNumEmailReg = /[0-9]+@qq.com/i;
                    ...
                    if (!_bIsPassChecked && _bShowEmailSecConfirm) {
                        new QMDialog({
                            ...
                            sTitle: "\u786E\u8BA4\u4F60\u7684\u53D1\u4FE1\u5E10\u53F7",
                            sBodyHtml: TE(['<div class="resume_confirmName">', '<span class="dialog_icon qui_icoPrompt qui_icoPrompt_InfoB"></span>', '<div class="resume_confirmName_cnt">', '<div class="resume_confirmName_tip">\u4F60\u6B63\u5728\u4F7F\u7528\u6570\u5B57\u90AE\u7BB1\u5E10\u53F7\u53D1\u9001\u8FD9\u5C01\u90AE\u4EF6\u3002\u5EFA\u8BAE\u5207\u6362\u4E3A\u82F1\u6587\u90AE\u7BB1\u5E10\u53F7\uFF0C\u66F4\u4E3A\u4E13\u4E1A\u3002</div>', '<div class="resume_confirmEmail_img"></div>', '</div>', '</div>']).replace({}),
                            sFootHtml: '<a id="a_continue" class="qui_btn qui_btn_Space" href="javascript:;">\u7EE7\u7EED\u53D1\u9001</a><a id="a_reedit_aliasname" class="qui_btn qui_btn_Space" href="javascript:;">\u5207\u6362\u5E10\u53F7</a><a id="a_cancel" class="qui_btn" href="javascript:;">\u53D6\u6D88</a>',
                            nWidth: 550,
                            onshow: function () {
                                var _oSelf = this;
                                _oSelf.S("a_cancel").onclick = function () {
        ...
        _saveResumeConfirmed: function (type) {
            ...
            _oTop.QMAjax.send("/cgi-bin/do", {
                content: _sUrlParam, method: "POST", onload: function (_abIsOk) {
                    if (_abIsOk) {
        ...
        _composeFormSubmit: function (_aoForm, _asTemplate, _afCallback) {
            ...
            if ("save" != _aoForm.actiontype.value && _oCompose._isUseBackgroundSend()) {
                ...
                _oTop.waitFor(function () {
                    ...
                    var _oCpsLib = _oTop.ComposeLib, _oFormData = _oCpsLib.getFormData(_aoForm),
                        _sCgiPath = _aoForm.getAttribute("action") || "", _sSection = _oFormData.s,
                        _sActionType = _fGetActionType();
                    ...
                    _oCpsLib.send(_oTop.extend(_oFormData, {
                        cginame: _sCgiPath.replace(/^.*?\/cgi-bin\/(\w+).*$/gi, "$1"),
                        ef: "js",
                        t: "compose_send.json"
                    }), {
                        sType: "nil",
                        nTimeout: 2 * 60 * 1000,
                        sSendingDesc: _oTop.TE(['$@$if($type$=="note")$@$', '\u8BB0\u4E8B\u6B63\u5728\u4FDD\u5B58\u4E2D', '$@$else if($type$=="urlcreator")$@$', '\u7F51\u9875\u6B63\u5728\u4FDD\u5B58\u4E2D', '$@$else if($sendtime$==1)$@$', '$@$if($s$=="comm")$@$', '\u90AE\u4EF6\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$else if($s$=="card")$@$', '\u8D3A\u5361\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$else if($s$=="postcard")$@$', '\u660E\u4FE1\u7247\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$else if($s$=="video")$@$', '\u89C6\u9891\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$else if($s$=="voice")$@$', '\u97F3\u9891\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$endif$@$', '$@$else$@$', '$@$if($handleString$=="send")$@$', '\u90AE\u4EF6\u6B63\u5728\u53D1\u9001\u4E2D', '$@$else if($s$=="group")$@$', '\u90AE\u4EF6\u6B63\u5728\u4FDD\u5B58\u5230\u7FA4\u90AE\u4EF6\u8349\u7A3F\u7BB1', '$@$else$@$', '\u90AE\u4EF6\u6B63\u5728\u4FDD\u5B58\u5230\u8349\u7A3F\u7BB1', '$@$endif$@$', '$@$endif$@$', '... [<a onclick="ComposeLib.abort();" nocheck="true" style="color:white;">\u53D6\u6D88</a>]']).replace({
                            handleString: "save" != _sActionType ? "send" : "save",
                            sendtime: _oFormData.sendtime,
                            s: _oFormData.s,
                            type: _oCompose.getPageId()
                        }),
                        sCgiPath: _sCgiPath,
                        bCancelable: true,
                        onready: function () {
                                ...
                                if (typeof (_oResp.errcode) == "undefined") {
                                    ...
                                    if (_oScriptMatch) {
                                        ...
                                        if (_oResp.errcode == "-151") {
                                            ...
                                            var _sVirusAttNameTemp = _oResp.errmsg.match("sVirusAttName=.*?(?=,)"),
                                                _sMatchRulesTemp = _oResp.errmsg.match("sMatchRules=.*?(?=;)"),
                                                ...
                                                _sVirusAttName = _oVirusAttNameTemp && _oVirusAttNameTemp[1],
                                                _sMatchRules = _oMatchRulesTemp && _oMatchRulesTemp[1];
                                            _sVirusAttName && _sMatchRules && _oTop.alertBox({
                                                title: "\u75C5\u6BD2\u63D0\u9192",
                                                msg: _oTop.T(['<div class="dialog_f_t">\u60A8\u7684\u9644\u4EF6\u88AB\u68C0\u6D4B\u51FA\u542B\u6709\u75C5\u6BD2\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\u3002</div>', '<div class="dialog_f_d" style="margin-top:4px;">', '<span class="addrtitle">\u6587\u4EF6\u540D\uFF1A</span>', '<span class="tf" style="display:inline-block;width:242px;margin-top:-3px;vertical-align:middle;">$sVirusAttName$</span>', '<br /><span class="addrtitle">\u75C5\u6BD2\u540D\uFF1A</span>$sMatchRules$', '<div class="graytext"><span class="ico_Avira"></span>\u68C0\u6D4B\u7ED3\u679C\u7531\u7535\u8111\u7BA1\u5BB6\u4E91\u67E5\u6740\u5F15\u64CE\u63D0\u4F9B</div>', '</div>']).replace({
                                                    sVirusAttName: _sVirusAttName.substr(1, _sVirusAttName.length - 2),
                                                    sMatchRules: _sMatchRules.substr(1, _sMatchRules.length - 2)
                                                })
                                            });
                                        }
                                        _oWin.setTimeout(function () {
                                    ...
                                    _oTop.ComposeResp.handle({
                                        sType: _sActionType,
                                        sModule: _oCompose.getPageId(),
                                        oPostData: _oFormData,
                                        oRespData: _oResp,
    ...
    function initComposeForPage(_asPageId, _aoWin, _aoConfig) {
        ...
        _oTop.liveEvent(_aoWin.document.body, {
            rule: function () {
    ...
    QMComposePageMain.prototype = {
        _oInitFuncMap: {
            "compose": '_initEditorForComposePage',
            "group": '_initEditorForGroupPage',
            "groupsms": '_initEditorForGroupSmsPage',
            "card": '_initEditorForCardPage',
            "voice": '_initEditorForVoicePage',
            "postcard": '_initForPostcardPage',
            "qq": '_initEditorForQQPage',
            "readmailGroup": '_initEditorForReadMailGroupPage',
            "note": '_initEditorForNotePage',
            "noteFirstPage": '_initEditorForNoteFirstPage',
            "remind": '_initForRemindPage',
            "readmailConv": '_initForReadmailConv',
            "urlcreator": '_initEditorForHelper',
            "qzone": '_initEditorForHelper',
            "qfcompose": '_initEditorForQfCompose',
            "none": '_initEmpty'
        },
        _oWinProxyFuncArr: ['openNewWinEdit', 'getPageId', 'getPageEditor', 'attachInsertImage', 'attachInsertFile', 'existAttachInsertFile', 'doAttachInsertFile', 'focusPageEditor', 'changeContentType', 'tryListenBgMusic', 'noteFirstPageQuickSave', 'initColorSubject', 'showSubjectMsg', 'hideRightArea', 'initCookieSetting', 'loadValue', 'setNeedCloseConform', 'closePage', 'exitConfirm', 'saveContentGoUrl', 'selectGroup', 'useStationery', 'useStationery_new', 'changeTab', 'autoSave', 'clearLocalStorage', 'clearAutoSave', 'enableAutoSave', 'initFileTransporter', 'setComposeData', 'QQMailPreviewContent', 'setDefSign', 'setSignature', 'doFtnUploaded', 'initResumeData', 'initCardListPage', "showAddOnlineDocDlg", "initOnlineDocData"],
        _oWinNeedRunFuncArr: ['showInstallActiveXDialog'],
        _oWinUtilFuncArr: {
            'filterSourceContent': filterSourceContent,
            'redirectExitURLId': redirectExitURLId,
            'sendAfterUpload': sendAfterUpload,
            'getNoteFirstPageSource': getNoteFirstPageSource
        },
        getWin: function () {
            return this._moWin;
        },
        ...
        _initVar: function () {
            var _oCompose = this;
            var _oWin = _oCompose.getWin();
            _oWin.goCompose = _oCompose._moComposeVar = {
                ...
                _sDomainEmail: "",
                _bIsUserSave: false,
                _oAutoSaveTimer: null,
                _oAutoSaveLocalTimer: null,
                _bIsSkinSubject: false,
                _bIsAlarmedBigAttach: false,
                _bIsSkinNoAttach: false,
                _bAttachHasChecked: false,
                _bIsAlarmNickName: false,
                _bIsAlarmedDomainAddr: false,
                _oDomainChecker: null,
                sIphoneUpImgKey: "",
                oRecentGroupConf: ["to", "cc", "bcc"]
            };
        ...
        _initWinFunc: function () {
            ...
            _oWin.addBigAttach = function (_asExpireTime, _asFileName, _asSize, _asUrl, _asCode, _asFid, _aoCfg) {
                if (_oAttach.mbHideBigAttach) {
                    ...
                    _oCompose._addExistBigAttach([{
                        id: _asFid,
                        filesize: _asSize,
                        filename: _asFileName,
                        downloadlink: _asUrl,
                        code: _asCode,
                        key: _asUrl.replace(/^(.*?\?k=)([0-9a-zA-Z]+)(.*)?$/gi, "$2"),
                        fid: _asFid,
                        exptime: _asExpireTime,
                        nExpireTime: _aoCfg && _aoCfg.nExpireTime || -1
                    }]);
                    _oCompose.setEditedAttach(true);
                }
            };
        ...
        _initButtonEvent: function (_aoConfig) {
            ...
            function _doTimeSend(_aoEvent, _abNotCheck, _anCheckStartStep) {
                ...
                initTimeSendDlg({
                    sendtimeyear: _oCompose.getInputObj("sendtimeyear"),
                    sendtimemonth: _oCompose.getInputObj("sendtimemonth"),
                    sendtimeday: _oCompose.getInputObj("sendtimeday"),
                    sendtimehour: _oCompose.getInputObj("sendtimehour"),
                    sendtimemin: _oCompose.getInputObj("sendtimemin"),
                    confirmbtn: "\u53D1\u9001",
                    title: "\u5B9A\u65F6\u53D1\u9001",
                    timetips: _oSendTimeTip && _oSendTimeTip.value || "\u9009\u62E9\u5B9A\u65F6\u53D1\u9001\u7684\u65F6\u95F4\uFF1A"
                }, function (_aoObj) {
            ...
            if (_oNoLetterBtn) {
                _oNoLetterBtn.onclick = function () {
                    var _oEditor = _oCompose.getPageEditor(),
                        _oQQmailStationery = _oEditor.getContentObj("QQMAILSTATIONERY");
            ...
            if (_oMobileEmailBtn) {
                var _sDefSender = _oTop.goUserInfo.get('RealDefaulSender'), _sMobileEmail = _getOneSender("phone", "1"),
                    _fHandleME;
                if (_sMobileEmail) {
                    _fHandleME = function () {
                        if (_oMobileEmailBtn.checked) {
                            _oTop.confirmBox({
                                msg: _oTop.T(['<div class="dialog_f_t">\u662F\u5426\u4E34\u65F6\u6539\u7528$email$\u6765\u53D1\u4FE1?</div>', '<div class="dialog_f_d">\u5BF9\u65B9\u56DE\u4FE1\u5230\u6B64\u5730\u5740\uFF0C\u76F8\u5E94\u624B\u673A\u4E0A\u4F1A\u7ACB\u5373\u6536\u5230\u77ED\u4FE1\u63D0\u9192\u3002</div>']).replace({email: _sMobileEmail}),
                                width: 450,
                                onreturn: function (_aIsOk) {
                                    if (_aIsOk) {
                    ...
                    _fHandleME = function () {
                        ...
                        _oTop.confirmBox({
                            msg: ['<div class="dialog_f_t">\u60A8\u9700\u8981\u5148\u6CE8\u518C\u624B\u673A\u53F7\u90AE\u7BB1\uFF0C\u624D\u80FD\u5F00\u542F\u6B64\u529F\u80FD\u3002</div>', '<div class="dialog_f_d">\u624B\u673A\u53F7\u90AE\u7BB1\u53CA\u9644\u5C5E\u77ED\u4FE1\u63D0\u9192\u90FD\u662F\u514D\u8D39\u7684\u3002<br>\u5F00\u901A\u540E\u5728\u4E0B\u6B21\u5199\u4FE1\u65F6\u624D\u53EF\u4F7F\u7528\u63D0\u9192\u529F\u80FD\u3002</div>'].join(""),
                            width: 430,
        ...
        _initEditorForHelper: function (_asPageId, _aoConfig) {
            ...
            var _oEditor = _oTop.QMEditor.createEditor({
                editorId: _asPageId,
                editorAreaWin: _oWin,
                funclist: _oFuncList,
                photoCGI: _oTop.getPhotoCGI(),
                customtags: _getCustomTagList(),
                isOpenEditBar: true,
                funcConfig: {Photo: {album: true, attach: true, iPhoneUpload: true}},
                nAutoRisizeMinHeight: 319,
                onload: _fOnLoad,
                onfocus: _oCompose._editorFocus(),
                onmousedown: _oCompose._doEditorMouseDown(),
                onbeforesaverange: _oCompose._fixStationeryCursorPos(),
                onkeydown: _oCompose._composeKeyDown(),
                onkeyup: _oCompose._composeKeyUp(),
                onputcontent: _oCompose._fixBodyPadding(),
                onchangecontenttype: _oCompose._onChangeContentTypeEvent(),
                onshowinstallactive: _oCompose.showInstallActiveXDialog(),
                onpreview: _oCompose._showPreview()
        ...
        _initEditorForQfCompose: function (_asPageId, _aoConfig) {
            ...
            _oTop.QMEditor.createEditor({
                ...
                onbeforesaverange: _oCompose._fixStationeryCursorPos(),
                onkeydown: _oCompose._composeKeyDown(),
                onpaste: _oCompose._pasteUrlAnalyse(),
                onputcontent: _oCompose._fixBodyPadding(),
                onchangecontenttype: _oCompose._onChangeContentTypeEvent(),
                onchangebgmusic: _oCompose._changeEditorBgMusic(),
                onshowinstallactive: _oCompose.showInstallActiveXDialog(),
                onpreview: _oCompose._showPreview(),
                onuploademl: _uploadComposeEml
            }).initialize(_aoConfig.source, false, _oCompose.S("QMEditorArea").getAttribute("tIndex") || 3, _oCompose.S("QMEditorArea").getAttribute("accKey"));
        },
        _initEditorForComposePage: function (_asPageId, _aoConfig) {
            ...
            var _fOnLoad = function () {
                var _oEditor = _oCompose.getPageEditor(), _oReloadInfo = _oCompose._reloadSaveContent(_aoConfig),
                    _bFromReload = false, _bFromeCache = false, _sSubTmpl = _oCompose.getPageConfig().subtmpl;
                ...
                _oCompose.getComposeVar().oQmSender = new _oTop.QMSender({
                    oWin: _oWin,
                    nCurFolderId: _aoConfig.folderid,
                    sCurSaveFrom: _sFrom,
                    sWidth: 180,
                    bShowNode: "parentNode",
                    sVerAlign: "top",
                    bDraft: _aoConfig.subtmpl == "draft",
                    bFromReload: _bFromReload,
                    onclickItemCallBack: function (_aoData) {
            ...
            var _oEditor = _oTop.QMEditor.createEditor({
                editorId: _asPageId,
                editorAreaWin: _oWin,
                funclist: _oTop.QMEditor.CONST.FUNCLIST.COMPOSE,
                photoCGI: _oTop.getPhotoCGI(),
                customtags: _getCustomTagList(),
                isOpenEditBar: true,
                funcConfig: {Photo: {album: true, attach: true, iPhoneUpload: true}},
                nAutoRisizeMinHeight: 319,
                isNoEditScroll: _oTop.location.href.indexOf("from_wm_newwin") == -1 ? false : true,
                onload: function () {
                ...
                onfocus: _oCompose._editorFocus(),
                onblur: _oCompose._editorBlur(),
                onmousedown: _oCompose._doEditorMouseDown(),
                onmouseover: _oCompose._composeMouseOver(),
                onmouseout: _oCompose._composeMouseOut(),
                onbeforesaverange: _oCompose._fixStationeryCursorPos(),
                ...
                onpreview: _oCompose._showPreview(),
                fullscreenCfg: {
                    funclist: {toolbar: _oTop.QMEditor.CONST.FUNCLIST.COMPOSE.toolbar + ' | Photo Word ScreenSnap Mo'},
                    onfullscreenshow: function (_aoFullEditor) {
                    ...
                    onload: function (_aoFullEditor) {
                        _oAttach.initDragFileUpload({
                            oWin: _oTop,
                            oImgUploadArea: _aoFullEditor.getEditorArea(),
                            oEditor: _aoFullEditor,
                            bNoFileUplad: true
                        });
                    }
                }
        ...
        _initEditorForGroupPage: function (_asPageId, _aoConfig) {
            ...
            _oTop.QMEditor.createEditor({
                editorId: _asPageId,
                editorAreaWin: _oWin,
                funclist: _oTop.QMEditor.CONST.FUNCLIST.GROUP,
                photoCGI: _oTop.getPhotoCGI(),
                photoConfig: {widthlimit: 1024, heightlimit: 1024, sizelimit: 1},
                customtags: _getCustomTagList(),
                isOpenEditBar: true,
                nAutoRisizeMinHeight: 319,
                ...
                onpreview: _oCompose._showPreview(),
                fullscreenCfg: {
                    funclist: {toolbar: _oTop.QMEditor.CONST.FUNCLIST.GROUP.toolbar + ' | Photo Word ScreenSnap Mo'},
                    onfullscreenshow: function (_aoFullEditor) {
                        var _oWordToolbar = _aoFullEditor.getToolBarInfo('Word');
                        if (_oWordToolbar && _oWordToolbar.funcObj) {
                            delete _oWordToolbar.funcObj;
        ...
        _initEditorForGroupSmsPage: function (_asPageId, _aoConfig) {
            ...
            _oTop.QMEditor.createEditor({
                editorId: _asPageId,
                editorAreaWin: _oWin,
                height: _oTop.getStyle(_oEditorArea, "height"),
                funclist: _oTop.QMEditor.CONST.FUNCLIST.GROUP,
                photoCGI: _oTop.getPhotoCGI(),
                photoConfig: {widthlimit: 1024, heightlimit: 1024, sizelimit: 1},
                customtags: _getCustomTagList(),
                onload: _oCompose._editorOnLoader(_fOnLoad),
                onfocus: _fOnFocus,
                onblur: _fOnBlur,
                onmousedown: _oCompose._doEditorMouseDown(),
                onkeydown: _fOnKeyDown,
                onpaste: _fOnKeyDown,
                onshowinstallactive: _oCompose.showInstallActiveXDialog()
            }).initialize(_aoConfig.source || _outputDataLoading(), false, 5);
            var _oEditor = null, _oToolContainer = _oCompose.S('editorToolContainer'), _oEditorIframe, _oEditorWin,
                _oEditorDoc, _nNORMALHEIGHT = 62, _nMINHEIGHT = 62, _nMinHeight, _nMaxHeight,
                _nRawWrapperHeight = +_oEditorArea.clientHeight, _nTimerId;
            ...
            var _oQuickEditorCntr = _oCompose.S('quickEditorContainer'), _oFullModeLink = _oCompose.S('fullModeLink'),
                _oFoldLink = _oCompose.S('foldLink'), _oExpandLink = _oCompose.S('expandLink');
            if (_oFullModeLink && _oFoldLink && _oExpandLink) {
                ...
                _oFullModeLink.onclick = function () {
                    ...
                    var _sGrpContent = _oEditor.getContent().toLowerCase(), _sPlainText = _oEditor.getContent(true),
                        _sPureText = _oTop.trim(_sPlainText.replace(/&nbsp;/ig, '')),
                        _oVfrm = _oCompose._getSubmitForm(), _oFileCell = _oCompose.S('filecell'),
                        _oBigAttach = _oCompose.S('BigAttach');
                    if (_oFileCell.innerHTML.length > 10 || _oBigAttach.innerHTML.length > 10 || _oVfrm.mailtype.value == 'vote') {
                        _oTop.confirmBox({
                            msg: ['<div class="dialog_f_t">\u5207\u6362\u5230\u5B8C\u6574\u683C\u5F0F\u4F1A\u4E22\u5931\u9644\u4EF6\u548C\u6295\u7968\u6570\u636E\u3002</div>', '<div class="dialog_f_d" style="font-size:14px;">\u60A8\u786E\u5B9A\u7EE7\u7EED\u5207\u6362\uFF1F</div>'].join(""),
                            width: 430,
                            onreturn: function (_aIsOk) {
                                if (_aIsOk) {
                                    _toFullMode();
            ...
            function _expand(_aoDom, _abExpand, _afComplete) {
                ...
                _oAnimation[_abExpand ? 'expand' : 'fold'](_aoDom, {
                    durlimit: 300, type: 'wait', speed: 'fast', oncomplete: function () {
                        _afComplete();
        ...
        _initEditorForVoicePage: function (_asPageId, _aoConfig) {
            ...
            getTop().QMEditor.createEditor({
                ...
                onload: _oCompose._editorOnLoader(_fOnLoad),
                onkeydown: _oCompose._composeKeyDown()
            }).initialize(_aoConfig.source, false, 3);
            _oCompose._reloadSaveContent(_aoConfig);
        },
        ...
        _initEditorForReadMailGroupPage: function (_asPageId, _aoConfig) {
            ...
            getTop().QMEditor.createEditor({
                ...
                onload: _fOnLoad,
                onkeydown: _oCompose._composeKeyDown()
            }).initialize(_aoConfig.source, false);
        },
        _initEditorForNoteFirstPage: function (_asPageId, _aoConfig) {
            ...
            getTop().QMEditor.createEditor({
                editorId: _asPageId,
                editorAreaWin: _oWin,
                height: _aoConfig.height || getTop().getStyle(_oCompose.S("QMEditorArea"), "height"),
                isNoEditScroll: true,
                onmousedown: _oCompose._doEditorMouseDown(),
                onkeydown: _oCompose._composeKeyDown(),
                onpaste: function () {
        ...
        _initForReadmailConv: function (_asPageId, _aoConfig) {
            ...
            getTop().QMEditor.createEditor({
                ...
                onchangecontenttype: _oCompose._onChangeContentTypeEvent(),
                onshowinstallactive: _oCompose.showInstallActiveXDialog()
            }).initialize("", false, _oCompose.S("QMEditorArea").getAttribute("tIndex"), _oCompose.S("QMEditorArea").getAttribute("accKey"));
        },
        ...
        getInputObj: function (_asName, _aoFrm, _abDisabled) {
            ...
            if (!_obj) {
                _oTop.insertHTML(_oFrm, "afterBegin", _oTop.T('<input name="$name$" type="hidden" $disabled$/>').replace({
                    name: _asName,
                    disabled: _abDisabled ? "disabled" : ""
                }));
                _obj = _oFrm[_asName];
            }
            return _obj;
        ...
        _isContentEdited: function () {
            var _oCompose = this;
            var _oCtrls = _oCompose._oLoadValueCtrls, _oCache = _oCompose._oLoadValueCache,
                _fClean = function (_asHtml) {
        ...
        _reloadSaveContent: function (_aoConfig) {
            ...
            if (!!_oReloadInfo) {
                var _sBigAttachCode = _oReloadInfo.bacode, _sExistFileCode = _oReloadInfo.excode,
                    _sOnlineDocCode = _oReloadInfo.sOnlineDocCode,
                    _bHideBigAttach = _aoConfig && _aoConfig.hideBigAttach,
                    _oFileUploadData = _oReloadInfo.fileuploaddata, _oSubjectDom = _oCompose.S("subject"),
                    _oBigAttachDom = _oCompose.S("BigAttach"), _oExistFileDom = _oCompose.S("exist_file"),
                    _sOnlineDocAttachDom = _oCompose.S("div_onlineAttach"), _oEditor = _oCompose.getPageEditor();
        ...
        _doResumeAttachInsertFile: function (_asUrl, _afCheckEditorType) {
            ...
            _oTop.createIframe(_oWin, _asUrl + '&nocmd=true', {
                onload: function (_aoWin, _asId, _aoIframe) {
                    try {
            ...
            _oTop.QMAjax.send(_asUrl, {
                onload: function (_abOK, _asData) {
                    if (_abOK && _asData && ('' + _asData).indexOf('<!--cgi exception-->') !== 0) {
                        ...
                        _oTop.getOfficeRealContent(_asData, {
                            onload: function (_abOK, _asData) {
                                if (_abOK) {
                                    _addContent(_asData);
                                }
            ...
            var _oEditor = _oCompose.getPageEditor(), _fGenFileList = function (_aoList) {
                ...
                _oTop.E(_aoList, function (_aoItem) {
                    _oList.push({
                        ...
                        sLink: _aoItem.furl,
                        sName: _aoItem.fname,
                        sFileSize: _aoItem.fsize,
                        sIconUrl: _oTop.getIconByExt(_aoItem.fname.split(".").pop())
                    });
                });
                return _oList;
            };
        ...
        _setEditorSource: function (_aoConfig, _abClearId, _anBreakLinkNum) {
            ...
            var _sSource = (_oCompose.S("source") && _oCompose.S("source").innerHTML),
                _sSignVal = _oTop.goUserInfo.get('getRealUserSignature') ? (_oTop.goUserInfo.get('getRealUserSignature'))(_aoConfig.folderid, _aoConfig.saveFrom) : null,
                _bNoMore = _aoConfig.subtmpl == "draft" || _aoConfig.subtmpl == "content" || _aoConfig.subtmpl == "background" || _aoConfig.subtmpl === "from_star_list",
                _oContent = [], _oEditor = _oCompose.getPageEditor();
            ...
            if (!_bNoMore) {
                ...
                if (_aoConfig.pluscontent) {
                    ...
                    _oContent.push(_oTop.QMEditor.getBreakLine(_anBreakLinkNum || (_oTop.filteSignatureTag(_sSignVal) ? 2 : 1), {
                        family: _oTop.goUserInfo.get("DEF_FONT_FAMILY"),
                        size: _oTop.goUserInfo.get("DEF_FONT_SIZE"),
                        color: _oTop.goUserInfo.get("DEF_FONT_COLOR")
                    }));
                }
        ...
        _changeEditorBgMusic: function () {
            ...
            return function () {
                ...
                _oBgMusicContainer.firstChild.innerHTML = _oTop.T(['<span style="word-break:break-all;"><span class="graytext">\u80CC\u666F\u97F3\u4E50\uFF1A</span>$bgmusic$</span>', '<a style="margin:0 5px 0 10px;" onclick="', 'if ( confirm( \x27\u60A8\u786E\u8BA4\u5220\u9664\u8BE5\u80CC\u666F\u97F3\u4E50\uFF1F\x27 ) ) {', 'getTop().audioStop();', 'getPageEditor().setBgMusicInfo();', '}', '">\u5220\u9664</a>', '<a onclick="', 'tryListenBgMusic( this );', '" >\u8BD5\u542C</a>']).replace({
                    bgmusic: _oInfo.song ? _oTop.T("$song$($singer$)").replace({
                        song: _oInfo.song,
                        singer: _oInfo.singer
                    }) : _oTop.htmlEncode(_oInfo.url)
                });
                _oTop.audioStop();
            ...
            return function () {
                ...
                if (_oEditor) {
                    ...
                    if (_oQQmailStationery) {
                        ...
                        if (_oQMAddrInput) {
                            var _oTo = _oQMAddrInput.get("to", _oWin), _oTop = getTop(),
                                _sOwnQz = [_oTop.getUin(), "@qzone.qq.com"].join("");
                            if (_oTo) {
        ...
        _fixBodyPadding: function () {
            var _oCompose = this;
            return function () {
                var _oQQmailStationery = this.getContentObj("QQMAILSTATIONERY"),
                    _oNoLetterBtn = _oCompose.S("noletter");
                ...
                if ((!_oCompose.S("subject").value || _oCompose.S("subject").value == (_oSampleSubject && _oSampleSubject.value)) && !_oCompose._oPasteUrlAnalyseProcess) {
                    ...
                    _oWin.setTimeout(function () {
                        ...
                        if (getTop().isUrl(_paste)) {
                            ...
                            _oAjax.send(getTop().T('sid=$sid$&url=$url$&pageid=$id$').replace({
                                sid: getTop().getSid(),
                                id: _oCompose.getPageId(),
                                url: encodeURIComponent(_paste)
                            }));
                        }
                    }, 13);
                }
        ...
        initColorSubject: function () {
            ...
            var _oColorData = ["11", "\u6A59\u7EA2\u8272", "13", "\u6DF1\u7EFF\u8272", "14", "\u9C9C\u7D2B\u8272", "10", "\u7EAF\u9ED1\u8272"],
                _oItems = [{sItemValue: '<span style="margin-left:5px;">\u5F69\u8272\u4E3B\u9898...</span>'}];
            for (var i = 0, _nLen = _oColorData.length; i < _nLen; i += 2) {
                _oItems.push({
                    sId: _oColorData[i],
                    sItemValue: ["<div id='", _oColorData[i], "' class='s", _oColorData[i], "_bg' style='margin-top:3px;width:15px;height:15px;float:left;'></div>&nbsp;", _oColorData[i + 1]].join("")
                });
            }
            ...
            _oBtn.onclick = function () {
                ...
                new _oTop.QMMenu({
                    oEmbedWin: _oWin,
                    sId: "colorsubject",
                    nX: _oTop.getLocale() == "zh_CN" ? _oPos[1] - 96 : _oPos[1] - 146,
                    nY: _oPos[2] + 1,
                    nWidth: _oTop.getLocale() == "zh_CN" ? 100 : 150,
                    oItems: _oItems,
                    nItemHeight: 21,
                    onitemclick: function (_asQQStyle) {
        ...
        _getToBeReloadInfo: function () {
            ...
            var _oInfo = {
                content: _oCompose.getPageEditor() && _oCompose.getPageEditor().getContent(),
                subject: _oCompose.S("subject").value,
                exbacode: _oCompose.S("exist_BigAttach") && _oCompose.S("exist_BigAttach").innerHTML,
                bacode: _sBacode,
                excode: _sExcode,
                sOnlineDocCode: _sOnlineDocCode,
                fileuploaddata: _oFileUploadData || [],
                hasResume: _oResumeInput && _oResumeInput.value ? true : false,
                resumesender: _oCompose.getResumeSender_()
            };
        ...
        exitConfirm: function (_avExitRunCode) {
            ...
            var _sMailid = _oCompose.S("fmailid") && _oCompose.S("fmailid").value,
            ...
            if (_oCompose._isNeedCloseConform() && _oCompose.getPageId() != "remind" && ((_sExitCode = _oCompose._confirmCheckBeforeClose()) != "exit" || (!_bDraft && _sMailid && !_oCompose.getComposeVar()._bIsUserSave && _oCompose.getPageId() != "group") || (!_bDraft && _sDraftMailid && !_oCompose.getComposeVar()._bIsUserSave && _oCompose.getPageId() == "group"))) {
                ...
                var _oParam = {
                    ...
                    exitbtn: "\u5426",
                    disattach: _oTop.getMainWin().sendAfterUpload() ? "block" : "none"
                };
                if (_oCompose.getPageId() == "note") {
                ...
                var _oDialog = new _oTop.QMDialog({
                    ...
                    onload: function () {
                        ...
                        _oTop.addEvent(_oSelfObj.S("btn_exit_save"), "click", function (_aoEvent) {
                            if (_sExitCode != "exit") {
                                _oSelfObj.close();
                                _oProcess.doProcess(_oCompose.getPageId() == "note" ? "" : "savedraft", {
                                    card: "card",
                                    note: "send"
                                }[_oCompose.getPageId()] || "save", _oCompose.getPageId() == "note" ? 1 : 0, undefined, undefined, function () {
                                    _oWin.setTimeout(function () {
                                        _oCompose.setNeedCloseConform(false);
                                        _fExitRun();
                                    }, 0);
                        ...
                        _oTop.addEvent(_oSelfObj.S("btn_delete_save"), "click", function (_aoEvent) {
                            ...
                            if (_sDraftMailid) {
                                ...
                                _oAjax.send(_oTop.T('sid=$sid$&Fun=$fun$&mailaction=$mailaction$&mailid=$mailid$').replace({
                                    sid: _oTop.getSid(),
                                    fun: "PerDel",
                                    mailaction: "mail_del",
                                    mailid: _sDraftMailid
                                }));
        ...
        _syncAddrStationeryHeight: function (_asName) {
            var _oCompose = this;
            var _oTop = getTop();
            var _oQuickDiv = _oCompose.S('quickaddr_div'), _oStationeryDiv = _oCompose.S('stationery_div'),
                _oRightAreaBtnWarp = _oCompose.S('rightAreaBtnWarp'), _nNewHeight;
        ...
        autoSave: function (_abEnable) {
            ...
            var _oLocalStorage = _oTop.QMLocalStorage,
                _bHasLocal = _oLocalStorage.getUserItem("tM") && _oLocalStorage.getUserItem("tM") != "",
                _bSaveLocal = false;
            if (_oTop.bnewwin == 1) {
        ...
        _combineBgMusicMail: function (_asContent, _aoBgMusicInfo) {
            ...
            var _sBgmusic = _aoBgMusicInfo.song ? getTop().T('<b>$songDisp$</b>($singerDisp$)').replace({
                songDisp: getTop().htmlEncode(_aoBgMusicInfo.song),
                singerDisp: getTop().htmlEncode(_aoBgMusicInfo.singer)
            }) : "";
            var _sViewUrl = _aoBgMusicInfo.song ? getTop().T('<a href="http://y.qq.com/#type=soso&p=%3Futf8%3D1%26w%3D$songorg$" target="_blank">\u67E5\u770B</a>&nbsp;').replace({
                songorg: encodeURIComponent(_aoBgMusicInfo.song),
                singerorg: _aoBgMusicInfo.singer
            }) : getTop().T('<a href="$url$" target="_blank">\u4E0B\u8F7D</a>').replace({url: _aoBgMusicInfo.url});
            return getTop().T(['$content$', '<player id="cmd:bgmusic" url="$url$" song="$song$" singer="$singer$"></player> ', '<div id=QQMailBgMusicInfo style="font:12px;color:#909090;">', '<br><br><br><br>\u4F60\u7684\u670B\u53CB $alias$ \u4E3A\u8FD9\u5C01\u90AE\u4EF6\u63D2\u5165\u4E86\u80CC\u666F\u97F3\u4E50 - $bgmusic$', '$viewurl$&nbsp;', '<a id="_bgmusic_play_btn_" href="http://mail.qq.com/zh_CN/htmledition/playmusic.html?song=$song$&singer=$singer$&sender=$encodealias$&url=$encodeurl$" target="_blank">\u64AD\u653E</a>', '</div>']).replace({
                content: _asContent,
                url: _aoBgMusicInfo.url,
                alias: _sAlias,
                bgmusic: _sBgmusic,
                viewurl: _sViewUrl,
                song: _aoBgMusicInfo.song ? encodeURIComponent(_aoBgMusicInfo.song) : "",
                singer: _aoBgMusicInfo.singer ? encodeURIComponent(_aoBgMusicInfo.singer) : "",
                encodeurl: _aoBgMusicInfo.url ? encodeURIComponent(_aoBgMusicInfo.url) : "",
                encodealias: encodeURIComponent(_sAlias)
            });
        },
        ...
        _isUseBackgroundSend: function () {
            var _oCompose = this;
            var _oAttach = _oCompose.moAttach;
            var _oExistList = _oAttach.getExistList(), _sPageId = _oCompose.getPageId(),
                _sUploadMode = _oExistList.length ? _oExistList[_oExistList.length - 1].sUploadMode : "";
        ...
        initFileTransporter: function (_abAutoSelect) {
            var _oCompose = this;
            var _oWin = _oCompose.getWin();
            var _oTop = getTop(), _sDlgId = "ftnupload_attach", _oFtnV2 = _oCompose.S("bigAttachLink"),
                _bFtnV2 = _oTop.attr(_oFtnV2, "ftnv2"), _bUseNewBigAttach = _bFtnV2 == "true" ? true : false;
            var _sUrl = _oTop.T("/cgi-bin/ftnExs_files?sid=$sid$&t=exs_attachment&smethod=new&ftntype=1&listtype=attach$autoselect$").replace({
                sid: _oTop.getSid(),
                autoselect: _abAutoSelect ? "&autoselect=true" : ""
            }), _sNewUrl = _oTop.T("/cgi-bin/readtemplate?sid=$sid$&t=ftn_bigattach$autoselect$").replace({
                sid: _oTop.getSid(),
                autoselect: _abAutoSelect ? "&cmd=bigattachUpload,1,1" : ""
            });
            _oTop.QMDialog(_sDlgId, "max") || new _oTop.QMDialog({
                sId: _sDlgId,
                sTitle: "<span class='attach_add_title'>\u6DFB\u52A0\u8D85\u5927\u9644\u4EF6</span>",
                bMin: true,
                nWidth: _bUseNewBigAttach ? 467 : 440,
                nHeight: _bUseNewBigAttach ? 476 : 399,
                sUrl: _bUseNewBigAttach ? _sNewUrl : _sUrl,
                onbeforeclose: function () {
        ...
        startAppScanUpload: function () {
            var _oTop = getTop(), _sKey = (new Date()).valueOf(), _sTitle = "", _sDesc = "", _oImgPath = [],
                goAppScanUploadNameSpace = (_oTop.goAppScanUploadNameSpace || (_oTop.goAppScanUploadNameSpace = {})),
                _sDefaultPdfIconUrl = _oTop.getRes('$images_path$icon_scan_pdf347b21.png');
            ...
            function getAppScanUploadDlg(abIsInstalledAppJust) {
                ...
                _oAppScanUploadDlg = new (_oTop.QMDialog)({
                    sId: "iphoneuploadimg",
                    sTitle: "\u626B\u63CF\u7EB8\u8D28\u6587\u6863\u4E0A\u4F20",
                    sBodyHtml: DIALOG_BODY_TMPL.replace({
                        hasInstalledSupportApp: 1,
                        isInstalledAppJust: abIsInstalledAppJust ? 1 : 0
                    }),
                    nWidth: 384,
                    bAnimation: false,
                    onload: function () {
            ...
            function resetAppScanUpload() {
                if (!isExistFileUploding()) {
                    ...
                    _oTop.QMAjax.send("/cgi-bin/webapnscheck", {
                        content: "action=clearindex", method: "POST", onload: function () {
                        }
                    });
                }
            }
                ...
                function onQMWebpushMessage(_anService, _aoData) {
                    ...
                    if (_anService == 64) {
                        ...
                        if (_sStatus == "download") {
                            ...
                            _oAppScanUploadDlg.setBody(DIALOG_BODY_TMPL.replace({
                                sys: _sSystemDiff,
                                sid: _oTop.getSid(),
                                skey: _sKey,
                                sTitle: _aoConfig.sTitle,
                                hasInstalledSupportApp: 1,
                                isInstalledAppJust: 1
                            }));
                            doWpns(true);
                        }
                    }
            ...
            function sendMessageToPhone(asKey, aoUpDlg) {
                ...
                _oTop.QMAjax.send("/cgi-bin/webapnscheck", {
                    content: _oTop.T("key=$key$&filefrom=scan&allowsize=$allowsize$").replace({
                        key: asKey,
                        allowsize: _nAllowSize
                    }), method: "POST", onload: function (_abIsOk, _asReturn) {
                        if (_abIsOk) {
                            if (/<!--cgi exception-->/ig.test(_asReturn)) {
                                ...
                                if ("2" == errcode) {
                                    ...
                                    goDownAppProcess({
                                        ...
                                        skey: _sKey,
                                        sTitle: "\u4E0B\u8F7D\u5E76\u5B89\u88C5",
                                        sdesc: "\u6B64\u529F\u80FD\u9700\u8981QQ\u90AE\u7BB1\u624B\u673A\u5BA2\u6237\u7AEF\u914D\u5408\u4F7F\u7528\uFF0C<br/>\u8BF7\u5148\u626B\u63CF\u4E8C\u7EF4\u7801\u4E0B\u8F7D\u5B89\u88C5\u3002"
                                    });
                                }
                                else if ("101" == errcode) {
                                    goDownAppProcess({
                                        ...
                                        skey: _sKey,
                                        sTitle: "\u66F4\u65B0\u5BA2\u6237\u7AEF",
                                        sdesc: "\u4F60\u4F7F\u7528\u7684QQ\u90AE\u7BB1iPhone\u5BA2\u6237\u7AEF\u7248\u672C\u8FC7\u4F4E\uFF0C<br/>\u8BF7\u5148\u626B\u63CF\u4E8C\u7EF4\u7801\u4E0B\u8F7D\u6700\u65B0\u7248\u672C\u3002"
                                    });
                                }
                            }
                            else {
            ...
            function pollingUploadProgress(aoUpDlg) {
                _oTop.QMAjax.send(_oTop.T("/cgi-bin/webapnscheck?key=$key$&action=checkappimg&filefrom=scan").replace({key: _sKey}), {
                    method: "POST", onload: function (_abIsOk, _asParam) {
                        if (_abIsOk && goAppScanUploadNameSpace._bIpUploading) {
                            var _oUpDlg = aoUpDlg, _oResult = evalValue(_asParam), _nTotal = _oResult.total || 1,
                                _sResult = _oResult.done, _nProcessPecent = 100 / _nTotal,
                                _oProcess = _oUpDlg.S("uploadprocess"), _oFiles = _oResult.files;
                            _oFiles.pop();
                                ...
                                if (!checkFileExist(_oFile.filePath)) {
                                    ...
                                    if (!_oUpDlg.isClose()) {
                                        if (_oFile.type === "pdf" || _oFile.type === "pdf_start") {
                                            _sPreviewUrl = _oTop.T(["/cgi-bin/viewdocument?encryptpath=$path$&nf=$nf$&s=yozo&filetype=doc&sid=$sid$"]).replace({
                                                sid: _oTop.getSid(),
                                                path: _oFile.filePath,
                                                nf: _oFile.nf
                                            });
                                    ...
                                    _oAttach.addExistNormalAttach([{
                                        sName: _oFile.name,
                                        nSize: _oFile.size,
                                        bUpToFtn: false,
                                        bResumeAttach: false,
                                        sDownloadPage: _sInsertTextUrl,
                                        sFileUrl: _sPreviewUrl,
                                        sNf: _oFile.nf,
                                        sFilePath: _oFile.filePath,
                                        sFileId: _oFile.filePath,
                                        bIsAppScanUploadFile: true
                                    }]);
                                }
                            }
                            if (_sResult == "true") {
        ...
        openAttachFolder: function () {
            ...
            var _oAttach = _oCompose.moAttach;
            var _oTop = getTop(),
                _sUrl = ['/cgi-bin/attachfolder?topmails=0&s=search&folderid=attach&hflag=attach&action=list&page=0&t=attachfolder_dlg&subject=&sender=&receiver=&searchmode=attach&advancesearch=0&showattachtag=1&fnviewtype=cell&nocheckframe=true&sid=', _oTop.getSid()].join(''),
                _sAttachSelect = "DEF_ATTACH_FOLDER_SELECT";
            _oTop.setGlobalVarValue(_sAttachSelect, {});
            new _oTop.QMDialog({
                sId: "attachFolderDlg",
                sTitle: "\u6536\u85CF\u7684\u9644\u4EF6",
                nWidth: 467,
                nHeight: _oTop.gbIsIE ? 431 : 426,
                sUrl: _sUrl,
                onclose: function () {
                    ...
                    if (_oAttachSelectData) {
                        ...
                        for (var k in _oAttachSelectData) {
                            if (_oData = _oAttachSelectData[k]) {
                                var _oAttachFile = _oAttach._moAttfldUpload.addFile({
                                    sName: _oData.name,
                                    nSize: +_oData.size,
                                    sStatus: "ready",
                                    mailid: _oData.mailid,
                                    attachid: _oData.attachid,
                                    attachname: _oData.name,
                                    editname: _oData.editname,
                                    fileextenal: _oData.ext,
                                    filebyte: _oData.size
                                });
                                _oAttachFile._oFile = [{
                                    mailid: _oData.mailid,
                                    attachid: _oData.attachid,
                                    attachname: encodeURIComponent(_oData.name),
                                    editname: _oData.editname,
                                    fileextenal: _oData.ext,
                                    filebyte: _oData.size
                                }];
        ...
        showInstallActiveXDialog: function () {
            ...
            return function (_asType) {
                ...
                function _getLocId(_asMethod) {
                    return [_bIsUpdate ? "update" : "setup", _oCompose.getPageId(), _asMethod, {
                        "paste": 2,
                        "filetransport": 3,
                        "drag": 4
                    }[_asType] || 1].join(",");
                ...
                function _detect() {
                    ...
                    if (_bResult) {
                        ...
                        }, _oBtns = _oCompose.SN("activexControlBtn");
                ...
                function _onlineSetup() {
                    ...
                    _oTop.open(_oTop.T("/cgi-bin/readtemplate?t=browser_addon&check=false&returnsid=$sid$&s=install").replace({
                        sid: _oTop.getSid(),
                        loc: _getLocId("cab")
                    }));
                }
                ...
                var _sMailName = (_oTop.getDomain() == "qq.com" ? "QQ" : "foxmail.com"),
                    _sControl = _sMailName + "\u90AE\u7BB1" + _sTitle, _sTitle = _sControl + "\u5B89\u88C5\u63D0\u793A";
                ...
                var _oMacTemplate = _oTop.T(['<div id="optContainer">', '<div class="dialog_feedback">', '<img class="dialog_icon" style="margin:1px 14px -4px 0;" src="$images_path$snip_74x741e9c5d.jpg" />', '<div class="dialog_f_c" id="setupMsg" style="margin-left:84px;white-space:nowrap;">', '<div class="dialog_f_t">\u8BF7\u5B89\u88C5Snip\u622A\u5C4F\u5DE5\u5177\uFF0C\u5B89\u88C5\u540E\u53EF\u4EE5\u5728QQ\u90AE\u7BB1\u4E2D\u4F7F\u7528\u622A\u5C4F\u529F\u80FD\u3002</div>', '<div class="dialog_f_d">\u5982\u5DF2\u5B89\u88C5\uFF0C\u8BF7\u5728Snip\u7684\u504F\u597D\u8BBE\u7F6E\u4E2D\u5173\u8054QQ\u90AE\u7BB1\u3002</div>', '</div>', '</div>', '</div>']),
                    _macSetupTemplate = _oTop.T(['<div id="snipFail"  style="display:none">\u5B89\u88C5\u5C1A\u672A\u6210\u529F\uFF0C\u8BF7\u786E\u8BA4\u662F\u5426\u5DF2\u7ECF\u4E0B\u8F7D\u5E76\u6210\u529F\u5B89\u88C5Snip\u3002</div>', '<div id="snipMsg" ><div class="b_size bold">\u68C0\u6D4BSnip\u5B89\u88C5\u72B6\u6001</div>', '<div style="margin:5px 0 0;" class="graytext">\u4E0B\u8F7D\u5E76\u6210\u529F\u5B89\u88C5Snip\u540E\u8BF7\u68C0\u6D4B\u5B89\u88C5\u72B6\u6001\u3002</div></div >']);
                var _sFunc = _oTop.TE([_oTop.gbIsIE || _oTop.gbIsFF ? '<input hideFocus type="button"  onmousedown="return false" unselectable="on" style="margin:2px 5px 0;" class="ico_att"/>\u62D6\u62FD\u4E0A\u4F20\u9644\u4EF6<br>' : '', _bIsNewSC ? '' : '<input hideFocus type="button"  style="margin:2px 5px 0;" class="ico_attbig"/>\u8D85\u5927\u9644\u4EF6<br>', '<input hideFocus style="background: url($images_path$/newicon/compose207c92.png) no-repeat 0 -120px;margin:2px 5px 0;height:16px;width:16px;padding:0;border:0;" type=button unselectable="on">\u622A\u5C4F']).replace({images_path: _oTop.getPath("image", true)}),
                    _sMsg = _bIsUpdate ? _oTop.T('<b>\u60A8\u7684$control$\u7248\u672C\u8FC7\u4F4E\uFF0C\u8BF7\u5347\u7EA7\u5230\u65B0\u7684\u7248\u672C\u3002</b>') : _oTop.T('<b>\u60A8\u8FD8\u672A\u5B89\u88C5$control$\u3002</b>'),
                    _sCtrlName = "\u622A\u5C4F", _nWidth = 400, _nHeight = 210;
                switch (_asType) {
                    case "paste":
                ...
                if (_oTop.gbIsMac) {
                    var _oStatus = _oTop.detectActiveX(0, 0) && !_oTop.detectActiveX(0, 2),
                        _sNewTitle = "\u8BF7\u5B89\u88C5Snip",
                        _sUpgradTitle = "Snip\u63A7\u4EF6\u7248\u672C\u8FC7\u4F4E\uFF0C\u8BF7\u4E0B\u8F7D\u5347\u7EA7";
                    _oTemplate = _oMacTemplate.replace({
                        title: _oStatus ? _sUpgradTitle : _sNewTitle,
                        images_path: _oTop.getPath("image", true)
                    });
                ...
                new _oTop.QMDialog({
                    sId: "activexDialog",
                    sTitle: _sTitle,
                    sBodyHtml: _oTemplate.replace({
                        control: _sControl,
                        images_path: _oTop.getPath("image", true),
                        msg: _sMsg.replace({control: _sControl, mailname: _sMailName, controlname: _sCtrlName}),
                        setupStyle: _sDownloadFname ? "" : "display:none;",
                        onlineStyle: _sOnlineFname ? "" : "display:none;",
                        opt: _bIsUpdate ? "\u5347\u7EA7" : "\u5B89\u88C5",
                        func: _sFunc,
                        path: _sPath,
                        exe: _sDownloadFname
                    }),
                    sFootHtml: _oOperate.replace({
                        control: _sControl,
                        images_path: _oTop.getPath("image", true),
                        msg: _sMsg.replace({control: _sControl, mailname: _sMailName, controlname: _sCtrlName}),
                        setupStyle: _sDownloadFname ? "" : "display:none;",
        ...
        _showPreview: function () {
            ...
            return function () {
                ...
                var _sWinParam = getTop().T('height=$height$,width=$width$,top=$top$,left=$left$,toolbar=no,scrollbars= yes,menubar=no').replace({
                    top: 100,
                    left: 100,
                    height: 500,
                    width: 550
                });
                _oCompose._createPostNewWindow("newwin", "/cgi-bin/readtemplate", {
                    content: _sContent,
                    t: "compose_preview"
                }, _sWinParam);
            };
        ...
        QQMailPreviewContent: function () {
            ...
            if (_oGroupTo && _oGroupTo.value != "0") {
                _oSender.sender_group = [{
                    nick: _oCompose.S('Gname_' + _oGroupTo.value).innerHTML,
                    addr: _oTop.htmlEncode(_oGroupTo.value),
                    bEndItem: true
                }];
            }
            var _oFileListArr = [];
            _oTop.E(_oTop.finds('[ui-type="filename"]', _oWin), function (_aoItem) {
                ...
                _oFileListArr.push({
                    filename: _sFileName,
                    icon: _oTop.getIconByExt(_sExt == _sFileName ? '' : _sExt, 'min')
                });
            });
            ...
            var _sHTML = _oTop.TE(['<table width="100%" border="0" cellspacing="0" cellpadding="0" class="readmailinfo bd" style="border-width:0 0 1px;"><tbody><tr><td colspan="2" height="24"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td height="24" valign="middle" style="word-break:break-all;padding:8px 8px 6px 14px;"><span class="sub_title $subjectClassName$">$subject$</span></td></tr></tbody></table></td></tr>$@$if($sendAddr$)$@$<tr><td style="padding-left:14px;"><span class="addrtitle">\u53D1\u4EF6\u4EBA\uFF1A</span>$@$if($sendName$)$@$<b class="grn">$sendName$</b>&nbsp;$@$else$@$$sendAddr$$@$endif$@$<span class="tcolor">&lt;$sendAddr$&gt;</span></td><td width="1%" nowrap="" style="padding-right:12px;"></td></tr>$@$endif$@$<tr><td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody><tr><td style="word-break:break-all;padding:2px 12px 0 14px;line-height:19px;"><span class="addrtitle">\u65F6\u3000\u95F4\uFF1A</span><span>$sendTime$</span><span></span></td></tr>$@$if($sender_to$&&$sender_to.length$)$@$<tr><td style="padding:2px 12px 0 14px;line-height:19px;"><span class="addrtitle" style="position:absolute;">$@$if($isSeparatedCopy$)$@$\u5206\u9001\u7ED9\uFF1A$@$else$@$\u6536\u4EF6\u4EBA\uFF1A$@$endif$@$</span><div style="padding-left:48px;font-size:12px;overflow:hidden;zoom:1;">$@$for($sender_to$)$@$<span style="white-space:nowrap;line-heihgt:18px;height:18px;float:left;">$nick$&nbsp;<span class="tcolor">&lt;$addr$&gt;</span>$@$if(!$bEndItem$)$@$;&nbsp;$@$endif$@$</span>$@$endfor$@$</div></td></tr>$@$else if($sender_group$&&$sender_group.length$)$@$<tr><td style="padding:2px 12px 0 14px;line-height:19px;"><span class="addrtitle" style="position:absolute;">QQ \u7FA4\uFF1A</span><div style="padding-left:48px;font-size:12px;overflow:hidden;zoom:1;">$@$for($sender_group$)$@$<span style="white-space:nowrap;line-heihgt:18px;height:18px;float:left;">$nick$&nbsp;<span class="tcolor">&lt;$addr$&gt;</span>$@$if(!$bEndItem$)$@$;&nbsp;$@$endif$@$</span>$@$endfor$@$</div></td></tr>$@$endif$@$$@$if($sender_cc$&&$sender_cc.length$)$@$<tr><td style="padding:2px 12px 0 14px;line-height:19px;"><span class="addrtitle" style="position:absolute;">\u6284\u3000\u9001\uFF1A</span><div style="padding-left:48px;font-size:12px;overflow:hidden;zoom:1;">$@$for($sender_cc$)$@$<span style="white-space:nowrap;line-heihgt:18px;height:18px;float:left;">$nick$&nbsp;<span class="tcolor">&lt;$addr$&gt;</span>$@$if(!$bEndItem$)$@$;&nbsp;$@$endif$@$</span>$@$endfor$@$</div></td></tr>$@$endif$@$$@$if($attachments$&&$attachments.length$)$@$<tr><td style="padding:2px 12px 0 14px;line-height:19px;"><span class="addrtitle" style="position:absolute;">\u9644\u3000\u4EF6\uFF1A</span><div style="padding-left:48px;font-size:12px;overflow:hidden;zoom:1;">$@$for($attachments$)$@$<span style="white-space:nowrap;line-heihgt:18px;height:18px;float:left;"><img src="$icon$" style="position: relative;top:2px;" />$filename$$@$if(!$bEndItem$)$@$<span class="tcolor">;&nbsp;</span>$@$endif$@$</span>$@$endfor$@$</div></td></tr>$@$endif$@$<tr><td style="padding:2px 12px 0 14px;line-height:19px;"></td></tr></tbody></table><div style="height:8px;overflow:hidden"><div></div></div></td></tr></tbody></table><!-- <div class="qmbox" style="padding: 15px; overflow: visible; font-size: 14px; height: auto; min-height: 250px; line-height: 1.7;">$content$</div> -->']).replace(_oTop.extend({
                'sendTime': _oTop.formatDate(new Date(), '$YY$\u5E74$MM$\u6708$DD$\u65E5 $hh$:$mm$'),
                'subject': _oTop.subAsiiStr(_oTop.htmlEncode(_oSubject && _oSubject.value || '(\u65E0\u4E3B\u9898)'), 140, '...'),
                'sendName': _oTop.htmlEncode(_oSendName && _oSendName.value || '') || _oTop.getUserInfo('alias'),
                'sendAddr': _oTop.htmlEncode(_oSendAddr && _oSendAddr.value || '') || _oTop.getUserInfo('addr'),
                'subjectClassName': _oCompose.S('subject') && _oCompose.S('subject').className,
                'attachments': _oFileListArr,
        ...
        _setOtherComposeOptionEvent: function () {
            ...
            _oTop.addEvent(_oBtn, "click", function () {
                ...
                return;
                _oTop.qmAnimation[_bShow ? "fold" : "expand"](_oCntr, {
                    durlimit: 10, type: "wait", speed: "fast", onready: function () {
        ...
        setDefSign: function (_asSignValue) {
            var _oTop = getTop(),
                _oSelectTmpl = _oTop.TE(['<div class="left" style="cursor:pointer;">', '\u7B7E\u540D\uFF1A$@$if($sItemValue$)$@$$sItemValue$$@$else$@$\u4E0D\u4F7F\u7528$@$endif$@$<span class="addrtitle" style="font-family: arial,sans-serif; padding-left:4px; font-size:9px; position:relative; top:-1px;" >\u25BC</span>&nbsp;', '</div>', '<span class="left addrtitle" >&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>']);
        ...
        _setMultiSignatureSelect: function () {
            ...
            if (_oContainer) {
                var _oMenuItemTmpl = _oTop.TE(['<div style="$@$if($bNewStyle$)$@$margin-left:-18px;$@$endif$@$padding:0 0 0 12px;">', '$@$if($sItemValue$)$@$$sItemValue$$@$else$@$\u7B7E\u540D1$@$endif$@$&nbsp;&nbsp;&nbsp;&nbsp;', '</div>']),
                    _sSepLineTmpl = '<div style="width:100%;height:0;overflow:hidden;margin-left:-16px;padding:5px 26px 0 0;border-bottom:1px solid #E6E9ED;">&nbsp;</div>',
                    _nInitIdx = 0;

                function _buildMenuItems() {
                    var _oMenuItems = [{sId: "-1", sItemValue: '<div style="padding:0 12px">\u4E0D\u4F7F\u7528</div>'}],
                        _sInitSignId = _oCompose._getEditorSignId("sign"),
                        _oMenuDatas = _oTop.goUserInfo.get('RealAllSignature');
                    _nMenuHeight = 21;
                    _oMenuItems.push({sId: "border", nHeight: 11, sItemValue: _sSepLineTmpl, bDisSelect: true});
                    _nMenuHeight += 11;
                    for (var _sId in _oMenuDatas) {
                        var _oData = _oMenuDatas[_sId], _sTmpl = _oMenuItemTmpl.replace({
                            sItemValue: _oData[1],
                            bNewStyle: (_sId > 199 && _sId < 300) ? true : false
                        });
                ...
                _oTop.addEvent(_oContainer, "click", function () {
                    var _oPos = _oTop.calcPos(_oContainer), _oMenu = _buildMenuItems(),
                        _oDatas = _oTop.goUserInfo.get('RealAllSignature');
                    new (_oTop.QMMenu)({
                        oEmbedWin: _oWin,
                        sId: "signatureMenu",
                        nX: _oPos[3] - 1,
                        nY: _oPos[2] - _oMenu.nheight - 8,
                        nItemHeight: 21,
                        bAnimation: false,
                        oItems: _oMenu.oitems,
                        onitemclick: function (_asId, _aoItem) {
                            ...
                            if (_oDatas[_asId]) {
                                ...
                                var _sUrl = _oTop.T("/cgi-bin/setting1?fun=list&edittype=$edittype$&t=signature_new&sid=$sid$&signid=$signid$").replace({
                                    edittype: "addsign",
                                    sid: _oTop.getSid(),
                                    signid: -1
                                });
        ...
        _setEditorSignValue: function (_asType, _asValue, _asId, _abIsFocus) {
            ...
            function _insertTag(_asType, _aObj, _asPos) {
                ...
                getTop().insertHTML(_aObj, _asPos, getTop().T('$breakline$<div><$type$></$type$></div>').replace({
                    ...
                    case "sign":
                        ...
                        if (_oSign && (parseInt(_avParam) < 100 || (parseInt(_avParam) > 199 && parseInt(_avParam) < 300))) {
                            ...
                            if (!_oWin._bLinkedInSign && _oSign[1] == "LinkedIn\u9886\u82F1") {
                                var _oTop = getTop(), _sEmail = _oTop.getUin() + "@qq.com",
                                    _oLinkedIn = _oTop.bindLinkedInAccount;
                                _oWin._bLinkedInSign = true;
                                _oTop.QMAjax.send("/cgi-bin/bind?sid=" + _oTop.getSid() + "&t=linkedin_profile&fun=getlinkedintoken&useremailaddr=" + _sEmail, {
                                    method: "GET", onload: function (_abIsOk, _asReturn) {
                                        var _oReturn = _oTop.evalValue(_asReturn),
                                            _bUseLinkedIn = _oReturn.bindlinkedin == "1" && _oReturn.linkedinoverdue == "0",
                                            _sLinkedInAccessToken = _oReturn.access_token || "";
                                        if (_bUseLinkedIn) {
        ...
        _splashToCtrl: function (_avObj, _anTimes) {
            var _oCompose = this;
            var _oWin = _oCompose.getWin();
            var _oCtrlObj = _avObj.style ? _avObj : _oCompose.S(_avObj), _nTimes = 0,
                _nMaxTimes = isNaN(_anTimes) ? 6 : _anTimes;
            (function () {
        ...
        _getResumeData: function () {
            if (this._isBusinessReume() == 'top') {
                ...
                return {
                    oResumeWorks: _oPageConfig.resumeworks,
                    hasResume: _oPageConfig.hasResume,
                    sSender: _oPageConfig.sResumeSender
                };
            }
            return {};
        },
                ...
                _oTop.waitFor(function () {
                    ...
                    if (_abOK) {
                        for (var _sResumeType in _oResumeData.oResumeAttach) {
                            _oAttach.addOtherUploaderFileCell({
                                get: function () {
    ...
    function initLocationIdentify(_asWorkerUrl, _asWorkerImportUrl) {
        ...
        function _fVerifyLocationsByCGI() {
            ...
            if (_oLocationString.length) {
                ...
                QMAjax.send('/cgi-bin/check_chinaaddr?resp_charset=UTF8', {
                    method: 'POST', content: _oLocationString.join('&'), onload: function (_abIsOk, _asData) {
                        if (_abIsOk) {
                            ...
                            if (_oData) {
                                for (var i in _oData) {
                                    if (_oData[i].isAddr) {
                                        ...
                                        _oCallbackData.push({
                                            sLocation: _oData[i].addr,
                                            oNode: _oItem.oNode,
                                            sValue: _oItem.sValue
                                        });
                                    }
                                }
