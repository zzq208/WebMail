(function (_aoWin, _aoUndefined) {
        ...
        getInst: function () {
            ...
            if (_oWin.QMWin && QMWin.ajax) {
                QMWin.ajax({
                    sDataType: "json",
                    sUrl: _aoConfig.sUrl,
                    vData: _oContent.join(''),
                    sType: _aoConfig.sType,
                    nTimeout: _aoConfig.nTimeout,
                    ongetxhr: function () {
                ...
                QMAjax.send(_bGET ? _oContent.join('') : _sUrl, {
                    method: _aoConfig.sType,
                    timeout: _aoConfig.nTimeout,
                    content: _bGET ? '' : _oContent.join(''),
    ...
    _oQMWebpush._LOGIC_KEY = {
        _GETWEBPUSHKEY: "/cgi-bin/getwpkey",
        _RETRY: 5,
        _RETRYTIME: 60,
        _DELAYTIME: 300000,
        _mnRetry: 0,
        ...
        _msKey: "",
        _moGetKeyList: [],
        getKey: function (_afCallback, _abNew) {
            var _oSelf = this;
        ...
        _mbDelayTimeHandle: null,
        _mnPreviousTime: 0,
        _getKeyDelayFromCgi: function () {
            var _oSelf = this;
        ...
        _getKeyFromCgi: function () {
            ...
            _oQMWebpush._ajax({
                sUrl: _oSelf._GETWEBPUSHKEY,
                vData: {resp_charset: "UTF8", ef: "js", sid: _oQMWebpush.sid()},
                oncomplete: function (_abIsOk, _asParam, _aoXmlObj) {
    ...
    _oQMWebpush._LOGIC_POLL = {
        _moProxyWin: null,
        _mbCreatingProxy: false,
        _moLongConnectAjax: null,
        _mbLongConnecting: false,
        _msKey: null,
        _msTime: "0",
        _mnOpenServices: 0,
        _moEventList: [],
        _ABORTTIME: 30,
        _POLL: location.protocol + "//wp.mail.qq.com/poll",
        _PROXY_URL: location.protocol + "//wp.mail.qq.com/ajax_proxy.html?mail.qq.com&v=110702",
        open: function (_anServices) {
            var _oSelf = this;
        ...
        _poll: function () {
            ...
            _oQMWebpush._ajax({
                ...
                vData: {
                    u: _oQMWebpush.uin(),
                    s: _oSelf._mnOpenServices,
                    k: _oSelf._msKey,
                    t: _oSelf._msTime,
                    i: _oSelf._ABORTTIME,
                    r: Math.random()
                },
                nTimeout: (_oSelf._ABORTTIME + 3) * 1000,
                oAjaxInst: _oSelf._moLongConnectAjax,
                oncomplete: function (_abIsOk, _asParam, _aoXmlObj) {
                    _oSelf._mbLongConnecting = false;
