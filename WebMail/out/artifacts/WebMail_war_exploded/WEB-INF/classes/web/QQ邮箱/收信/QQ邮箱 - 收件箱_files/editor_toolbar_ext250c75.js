...
QMEditorExt.dtd = (function (y) {
    ...
    var a = x({isindex: 1, fieldset: 1}), b = x({input: 1, button: 1, select: 1, textarea: 1, label: 1}),
        c = w(x({a: 1}), b), d = w({iframe: 1}, c), e = x({
            hr: 1,
            ul: 1,
            menu: 1,
            div: 1,
            ...
            h3: 1,
            h2: 1
        }), f = x({ins: 1, del: 1, script: 1, style: 1}), g = w(x({
            b: 1,
            acronym: 1,
            bdo: 1,
            'var': 1,
            ...
            big: 1,
            small: 1
        }), g), i = w(x({p: 1}), h), j = w(x({iframe: 1}), h, b), k = x({
            img: 1,
            embed: 1,
            noscript: 1,
            br: 1,
            ...
            em: 1,
            dfn: 1
        }), l = w(x({a: 0}), j), m = x({tr: 1}), n = x({'#': 1}), o = w(x({param: 1}), k), p = w(x({form: 1}), a, d, e, i),
        q = x({li: 1, ol: 1, ul: 1}), r = x({style: 1, script: 1}), s = x({base: 1, link: 1, meta: 1, title: 1}),
        t = w(s, r), u = x({head: 1, body: 1}), v = x({html: 1});
    var z = x({
        address: 1,
        blockquote: 1,
        center: 1,
    ...
    return x({
        $nonBodyContent: w(v, u, s),
        $block: z,
        $inline: l,
        $inlineWithA: w(x({a: 1}), l),
        $body: w(x({script: 1, style: 1}), z),
        $cdata: x({script: 1, style: 1}),
        $empty: W,
        $nonChild: x({iframe: 1, textarea: 1}),
        $listItem: x({dd: 1, dt: 1, li: 1}),
        $list: x({ul: 1, ol: 1, dl: 1}),
        $isNotEmpty: x({
            table: 1,
            ul: 1,
            ol: 1,
        ...
        $notTransContent: x({pre: 1, script: 1, style: 1, textarea: 1}),
        html: u,
        head: t,
        style: n,
        script: n,
        ...
        img: {},
        embed: {},
        colgroup: x({thead: 1, col: 1, tbody: 1, tr: 1, tfoot: 1}),
        noscript: p,
        td: p,
        br: {},
        th: p,
        ...
        h2: l,
        form: w(a, d, e, i),
        select: x({optgroup: 1, option: 1}),
        font: l,
        ins: l,
        menu: q,
        abbr: l,
        label: l,
        table: x({thead: 1, col: 1, tbody: 1, tr: 1, colgroup: 1, caption: 1, tfoot: 1}),
        code: l,
        tfoot: m,
        cite: l,
        li: p,
        ...
        big: l,
        small: l,
        span: x({'#': 1, br: 1, b: 1, strong: 1, u: 1, i: 1, em: 1, sub: 1, sup: 1, strike: 1, span: 1}),
        hr: l,
        dt: l,
        sub: l,
        optgroup: x({option: 1}),
        ...
        area: {},
        dir: q,
        map: w(x({area: 1, form: 1, p: 1}), a, f, e),
        applet: o,
        dl: x({dt: 1, dd: 1}),
        del: l,
        isindex: {},
        fieldset: w(x({legend: 1}), k),
        thead: m,
        ul: q,
        acronym: l,
        b: l,
        a: w(x({a: 1}), j),
        blockquote: w(x({td: 1, tr: 1, tbody: 1, li: 1}), p),
        caption: l,
        i: l,
        u: l,
        tbody: m,
...
QMEditorExt.domUtils = (function (a, b) {
    var d = b.dtd;
    var c = {
        fillChar: a.gbIsIE && a.gnIEDocTypeVer == 6 ? '\ufeff' : '\u200B', isWhitespace: function (e) {
...
var QMSelection = (function (a, d) {
    ...
    var e = 0;
    var f = b.prototype = {
        qmSelection: c, _getUinId: function (i) {
            var j;
            do {
                j = i + (++e);
            }
