 ...
 *
 */
public class SandMail1 {

    // 发件人的邮箱和密码
    public static String myEmailAccount = "17816869570@163.com";
    public static String myEmailPassword = "Zzq123456";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般格式为: smtp.xxx.com
    public static String myEmailSMTPHost = "smtp.163.com";

    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "294264338@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("/Users/zhuzhaoqianzhu/Desktop/index.png")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("/Users/zhuzhaoqianzhu/Desktop/index.png"));  // 读取本地文件
